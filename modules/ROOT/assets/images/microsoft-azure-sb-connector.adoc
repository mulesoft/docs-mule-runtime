...
[source,linenums]
----
Endpoint=sb://mulesbft.servicebus.windows.net;
SharedAccessKeyName=RootManageSharedAccessKey;
SharedAccessKey=VqhjhWH3u7Ffw9xnP7MU5FQcbJPksBNrsgutTQ2BHdc=
----
+
|===
...
Use the *subscriptionlistener listener* input source when you want the app to receive messages from an Azure subscription. Configure the source as follows:
