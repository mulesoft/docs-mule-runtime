...
Mule provides abstract parent classes to help with unit testing. See xref:3.6@unit-testing.adoc[Unit Testing] for more information.
...
The FTC supports plenty of configuration options. Read more about it there: xref:3.7@functional-testing.adoc[Functional Testing].
