...
include::mule-runtime::partial$mmp-authentication.adoc[tag=authenticationMethodsIntro]

include::mule-runtime::partial$mmp-authentication.adoc[tags=!authenticationMethodsIntro;!authenticationRTF;!authenticationOnPrem]
...
Ensure that this value is equal to or later than the earliest required Mule version of your application. | Yes
