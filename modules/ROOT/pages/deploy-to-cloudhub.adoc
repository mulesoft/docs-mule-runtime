...
Example value: `4.3.0` +
Starting with Mule 4.5, deployments to CloudHub accepts the Mule version exact name or the semantic versioning, which deploy the latest version of Mule runtime. +
Example values: `4.6`, `4.6-java8` , `4.6-e-java17` | Yes
