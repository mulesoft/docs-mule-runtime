...
----
<plugin>
include::4.2@example$mmp-concept-config.xml[]
  <configuration>
    <cloudHubDeployment>
...
include::4.2@partial$mmp-authentication.adoc[tags=!authenticationMethodsIntro;!authenticationRTF;!authenticationOnPrem]
