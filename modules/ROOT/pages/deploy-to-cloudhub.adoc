...
* Configure your CloudHub deployment strategy for the Mule Maven Plugin

===== Adding the Mule Maven Plugin to your Project
...
===== Declaring External Classes and Resources
...
===== Configuring the CloudHub Deployment Strategy
...
* xref:studio::deploy-mule-application-task.adoc[Deploy to CloudHub Using Studio]
* xref:runtime-manager::anypoint-platform-cli-commands.adoc#deploy-to-cloudhub[Deploy to CloudHub Using Anypoint CLI]
* xref:runtime-manager::deploying-to-cloudhub.adoc[Deploy to CloudHub Using Runtime Manager]
