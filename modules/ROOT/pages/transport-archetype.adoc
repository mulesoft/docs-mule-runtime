...
If you want to update an existing transport instead of creating a new one, such as adding new schema namespaces and registry bootstrapping to the transport, use the xref:3.6@creating-module-archetypes.adoc[Creating Module Archetypes] instead.
