...
For the Mule 3 approach, see this MuleSoft blog: https://blogs.mulesoft.com/dev-guides/how-to-tutorials/data-synchronizing-made-easy-with-mule-watermarks/[Data Synchronizing made easy with Watermarks].
