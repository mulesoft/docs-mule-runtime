...
[WARNING]
The *Mule Expression Language (MEL)* removes the need to use old expressions in Mule. Refer to xref:3.7@mule-expression-language-mel.adoc[Mule Expression Language MEL] for details on how to use MEL.
