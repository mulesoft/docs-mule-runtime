...
This page provides details on the elements you configure for components. This information is pulled directly from `mule.xsd` and is cached. For more information on components, see xref:3.7@configuring-components.adoc[Configuring Components].
...
See xref:3.6@using-interceptors.adoc[Using Interceptors].
