...
This page provides details on elements you configure for components. This information is pulled directly from `mule.xsd` and is cached. For more information on components, see xref:3.4@configuring-components.adoc[Configuring Components].
