...
If you are familiar with versions of Mule older than v 3.0, you may want to consult this list of xref:3.6@notes-on-mule-3.0-schema-changes.adoc[schema changes].
