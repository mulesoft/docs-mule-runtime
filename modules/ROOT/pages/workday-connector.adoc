...
To use the Workday connector 8.0 in a production environment, you must have an Enterprise license to use Mule.  Contact the mailto:info@mulesoft.com[MuleSoft Sales Team] to obtain either of these. Read more about xref:installing-an-enterprise-license.adoc[Installing an Enterprise License].
...
[NOTE]
====
In the Global Element Properties image, the placeholder values refer to a configuration file in the `src` folder of your project. See xref:configuring-properties.adoc[Configuring Properties]. Either enter your credentials in the global configuration properties, or reference a configuration file containing these values.
...
[NOTE]
For more information on setting credentials inside a properties file, refer to this section on  xref:configuring-properties.adoc#properties-files[Properties Files].
+
