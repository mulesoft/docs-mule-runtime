...
[TIP]
Keep in mind that if you'd rather code in Java, there's also a xref:3.7@java-component-reference.adoc[Java Component] that works very similarly.
...
* Read more about the xref:3.6@javascript-component-reference.adoc[JavaScript Component]
* Read more about the xref:3.6@ruby-component-reference.adoc[Ruby Component]
* Read more about the xref:3.7@groovy-component-reference.adoc[Groovy Component]
* Read more about the xref:3.7@python-component-reference.adoc[Python Component]
* Read more about the xref:3.7@java-component-reference.adoc[Java Component]