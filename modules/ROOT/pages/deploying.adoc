...
If Mule is embedded in another container, the xref:3.8@mule-management-console::index.adoc[Mule Management Console] cannot perform Autodiscovery or server restarts.

== Deployment Topics

* To learn how to start and stop the Mule runtime instance see xref:starting-and-stopping-mule-esb.adoc[Starting and Stopping Mule]
* For runtime instance management see xref:runtime-manager::index.adoc[Runtime Manager] and for cloud deployment on MuleSoft servers see xref:runtime-manager::cloudhub.adoc[CloudHub]
