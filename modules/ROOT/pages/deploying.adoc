...
* Mule Maven plugin
|
* No installation of Mule runtime engine is required, CloudHub workers take care of Mule instances as part of the deployment process
...
* Mule Maven plugin
|
* No Installation of Mule runtime engine is required, Anypoint Runtime Fabric internally take care of Mule instances as part of the deployment process
