...
All Mule applications require to be deployed to a Mule runtime engine instance to run. MuleSoft supports three different deployment targets: CloudHub, Anypoint Runtime Fabric, and on-premises Mule instances.
...
In addition, there are different tools available to deploy applications to each of the deployment targets:
