...
See xref:on-premises::mule-deployment-model.adoc[On-Premises Deployment Model] for more information about characteristics specific to on-premises deployments.
...
[NOTE]
After End of Extended Support for Mule runtime 4.4, Mule applications deployed to CloudHub or CloudHub 2.0 environments are stopped.
...
* xref:on-premises::mule-high-availability-ha-clusters.adoc[Mule High Availability Clusters]
