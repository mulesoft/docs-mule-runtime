...
. Optionally, select the *Fail On Verification* option if an exception must be thrown when the signature does not match the expected signature. Defaults to false.
