...
On Unix, you can run mule as any user with the following caveats:
...
Commercial configuration management and integrity management tools can help you automate management to the CIS benchmarks. Also, Mule documentation includes a good deal of information on xref:3.4@configuring-security.adoc[configuring security]. If your application deals in sensitive data, consider using SSL (HTTPS) to protect it.
