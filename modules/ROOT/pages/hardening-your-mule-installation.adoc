...
Commercial configuration management and integrity management tools can help you automate management to the CIS benchmarks. Also, Mule documentation includes a good deal of information on xref:configuring-security.adoc[configuring security]. If your application deals in sensitive data, consider using SSL Transport (HTTPS) to protect it.
