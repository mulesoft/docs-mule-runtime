...
* If you are not using xref:mule-management-console::index.adoc[Mule Management Console (MMC)], which reached its end of life in 2019, disable the MMC agent by adding `mule.agent.enabled=false` to `wrapper.conf`. This configuration file is in 
