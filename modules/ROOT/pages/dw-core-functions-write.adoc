...
| `writerProperties` | Optional: Sets writer configuration properties. For writer configuration properties (and other supported mime types), see https://docs.mulesoft.com/mule-runtime/4.2/dataweave-formats[Formats Supported by DataWeave].
|===
