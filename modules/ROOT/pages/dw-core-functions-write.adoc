...
| `writerProperties` | Optional: Sets writer configuration properties. For writer configuration properties (and other content types), see https://docs.mulesoft.com/mule-runtime/4.1/dataweave-formats[DataWeave Output Formats and Writer Properties].
|===
