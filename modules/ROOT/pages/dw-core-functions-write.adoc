...
| `writerProperties` | Optional: Sets writer configuration properties for the particular content type. For writer configuration properties (and other content types), see https://docs.mulesoft.com/mule-runtime/4.1/dataweave-formats[Formats Supported by DataWeave].
|===
