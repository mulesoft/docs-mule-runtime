...
This document assumes that you are familiar with Mule ESB and its xref:mule-concepts.adoc[basic concepts]. Consider reading the chapter, https://docs.mulesoft.com/getting-started/index[Anypoint Fundamentals] to gain familiarity before proceeding.
...
* Learn the xref:mule-expression-language-basic-syntax.adoc[basic syntax of MEL].
