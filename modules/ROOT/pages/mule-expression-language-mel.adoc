...
. *Understand how to see the contents of the Mule message.* To be able to act upon it, you need to recognize the type of data the message contains. Is the payload an array? Does the message contain a flow variable? What inbound properties exist?
