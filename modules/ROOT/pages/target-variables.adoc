...
:page-aliases: migration-core-enricher.adoc
...
+
image::mruntime-payload-flow.png["A message flow standard behavior"]
+
...
+
image::mruntime-payload-flow-target-variable.png["A message flow with target variable"]
...
+
image::mruntime-payload-flow-target-variable-2.png["A message flow with target variable and additional variables"]
+
[calloutlist]
