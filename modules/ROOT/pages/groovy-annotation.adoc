...
In the example above 'payload' is a context binding that gives you access to the message payload directly in Groovy. There are other context bindings available to Groovy scripts, See xref:3.6@scripting-module-reference.adoc[Script Context Bindings] for more information.
