...
You can find examples in https://www.anypoint.mulesoft.com/exchange[Anypoint Exchange]. The following example is for a custom transformer called `StringToNameString`, which wraps Java string in a custom class called `NameString`:
