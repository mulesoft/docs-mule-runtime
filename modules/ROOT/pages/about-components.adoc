...
An Endpoint is a type of component that initiates (or triggers) processing in a
...
Mule apps can contain error handling components route and process Mule errors in 
a flow:
...
processors (modules, components, or connectors) to apply some programming 
behavior to that isolated sequence of event processors.
