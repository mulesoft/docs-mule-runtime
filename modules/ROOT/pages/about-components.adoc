...
A Scope is a type of component that groups together a sequence of event processors (including other Core components and operations from modules and connectors) to apply some programming behavior to that isolated sequence of event processors.
