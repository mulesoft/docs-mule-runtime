...
A Flow Control component takes the input event and
routes it to one or more separate sequences of components. For example, a
xref:choice-router-concept.adoc[Choice router]) applies DataWeave logic to
