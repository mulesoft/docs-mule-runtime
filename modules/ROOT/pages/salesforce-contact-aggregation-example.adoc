...
Beyond this example, access xref:salesforce-connector.adoc[introductory] and https://mulesoft.github.io/mule-salesforce-connector/[reference] documentation for the Salesforce Connector.
...
* Access https://mulesoft.github.io/mule-salesforce-connector/[full reference documentation] for the Salesforce Connector.
