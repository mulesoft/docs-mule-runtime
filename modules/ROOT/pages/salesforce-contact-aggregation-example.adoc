...
Beyond this example, access xref:salesforce-connector.adoc[introductory] and link:/mule-user-guide/v/3.7/salesforce-connector-reference[reference] documentation for the Salesforce Connector.
