...
Beyond this example, access xref:salesforce-connector.adoc[introductory] and xref:connectors::salesforce/salesforce-connector-reference.adoc[reference] documentation for the Salesforce Connector.
