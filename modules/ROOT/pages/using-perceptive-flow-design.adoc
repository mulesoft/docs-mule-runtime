...
* Learn more about Anypoint DataMapper through the xref:6@studio::datamapper-user-guide-and-reference.adoc[Datamapper User Guide and Reference]. Specifically on the subject of metadata, see xref:defining-datamapper-input-and-output-metadata.adoc[Defining DataMapper Input and Output Metadata].
