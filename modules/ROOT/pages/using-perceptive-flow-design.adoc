...
This document assumes that you are familiar with the xref:6.x@studio::index.adoc[Visual Editor in Anypoint Studio] and the xref:anypoint-connectors.adoc[Anypoint Connectors] and xref:5.x@studio::datamapper-user-guide-and-reference.adoc[DataMapper Transformer] that you can use to create applications in Studio.  Further, this document references https://anypoint.mulesoft.com/exchange/?type=connector[Connectors] and xref:global-elements.adoc[Global Elements.] Review xref:datasense.adoc[DataSense] to learn more about the overall DataSense functionality.
...
* Learn more about Anypoint DataMapper through the xref:6.x@studio::datamapper-user-guide-and-reference.adoc[Datamapper User Guide and Reference]. Specifically on the subject of metadata, see xref:defining-datamapper-input-and-output-metadata.adoc[Defining DataMapper Input and Output Metadata].
* xref:runtime-manager::deployment-strategies.adoc[Deploy] your application to Runtime Manager.