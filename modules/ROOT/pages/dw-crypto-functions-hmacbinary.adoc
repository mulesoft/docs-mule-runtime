...
| `algorithm` | The hashing algorithm. `HmacSHA1` is the default. Valid values depend on the JDK version you are using. For JDK 8 and JDK 11, `HmacMD5`, `HmacSHA1`, `HmacSHA224`, `HmacSHA256`, `HmacSHA384`, `HmacSHA512` are valid algorithms. For JDK 11, `HmacSHA512/224` and `HmacSHA512/256` are also valid. 
|===
