...
To accomplish this example you must create two DataWeave scripts and store them locally, create the Mule application, run and test the application.
...
=== XML for Evaluate DataWeave Script from a File system
