...
|image:flow-reference-24x16.png[] |Flow Reference a|This building block calls another external flow. The called flow can be one of two types:
...
|image:java-component-24x16.png[] |Java |Allows you to select a Java class to be invoked by the application flow. |xref:java-component-reference.adoc[Java Component]
|image:javascript-component-24x16.png[] |JavaScript |Allows integration of a custom script backed by the JavaScript engine. |xref:javascript-component-reference.adoc[JavaScript Component Reference]
...
|image:ruby-component-24x16.png[] |Ruby |Allows intergratin of a custom script backed by the Ruby script engine. |xref:ruby-component-reference.adoc[Ruby Component Reference]
