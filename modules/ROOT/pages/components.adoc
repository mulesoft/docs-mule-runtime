...
|image:echo-24x16.png[Echo-24x16] |Echo |Simply passes the message to the next building block in the flow without performing any actions. |xref:3.7@echo-component-reference.adoc[Echo Component Reference]
|image:flow-reference-24x16.png[] |Flow Reference |This building block calls another external flow. The called flow can be one of two types: +
 ...
 |xref:3.6@flow-reference-component-reference.adoc[Flow Reference Component Reference]
|image:logger-24x16.png[Logger-24x16] |Logger |Logs custom strings, including strings constructed from embedded expressions. Also allows specification of logging level and category. |xref:3.6@logger-component-reference.adoc[Logger Component Reference]
|===
...
|===
|  |Components |Description |Documentation
|image:groovy-component-24x16.png[] |Groovy |Facilitates the integration of a custom script backed by the Groovy script engine. |xref:3.7@groovy-component-reference.adoc[Groovy Component Reference]
|image:java-component-24x16.png[] |Java |Allows you to select a Java class to be invoked by the application flow. |xref:3.7@java-component-reference.adoc[Java Component]
|image:javascript-component-24x16.png[] |JavaScript |Allows integration of a custom script backed by the JavaScript engine. |xref:3.6@javascript-component-reference.adoc[JavaScript Component Reference]
|image:python-component-24x16.png[] |Python |Allows integration of a custom script backed by the Python script engine. |xref:3.7@python-component-reference.adoc[Python Component Reference]
|image:ruby-component-24x16.png[] |Ruby |Allows integration of a custom script backed by the Ruby script engine. |xref:3.6@ruby-component-reference.adoc[Ruby Component Reference]
|image:component-24x16.png[Component-24x16] |Script |Makes a script written in Groovy, JavaScript, Python, or Ruby available to the application flow. |xref:3.6@script-component-reference.adoc[Script Component Reference]
|===
...
|===
|  |Components |Description |Documentation
|image:rest-24x16.png[Rest-24x16] |REST |Makes a REST web service available to the application flow via Jersey. |xref:3.7@rest-component-reference.adoc[REST Component Reference]
|image:soap-24x16.png[Soap-24x16] |CXF |Makes a web service available to the application flow via CXF. |xref:3.6@cxf-component-reference.adoc[CXF Component Reference]
|===