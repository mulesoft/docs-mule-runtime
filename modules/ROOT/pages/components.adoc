...
|image:echo-24x16.png[Echo-24x16] |Echo |Simply passes the message to the next building block in the flow without performing any actions. |xref:echo-component-reference.adoc[Echo Component Reference]
...
|image:ruby-component-24x16.png[] |Ruby |Allows integration of a custom script backed by the Ruby script engine. |xref:ruby-component-reference.adoc[Ruby Component Reference]
...
|image:soap-24x16.png[Soap-24x16] |CXF |Makes a web service available to the application flow via CXF. |xref:cxf-component-reference.adoc[CXF Component Reference]
|===