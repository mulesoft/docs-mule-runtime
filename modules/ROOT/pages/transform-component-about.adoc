...
image::transform-message-component-concept-design-center-b3dc0.png["Input and output structures for a transformation message component"]
...
image::transform-message-component-concept-design-center-d3719.png["A DataWeave script outputting JSON including version number, store ID, and item ID"]
...
image::using-dataweave-in-studio-b504a.png["A DataWeave transformation from XML to JSON"]
