...
This document assumes you are familiar with Mule Expression Language's xref:mule-expression-language-basic-syntax.adoc[basic syntax] and are comfortable building and running Mule applications using xref:5@studio::index.adoc[Mule Studio] or XML.
