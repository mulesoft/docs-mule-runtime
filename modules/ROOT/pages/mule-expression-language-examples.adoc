...
* Want to learn more about how to get information about the Mule message so that you can work with it using MEL? Try out this xref:general:getting-started:mule-message.adoc[tutorial].