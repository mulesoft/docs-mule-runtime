...
* See the xref:servlet-transport-reference.adoc[Servlet Transport Reference] for details on setting the properties for a Servlet endpoint using an XML editor.
