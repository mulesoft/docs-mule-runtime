...
[NOTE]
You don't have to use a service interface, you can just use an implementation class. However, the service interface makes it possible to consume the service very easily. See xref:consuming-web-services-with-cxf.adoc[Consuming Web Services] for more information.
