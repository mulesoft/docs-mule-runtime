...
If you are manually coding the Mule application in Studio’s XML editor or another text editor, paste these statements into the header of your Configuration XML, inside the ``<mule>`` tag, as shown below:
