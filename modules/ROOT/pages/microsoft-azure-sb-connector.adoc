...
To start configuring the connector, you first need to select and configure an input source. The Azure Service Bus Connector supports three input sources:
