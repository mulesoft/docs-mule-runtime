...
* xref:3.7@installing-an-enterprise-license.adoc[Install an Enterprise License] to begin using the Mule Management Console to manage clusters in production.
* For more information about Mule high availability, consult the xref:3.6@mule-high-availability-ha-clusters.adoc[Mule High Availability] documentation.
* For more information about Mule clustering, consult the https://docs.archive.mulesoft.com/mule-management-console/v/3.6/configuring-mule-ha-clustering[Mule HA Clustering] documentation.
