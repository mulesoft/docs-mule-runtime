...
You start a Mule app with or without an API specification, connect to
...
* xref:build-application-from-api.adoc[Build an Application from an API Specification]
