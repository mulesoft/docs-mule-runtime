...
:page-aliases: mule-application-about.adoc, mule-app-strategies.adoc, intro-packaging.adoc
...
Studio 7.x are compatible with Mule 4.x runtime engines. Make sure the
connector or module you use in a Mule application is compatible with your Mule version.

== See Also

* xref:about-mule-message.adoc[]
* xref:about-mule-variables.adoc[]
* xref:about-mule-configuration.adoc[]
* xref:apikit::overview-4.adoc[]
