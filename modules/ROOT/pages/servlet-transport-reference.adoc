...
Servlet endpoints accept the same attributes and child elements as HTTP endpoints. For more information, see xref:file-transport-reference.adoc[FTP Transport Reference].
