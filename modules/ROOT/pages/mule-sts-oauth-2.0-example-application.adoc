...
This document assumes that you are familiar with the xref:6.x@studio::index.adoc[Anypoint Studio interface].
...
* For more information on Oauth 2.0 in Mule, refer to xref:mule-secure-token-service.adoc[Mule Secure Token Service].