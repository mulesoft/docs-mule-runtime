...
This page describes how to use a standalone CXF-generated client with Mule. This approach is different from the xref:3.6@consuming-web-services-with-cxf.adoc[outbound router] approach, which is typically a more appropriate fit for most applications.
...
Following is an example of how to construct a client using the service that was developed in xref:3.6@building-web-services-with-cxf.adoc[Building Web Services with CXF]:
