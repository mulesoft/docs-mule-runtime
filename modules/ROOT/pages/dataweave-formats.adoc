...
| `java`
| xref:dataweave-formats-java.adoc[Java Format], xref:dataweave-formats-java.adoc#format_java_enum[Enum Format for Java]
...
| `application/x-ndjson`, `application/x-ldjson`
| `ndjson`
