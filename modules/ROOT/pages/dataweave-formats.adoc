...
It is also possible to use a Mule variable in a DataWeave script to set the value of a reader or writer property. For an example, see xref:set-reader-writer-config.adoc[Set Reader and Writer Configuration Properties].
