...
It is also possible to use a Mule variable as a value of a configuration property. For more complete examples, see xref:set-reader-writer-config.adoc[Set Reader and Writer Configuration Properties].
