...
When specifying an Avro `output` format in a DataWeave script,
you can append the following properties to change the way the DataWeave parser processes data.
