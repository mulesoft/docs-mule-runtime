...
| `schemaUrl` | String | No Default | The URL for Avro schema. Valid values: `classpath://`, `file://`, or `http://`.
...
|===
| Parameter | Type | Default | Description
| `schemaUrl` | String | No Default | The URL for the Avro schema. Valid values: `classpath://`, `file://`, or `http://`.
|===
