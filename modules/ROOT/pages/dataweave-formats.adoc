...
Another use of `with` outputs a format that is similar to the format that the writer recognizes, such as `output application/problem+json with json` described in <<reader_writer_properties>>.
