...
| `application/java`
| `java`
| xref:dataweave-formats-java.adoc[Java Format], xref:dataweave-formats-java.adoc#format_java-enum[Enum Format for Java]
...
| `application/xml`
| `xml`
| xref:dataweave-formats-xml.adoc[XML Format], <<format_xml_cdata>>

| `application/x-ndjson`
| `ndjson`
| xref:dataweave-formats-ndjson.adoc[ndjson Format] (Newline Delimited JSON)
...
| `properties`
| xref:dataweave-formats-properties.adoc[Text Java Properties Format]
|===
