...
[INFO] modules:
Which Mule modules do you want to include in this project?(options: builders,client,jaas,jbossts,management,ognl,pgp,scripting,spring-extras,sxc,xml):[default: client,management,scripting,sxc,xml]
----
