...
Install the xref:installing-anypoint-enterprise-security.adoc[Anypoint Enterprise Security update] on your instance of Mule Studio Enterprise Edition 3.3.2.
