...
Install the xref:3.6@installing-anypoint-enterprise-security.adoc[Anypoint Enterprise Security update] on your instance of Anypoint Studio Enterprise Edition 3.3.2 or later.
...
xref:3.6@mule-credentials-vault.adoc[Encrypt a properties file]
...
xref:3.6@mule-message-encryption-processor.adoc[Encrypt a message payload] +
xref:3.6@mule-message-encryption-processor.adoc[Decrypt a message payload]
...
xref:3.7@mule-digital-signature-processor.adoc[Add a digital signature to a message in Mule] +
xref:3.7@mule-digital-signature-processor.adoc[Sign part of a message payload] +
xref:3.7@mule-digital-signature-processor.adoc[Verify a digital signature in Mule]
...
xref:3.7@anypoint-filter-processor.adoc[Filter unsecure messages]
...
xref:3.6@mule-crc32-processor.adoc[Apply a CRC to a message] +
 +

== See Also

. Install the xref:3.6@installing-anypoint-enterprise-security.adoc[Anypoint Enterprise Security update] on your instance of Anypoint Studio or Standalone Enterprise 3.3.2 or later.
...
** xref:3.6@anypoint-enterprise-security-example-application.adoc[Anypoint Enterprise Security Example Application]
** xref:3.7@mule-sts-oauth-2.0-example-application.adoc[Mule STS Oauth 2.0 Example Application]