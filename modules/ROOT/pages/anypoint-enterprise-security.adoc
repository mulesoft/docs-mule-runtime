...
xref:3.8@mule-secure-token-service.adoc[Apply Oauth 2.0 to my Mule Web service provider] +
xref:3.8@mule-secure-token-service.adoc[Apply Oauth 2.0 to my Mule Web service consumer]
...
xref:anypoint-filter-processor.adoc[Filter unsecure messages]
