...
xref:mule-secure-token-service.adoc[Apply Oauth 2.0 to my Mule Web service provider] +
xref:mule-secure-token-service.adoc[Apply Oauth 2.0 to my Mule Web service consumer]
