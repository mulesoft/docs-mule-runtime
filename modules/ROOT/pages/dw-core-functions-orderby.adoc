...
This example orders a JSON array payload descending by the type String. The expression first orders them alphabetically by the value of the `Type` key, then reverses the order based on the `[-1 to 0]`.
