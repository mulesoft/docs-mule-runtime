...
This example orders a JSON array payload descending by the type String. The expression orders them by type first, then reverses the order based on the `[-1 to 0]`.
