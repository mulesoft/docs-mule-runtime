...
Use APIkit to create an API based on RAML (RESTful API Modeling Language) or OAS (OpenAPI Specification) API definition. The toolkit produces a Mule application with an HTTP endpoint and exception strategies and also offers an API console as a design feature only, which exposes auto-generated testable documentation for your API.
