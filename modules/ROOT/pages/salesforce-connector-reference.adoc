...
If you wish, you can customize the automatic connection management by explicitly configuring a connection pool to specify the parameters. For more information, see xref:3.6@tuning-performance.adoc[Tuning Performance].

You can also optionally configure a reconnection strategy using the reconnection child element. For more information, see xref:3.6@configuring-reconnection-strategies.adoc[Configuring Reconnection Strategies].
...
* Access explanatory documentation at xref:3.7@salesforce-connector.adoc[Salesforce Connector].