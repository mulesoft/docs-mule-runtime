...
When scheduling tasks, it's recommended that you instead resort to the xref:poll-reference.adoc[Poll Scope]
...
Note that you also have the option to use a Poll scope at the beginning of a flow, which also supports Cron expressions and watermarks. Read more about the xref:poll-reference.adoc[Poll scope].
