...
This page describes manual creation and configuration of a cluster. If you want to create and manage a cluster using the Management Console's graphical interface, see https://docs.archive.mulesoft.com/mule-management-console/v/3.7/creating-or-disbanding-a-cluster[Creating or Disbanding a Cluster].
...
* Learn about
https://docs.archive.mulesoft.com/mule-management-console/v/3.7/deploying-redeploying-or-undeploying-an-application-to-or-from-a-cluster[deploying] and https://docs.archive.mulesoft.com/mule-management-console/v/3.7/monitoring-a-cluster[monitoring] clusters.