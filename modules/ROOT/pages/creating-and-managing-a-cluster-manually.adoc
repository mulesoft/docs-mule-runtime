...
+
[NOTE]
You can find more information about the pool configuration of the `ComboPooledDataSource` Java class in https://www.mchange.com/projects/c3p0/[JDBC3 Connection and Statement Pooling].
