...
You can persistently store JDBC data in a centralized system, accessible from all cluster nodes, unless you are using Anypoint Runtime Fabric. Object Store Persistence is not currently supported for Runtime Fabric clusters. 
