...
---
compose(["http://examplewebsite.com/", "/page.html"], ["$(urlPath)"])
----
...
----
"http://examplewebsite.com/content%20folder/page.html"
----
...
import * from dw::core::URL
---
compose `http://examplewebsite.com/$(urlPath)/page.html`
----
