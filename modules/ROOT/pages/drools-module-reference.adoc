...
[NOTE]
====
Starting in Mule 3.9.1, Drools libraries are no longer bundled with the Mule distribution. Drools 5.0 is the latest supported version. To add the Drools module along with its libraries to 3.9.1 or later, follow this https://help.mulesoft.com/s/article/How-to-configure-Drools[Knowledge Base article]. Notice that this will not be supported in CH because of security concerns in drools distributions.
====
