...
Property placeholders are reserved for HTTP and HTTPS ports in CloudHub deployments. The shared load balancer in CloudHub uses the defaults for these properties. 

Use of the same placeholders is recommended for on-premises deployments.
