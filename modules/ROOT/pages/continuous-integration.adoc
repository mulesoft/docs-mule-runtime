...
* xref:1.x@api-manager::tutorial-set-up-an-api.adoc[To Set Up an API]
...
You can create functional tests with https://docs.archive.mulesoft.com/munit/v/1.1/[MUnit Unit Testing].
...
* https://docs.archive.mulesoft.com/munit/v/1.1/[MUnit Unit Testing]