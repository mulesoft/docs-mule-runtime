...
For a complete CI example that uses Jenkins and Maven, see the Anypoint Platform Development: Advanced class on the https://trailheadacademy.salesforce.com/products/mulesoft[MuleSoft training site]. The training site also includes related classes and certification exams.
