...
You can create functional tests with xref:1.3@munit::index.adoc[MUnit Unit Testing].
...
* https://www.eclipse.org/hudson/[Hudson]
...
* xref:1.3@munit::index.adoc[MUnit Unit Testing]
