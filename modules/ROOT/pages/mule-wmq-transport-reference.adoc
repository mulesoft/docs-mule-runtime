...
The WMQ transport supports xref:configuring-reconnection-strategies.adoc[retry policies]. As of Mule 2.2.3, you can configure the timeout value on the connector as follows:
