...
The sections below offer brief descriptions of each type of authorization grant, listed according to the level of security, in descending order. Refer to the xref:3.8@mule-secure-token-service.adoc[Mule Secure Token Service] document for details regarding OAuth Roles and the OAuth dance.
