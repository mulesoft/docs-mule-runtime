...
The Implicit grant type optimizes performance for browser clients that use a scripting language, such as Javascript. However, this grant type can expose the token to the resource owner or the resource owner's user-agent.
