...
* Learn how to xref:5.x@studio::testing-connections.adoc[test connections] to external resources.
* See the xref:5.x@studio::datasense-enabled-connectors.adoc[list of DataSense-enabled connectors].
* Learn how to exploit xref:5.x@studio::using-perceptive-flow-design.adoc[DataSense Perceptive Flow Design].
* Learn how to use the xref:5.x@studio::using-the-datasense-explorer.adoc[DataSense Explorer] to preview to contents of the message
