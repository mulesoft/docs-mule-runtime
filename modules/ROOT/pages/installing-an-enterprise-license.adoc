...
* Log in to https://help.mulesoft.com[the Support portal]. If you do not have credentials to log in, please contact your Customer Success Manager.

* Click the *Support* tab located on the top of the Support Portal Home page. https://help.mulesoft.com/s/support[Direct link]
