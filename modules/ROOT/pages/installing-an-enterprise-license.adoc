...
. Contact your MuleSoft account representative or http://www.mulesoft.com/contact[the MuleSoft sales team] to acquire an *Enterprise license*. Depending on your subscription, the license is provided either as:
