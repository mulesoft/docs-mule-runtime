...
. Contact your MuleSoft account representative or http://www.mulesoft.com/contact[the MuleSoft sales team] to acquire an *Enterprise license*. Depending on your subscription, the license is provided
  either as:
.. A single `license.lic` file
.. A `.zip` file that contains one or more license files:
   *** For Government Cloud customers, the `.zip` file includes both a FIPS, and a non-FIPS license.
...
. Contact your account representative or http://www.mulesoft.com/contact[the MuleSoft sales team] to acquire an *Enterprise Edition license*. Depending on your subscription, the license is provided either as a direct `license.lic` file or inside a `.zip` file.
...
To use the SAP Connector or other premium connectors, you must first acquire, then install a product license. Contact your account representative or http://www.mulesoft.com/contact[the MuleSoft sales team] to acquire a license for one of the previously mentioned products.
