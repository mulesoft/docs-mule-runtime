...
[TIP]
The https://repository.mulesoft.org/nexus-ee/content/repositories/releases-ee/[MuleSoft Enterprise Maven customer repository] allows you to access Mule Enterprise modules, connectors, and other components not included in the trial or community versions. See xref:3.6@configuring-maven-to-work-with-mule-esb.adoc[Configuring Maven to Work with Mule ESB] for details.
