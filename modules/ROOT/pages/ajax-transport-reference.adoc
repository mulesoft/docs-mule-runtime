...
|AJAX |https://www.mulesoft.org/docs/site/3.6.0/apidocs/org/mule/transport/ajax/package-summary.html[JavaDoc |http://www.mulesoft.org/docs/site/current3/schemadocs/namespaces/http_www_mulesoft_org_schema_mule_ajax/namespace-overview.html[SchemaDoc] |image:check.png[] |image:check.png[] |image:error.png[] |image:error.png[] |image:check.png[] |image:error.png[] |one-way |one-way |org.mule.transport:mule-transport-ajax
