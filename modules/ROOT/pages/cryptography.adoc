...
* xref:cryptography-pgp.adoc[PGP]: Signature and encryption using PGP.
...
1. Select **Search in Exchange**, and search for the Cryptography Module.
1. Add the extension.
1. You can now search in the mule Palette for operations of the Cryptography module.
