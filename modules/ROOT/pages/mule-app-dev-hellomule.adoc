...
image::mruntime-hellomule.png["Development environment showing a Mule application named 'Hello Mule' with components like Listener, Set Payload, and Logger"]
...
+
image::mruntime-hellomule-create-project.png["Dialog box for creating a new Mule project named 'Hello Mule' with options for selecting runtime versions"]
+
...
+
image::mruntime-hellomule-listener-config.png["HTTP Listener configuration in a Mule application"]
+
...
+
image::mruntime-hellomule-listener-path.png["Configuration settings for an HTTP Listener in a Mule application"]
+
...
*Test Connection*:
+
image::mruntime-hellomule-test-connection.png["Panel showing successful HTTP Listener connection test in Mule", 90%]
+
...
+
image::mruntime-hellomule-payload-config.png["Configuration panel for setting the payload in a Mule flow"]
+
...
+
image::mruntime-hellomule-logger.png["Logger component configuration in Hello Mule"]
+
...
+
image::mruntime-hellomule-browser-response.png["Web browser displaying the response 'Hello Mule!' from a local server"]
+
...
+
image::mruntime-hellomule-console.png["Console output showing logs from a Mule application named 'Hello Mule'"]
