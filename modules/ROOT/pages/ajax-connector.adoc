...
For details on setting the properties for an AJAX endpoint using an XML editor, see the xref:ajax-transport-reference.adoc[AJAX Transport Reference] discussion in the Mule ESB User Guide.