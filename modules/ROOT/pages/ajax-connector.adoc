...
* For details on setting the properties for an Ajax endpoint using an XML editor, see the xref:ajax-transport-reference.adoc[Ajax Transport Reference] discussion in the Mule Runtime documentation.
