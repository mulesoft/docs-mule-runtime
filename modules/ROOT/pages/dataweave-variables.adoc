...
Variable names have certain requirements to be valid, following are the rules for naming variables:

* All variable names must begin with a letter of the alphabet (a-Z).
* After the first letter, variable names can contain any combination of letters, numbers and underscores (`_`).
* The variable name cannot be any DataWeave reserved keyword (see <<reserved-keywords>> for a complete list).
...
The following table has some examples of invalid variable names, and a description of what makes them invalid:
...
The following list contain all reserved keywords that cannot be used as variable names:
