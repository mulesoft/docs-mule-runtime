...
DataWeave is a functional programming language in which variables behave just like functions. DataWeave eagerly evaluates variable, just as it consumes arguments to function. In addition, DataWeave variables are immutable. 
