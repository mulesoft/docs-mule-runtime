...
Variable names must meet the following requirements to be valid:
...
The following table provides examples of invalid variable names and a description of what makes them invalid:
