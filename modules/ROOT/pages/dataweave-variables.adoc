...
You can declare any variable name as long as it is a valid identifier. See xref:dataweave-language-introduction.adoc#valid-identifiers[Rules for Declaring Valid Identifiers] for more details.
