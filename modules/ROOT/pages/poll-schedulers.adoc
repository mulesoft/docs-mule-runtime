...
This document assumes that your are familiar with xref:5@studio::index.adoc[Anypoint Studio] and http://en.wikipedia.org/wiki/Polling_(computer_science)[polling] in general.  Read more about xref:poll-reference.adoc[poll scopes] in Mule.
