...
Mulesoft uses the Quartz scheduler library so you will need to use Quartz-style cron expressions. For more information see the http://www.quartz-scheduler.org/documentation/quartz-2.3.0/tutorials/crontrigger.html[Quartz cron] documentation. 
