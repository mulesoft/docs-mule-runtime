...
This document assumes that your are familiar with xref:6@studio::index.adoc[Anypoint Studio] and http://en.wikipedia.org/wiki/Polling_(computer_science)[polling] in general.  Read more about xref:3.6@poll-reference.adoc[poll scopes] in Mule.
