...
This document assumes that your are familiar with xref:6.x@studio::index.adoc[Anypoint Studio] and http://en.wikipedia.org/wiki/Polling_(computer_science)[polling] in general.  Read more about xref:3.6@poll-reference.adoc[poll scopes] in Mule.
...
image::poll-scheduler.png[poll_scheduler]
...
image::cron-scheduler.png[cron_scheduler]
...
* Learn more about xref:3.6@poll-reference.adoc[Poll Scopes] in Mule.
* Reference xref:3.7@mule-expression-language-mel.adoc[Mule Expression Language MEL].
* Learn more about xref:3.6@mule-expression-language-date-and-time-functions.adoc[MEL Date and Time Functions].
