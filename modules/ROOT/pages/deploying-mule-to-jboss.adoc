...
For information on configuring a JBoss JMS connector, see https://docs.archive.mulesoft.com/mule-user-guide/v/3.3/jboss-jms-integration[JBoss JMS Integration] and <<Using JBoss with AS 7>>.
