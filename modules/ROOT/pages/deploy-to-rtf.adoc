...
include::mule-runtime::partial$mmp-concept.adoc[tags=!authenticationMethodsIntro;!authenticationCloudHub;!authenticationOnPrem]
...
Example values: `4.2.0`, `4.2.2-hf4` | Yes
...
| `deploymentSettings` | Any of the parameters documented in xref:mmp-concept.adoc#deploymentsettings-reference[deploymentSettings Reference] | No
|===
