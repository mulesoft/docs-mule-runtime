...
include::mule-runtime::partial$mmp-authentication.adoc[tags=!authenticationMethodsIntro;!authenticationCloudHub;!authenticationOnPrem]
...
Must be the same or later than the minimum required Mule version for your application. | Yes
...
This name is part of the domain of your deployed app. | Yes
