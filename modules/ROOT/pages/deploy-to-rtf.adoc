...
include::partial$mmp-authentication.adoc[tags=!authenticationMethodsIntro;!authenticationCloudHub;!authenticationOnPrem]
...
| `muleVersion` | The release version of Mule runtime engine to run in your Runtime Fabric instance.  +
...
| `applicationName` | The application name displayed in Runtime Manager after the app deploys.
