...
[WARNING]
If you plan to connect to an external web service that exposes a WSDL file, the recommended connector to use is the xref:3.7@web-service-consumer.adoc[Web Service Consumer].
...
* xref:3.6@proxying-web-services.adoc[Creating a proxy/gateway to existing Web services] (for example, adding security to an existing Web service)
...
For more information, you can check the xref:3.6@consuming-web-services-with-cxf.adoc[Consuming Web Services with CXF] documentation.
...
For more information, read the xref:3.6@consuming-web-services-with-cxf.adoc[Consuming Web Services with CXF] documentation.
...
* xref:3.6@consuming-web-services-with-cxf.adoc[Use the JAX-WS Client API].
* xref:3.6@consuming-web-services-with-cxf.adoc[Build a Client Proxy].
...
For more information, read the xref:3.6@building-web-services-with-cxf.adoc[Creating a JAX-WS Service] documentation.
...
For more information, read the xref:3.6@building-web-services-with-cxf.adoc[Creating a WSDL First JAX-WS Service] documentation.
...
For more information, read the xref:3.6@building-web-services-with-cxf.adoc[Creating a simple front-end Web service] documentation.
...
* xref:3.6@proxying-web-services-with-cxf.adoc[Server-side Proxying]
* xref:3.6@proxying-web-services-with-cxf.adoc[Client-side Proxying]
...
* xref:3.6@cxf-module-reference.adoc[CXF Module Reference]
* xref:3.7@supported-web-service-standards.adoc[Supported Web Service Standards]
