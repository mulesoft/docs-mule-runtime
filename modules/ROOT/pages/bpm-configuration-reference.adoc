...
This page provides details on the process components you configure for BPM. Some of this information is pulled directly from `mule-bpm.xsd` and is cached. For more information on BPM, see xref:3.6@bpm-module-reference.adoc[BPM Module Reference]. Information on jBPM is available at http://www.jbpm.org.
...
See xref:3.7@exception-strategy-configuration-reference.adoc[Exception Strategy Configuration Reference].

== Entry Point Resolver

See xref:3.7@entry-point-resolver-configuration-reference.adoc[Entry Point Resolver Configuration Reference].