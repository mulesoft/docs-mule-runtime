...
This tutorial assumes that you have xref:5.x@studio::to-download-and-install-studio.adoc[installed, and launched Anypoint Studio], and that you've read through the xref:5.x@studio::index.adoc[Anypoint Studio Essentials].
