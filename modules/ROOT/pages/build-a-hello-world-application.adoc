...
This tutorial assumes that you have xref:5.x@studio::index.adoc[downloaded, installed, and launched Anypoint Studio], and that you've read through the xref:6.x@studio::index.adoc[Anypoint Studio Essentials].
...
* Skip ahead in the syllabus to the xref:6.x@studio::basic-studio-tutorial.adoc[Basic Studio Tutorial].