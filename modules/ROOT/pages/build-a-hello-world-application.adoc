...
This tutorial assumes that you have xref:5@studio::download-and-launch-anypoint-studio.adoc[installed, and launched Anypoint Studio], and that you've read through the xref:5@studio::index.adoc[Anypoint Studio Essentials].
