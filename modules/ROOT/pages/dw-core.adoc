...
| xref:dw-core-functions-indexof.adoc[indexOf] | Returns the index of the *first* occurrence of the specified element in this Array, or -1 if this list does not contain the element.
...
| xref:dw-core-functions-lastindexof.adoc[lastIndexOf] | Returns the index of the *last* occurrence of the specified element in this Array, or -1 if this list does not contain the element.
