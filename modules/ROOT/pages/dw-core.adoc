...
| xref:dw-core-functions-xsitype.adoc[xsiType] | Creates a xsi:type type attribute. This method returns an object so it is needs to be used with dynamic attributes.
