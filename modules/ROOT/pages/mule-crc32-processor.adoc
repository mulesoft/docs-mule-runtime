...
. Create a configure the global element through the Global Element tab at the bottom of the canvas, or directly within the CRC32 building block's Properties pane by clicking image:add.png[] icon right of the *Connector Ref* field.
...
.. Click the image:add.png[] icon next to the *Config Reference* field.
