...
. Create and configure the global element through the Global Element tab at the bottom of the canvas, or directly within the CRC32 processor's *Properties* pane by clicking the image:add.png[(plus)] icon to the right of the *Connector Ref* field.
