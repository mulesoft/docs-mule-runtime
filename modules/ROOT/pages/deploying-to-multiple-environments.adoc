...
[NOTE]
If you want to deploy your application to a specific environment in your own servers , MuleSoft recommends that you deploy your application via the command line or Mule Maven Plugin.
