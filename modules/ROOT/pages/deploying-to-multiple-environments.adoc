...
As a prerequisite you need to xref:runtime-manager::servers-create.adoc[create a server in Runtime Manager] and link it to the Mule. Then xref:runtime-manager::servers-properties-create.adoc[create a custom server property].
