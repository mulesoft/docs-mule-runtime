...
You can use an integrated development environment (IDE) such as Anypoint Studio (which is based on Eclipse), Eclipse, and IntelliJ to rapidly develop Mule applications. For more information on Anypoint Studio, see xref:6.x@studio::index.adoc[Anypoint Studio Essentials].
...
* Want more options for testing your Mule applications? Try https://docs.mulesoft.com/munit/v/1.2.0/[MUnit], the Mule testing framework.