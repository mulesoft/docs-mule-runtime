...
After you have ensured that your setup and configuration are correct and that your customizations work correctly, verify that your system is performing as intended. Tzhe xref:profiling-mule.adoc[Mule Profiler Pack] can identify memory leaks in your customizations.
