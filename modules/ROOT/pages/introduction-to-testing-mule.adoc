...
Mule provides legacy tools for testing your custom Mule applications using Java code. These tools provide the testing functionality but lack some features provided by MUnit, such as https://docs.archive.mulesoft.com/munit/v/1.2/mock-message-processor[mocking].
...
* xref:1.3@munit::index.adoc[MUnit v1.3]
