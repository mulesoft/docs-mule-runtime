...
A typical example of a message source is an xref:anypoint-connectors.adoc[*Anypoint Connector*].
...
[source,xml,linenums]
----
include::{examplesdir}/mule-application-architecture.xml[]
----
