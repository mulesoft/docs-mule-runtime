...
----
If you need to redeploy the application and there aren't properties configured in the deployment POM file, the existing properties in your CloudHub 2.0 environment are kept. Note that if properties are defined in the POM, the app is deployed using those properties, overriding any properties set in the UI.
| No
