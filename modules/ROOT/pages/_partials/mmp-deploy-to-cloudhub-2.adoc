...
----
| No
| `target` | The CloudHub 2.0 target name where to deploy the app. + 
Specify either a Shared space or a Private space available in your Deployment Target values in your CloudHub 2.0 instance. See xref:cloudhub-2::ch2-features[Features of CloudHub 2.0] for a detail description on Shares and Private Spaces. | Yes
