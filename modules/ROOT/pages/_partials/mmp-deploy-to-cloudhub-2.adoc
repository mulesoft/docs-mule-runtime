...
----
In case you need to redeploy the application, if there aren't properties configured in the deploy's POM file, the existing properties in your CloudHub 2.0 environment are kept.
| No
