...
When this parameter is set to `false`, no public URL is generated. +
This parameter is only used for applications that are deployed to xref:cloudhub-2-ch2-private-space-about.adoc[private space]. Applications that are deployed to xref:cloudhub-2-ch2-shared-space-about.adoc[shared space] always get a generated public URL.
