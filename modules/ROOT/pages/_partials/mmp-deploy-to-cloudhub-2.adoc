...
| `tracingEnabled` | Exposes tracing information in OpenTelemetry standard from Mule runtime into all APM solutions. See xref:cloudhub-2::ch2-deploy-private-space.adoc#enable-trace-data-collection[].
