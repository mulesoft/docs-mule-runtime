...
Example values: `4.6.0` selects the last build where it defaults to Edge channel and Java 8. If you want to select a different channel or Java version, specify the full Mule version name as in `4.6.0:1e-java17`.| Yes
