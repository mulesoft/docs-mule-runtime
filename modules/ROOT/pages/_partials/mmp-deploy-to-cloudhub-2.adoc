...
=== Maeven Snapshot Asssets

You can also deploy Maven snapshot assets into CloudHub 2.0. To learn more about publishing snapshot assets to Anypoint Exchange, see xref:exchange::to-publish-assets-maven.adoc#asset-lifecycle-state[Asset Lifecycle State].
