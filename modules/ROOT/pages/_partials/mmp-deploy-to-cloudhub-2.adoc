...
This parameter is only used for applications that are deployed to xref:cloudhub-2-ch2-private-space-about.adoc[]. Applications that are deployed to xref:cloudhub-2-ch2-shared-space-about.adoc[] always get a generated public URL.
