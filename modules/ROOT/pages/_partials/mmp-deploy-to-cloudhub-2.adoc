...
Specify either a shared space or a private space available in your Deployment Target values in CloudHub 2.0. See xref:cloudhub-2::ch2-features[Features of CloudHub 2.0] for a detail description on shared and private spaces. | Yes
