...
| `connectedAppClientId` | Specifies the Client Id key of the Connected App.
| `connectedAppClientSecret` | Specifies the Secret key of the Connected App.
| `connectedAppGrantType` | Specifies the type of Connected App credentials. The only supported type is `client_credentials`
