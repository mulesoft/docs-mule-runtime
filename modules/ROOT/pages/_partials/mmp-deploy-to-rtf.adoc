...
<deploymentSettings>
  <http>
    <inbound>
      <publicUrl>https://wwww.example1.com/myapp</publicUrl>
    </inbound>
  </http>
</deploymentSettings>
----
Configuration example using multiple single cert URLs:
[source,xml,linenums]
----
<deploymentSettings>
  <http>
    <inbound>
      <publicUrl>https://wwww.example1.com/myapp,>https://wwww.example2.com/myapp</publicUrl>
    </inbound>
  </http>
</deploymentSettings>
----
