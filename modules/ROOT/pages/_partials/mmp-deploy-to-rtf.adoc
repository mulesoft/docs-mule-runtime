...
You can also deploy Exchange snapshot assets into Runtime Fabric. To learn more about publishing snapshot assets to Anypoint Exchange, see xref:exchange::to-publish-assets-maven.adoc#asset-lifecycle-state[Asset Lifecycle State].
