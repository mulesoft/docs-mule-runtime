...
This document assumes basic familiarity with xref:anypoint-connectors.adoc[Anypoint Connectors] in Mule. Further, it assumes you have followed the instructions to xref:installing-connectors.adoc[install one or more versions of an Anypoint Connector] on your instance of Studio, and now wish to use the connectors in your Studio applications.
...
* Learn more about xref:anypoint-connectors.adoc[Anypoint Connectors] in Mule.