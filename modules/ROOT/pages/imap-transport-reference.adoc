...
|IMAP |[JavaDoc Sechema Doc] |image:check.png[] |image:error.png[] |image:error.png[] |image:error.png[] |image:error.png[] |image:error.png[] |one-way |one-way |org.mule.transport:mule-transport-imap
|IMAPS |[JaveDoc SchemaDoc] |image:check.png[] |image:error.png[] |image:error.png[] |image:error.png[] |image:error.png[] |image:error.png[] |one-way |one-way |org.mule.transport:mule-transport-imaps
|===
