...
| `minMuleVersion`
| String
| The minimum Mule runtime engine version required to run the application, for example `4.9.0`. The application can't be deployed to a runtime engine older than this version. See <<minmuleversion>> for details.
...
[NOTE]
Anypoint Studio and the Mule Maven Plugin manage the application descriptor automatically. You typically don't edit `mule-artifact.json` by hand.
