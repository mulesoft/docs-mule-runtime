...
You can specify the Mule runtime version that the Mule framework uses during the packaging process by adding the `runtimeVersion` property in the Mule Maven plugin configuration in your `pom.xml` file:
