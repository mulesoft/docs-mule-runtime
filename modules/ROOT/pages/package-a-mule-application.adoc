...
You can package your Mule applications using Mule Maven Plugin(command line) or Anypoint Studio. See xref:studio::import-export-packages.adoc#exporting-projects-from-studio[Exporting Projects from Studio] for details about this procedure.
...
These three components are mandatory. If one is missing, the project cannot be pacakged into a deployable JAR file. +
...
* xref:studio::import-export-packages.adoc#exporting-projects-from-studio[Exporting Projects from Studio]
