...
|image:python-transformer-24x16.png[Python-transformer-24x16] |python |Implements a script transformer backed by a Python script engine |xref:script-transformer-reference.adoc[Script Transformer Reference]
...
|image:transformer-24x16.png[Transformer-24x16]|Script |Implements a script transformer backed by a JSR-223- compliant script engine, such as a Groovy, Javascript, Python, or Ruby |xref:script-transformer-reference.adoc[Script Transformer Reference]
|===
...
|image:java-transformer-24x16.png[] |Java |Transforms the data from one format to another |xref:java-transformer-reference.adoc[Java Transformer Reference]
...
|image:transformer-24x16.png[Transformer-24x16] |Serialize-to-Byte-Array |Converts a Java Object to a byte array by serializing the object |xref:object-to-xml-transformer-reference.adoc[Object-to-XML Transformer Reference]
...
|image:transformer-24x16.png[Transformer-24x16] |XML-to-Json |Converts XStream to Json |xref:dataweave-reference-documentation.adoc#example-transformation[DataWeave XML to Json Example]
...
|image:transformer-24x16.png[Transformer-24x16] |Transformer Ref |References a transformer that is defined as a global element |xref:xslt-transformer-reference.adoc[ Transformer Reference]
...
|  |SAP-Specific +
 Transformer |Description |Documentation
|image:transformer-24x16.png[Transformer-24x16] |SAP-Object-to-XML *Enterprise Edition* |Transforms a SAP object representing a JCo function or IDoc document into its XML representation |xref:sap-connector.adoc[SAP Connector]
|image:transformer-24x16.png[Transformer-24x16] |XML-to-Function (BAPI) *Enterprise Edition* |Reads the XML representing a JCo function from java.io.InputStream, java.lang.String or byte[] to build the SAP object expected by the SAP transport |xref:sap-connector.adoc[SAP Connector]
|image:transformer-24x16.png[Transformer-24x16] |XML-to-IDOC *Enterprise Edition* |Reads the XML representing an IDOC document from java.io.InputStream, java.lang.String or byte[] to build the SAP object expected by the SAP transport |xref:sap-connector.adoc[SAP Connector]
|===
