...
=== Reader Properties (for CSV)
 ...
 The CSV format accepts optional properties that provide instructions for reading input data.
...
=== Writer Properties
 ...
 The CSV format accepts optional properties that provide instructions for writing output data.
