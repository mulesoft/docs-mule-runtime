...
The CSV reader accepts properties that provide instructions for reading input data.
...
The CSV writer accepts properties that provide instructions for writing CSV output data.
