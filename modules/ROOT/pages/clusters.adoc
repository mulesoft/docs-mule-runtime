...
For a detailed description of the format used in this document, consult https://docs.archive.mulesoft.com/mule-management-console/v/3.7/rest-api-reference[Content Organization and Conventions].
