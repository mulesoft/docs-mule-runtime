...
SharePoint Online Connector v1.0

Anypoint Connector for Microsoft SharePoint Online (SharePoint Online Connector) provides a web application platform for content and document management, intranet portals, collaboration, extranets, websites, and enterprise search.
...
Exchange: https://www.mulesoft.com/exchange/org.mule.modules/sharepoint-online/[SharePoint Online Connector] +
...
To install the connector, see xref:installing-connectors.adoc[Installing a Connector from Anypoint Exchange].
