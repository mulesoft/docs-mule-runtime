...
* xref:3.6@building-a-mule-application-with-maven-in-studio.adoc[Building a Mule application with Maven in Studio]
* xref:3.6@enabling-maven-support-for-a-studio-project.adoc[Enabling Maven support for an existing Studio project]
* xref:3.6@importing-a-maven-project-into-studio.adoc[Importing a Maven project into Studio]

*In Mule* Runtime:*

Maven-Mule Runtime functionality is provided by two Mule plugins for Maven.

* xref:3.7@maven-tools-for-mule-esb.adoc[Maven tools for Mule] is a plugin that provides archetypes for building regular Mule applications, allowing you to develop Mule applications from within Maven
* The xref:3.7@mule-esb-plugin-for-maven.adoc[muleesb-maven-plugin] allows you to control Mule ESB instances from within a Maven environment
...
* xref:3.6@using-maven-in-anypoint-studio.adoc[Using Maven in Anypoint Studio]
** xref:5.x@studio::maven-support-in-anypoint-studio.adoc[Maven Support in Anypoint Studio]
** xref:3.6@building-a-mule-application-with-maven-in-studio.adoc[Building a Mule Application with Maven in Studio]
** xref:3.6@enabling-maven-support-for-a-studio-project.adoc[Enabling Maven Support for a Studio Project]
** xref:3.6@importing-a-maven-project-into-studio.adoc[Importing a Maven Project into Studio]
* xref:3.7@using-maven-in-mule-esb.adoc[Using Maven in Mule]
** xref:3.6@configuring-maven-to-work-with-mule-esb.adoc[Configuring Maven to Work with Mule ESB]
** xref:3.7@maven-tools-for-mule-esb.adoc[Maven Tools for Mule]
** xref:3.7@mule-esb-plugin-for-maven.adoc[Mule Plugin For Maven]
* xref:3.7@maven-reference.adoc[Maven Reference]
...
* Learn more about xref:5.x@studio::maven-support-in-anypoint-studio.adoc[adjusting your Studio Preferences to work with Maven].
* Learn more about xref:3.6@importing-a-maven-project-into-studio.adoc[importing Maven projects into Studio] or xref:3.6@enabling-maven-support-for-a-studio-project.adoc["mavenizing" existing Studio projects].
* Using Maven outside of Studio? Refer to these instructions for xref:3.6@configuring-maven-to-work-with-mule-esb.adoc[configuring your Maven installation] to point to the necessary repositories.
* Access the xref:3.7@maven-reference.adoc[Maven reference documentation].