...
* Learn more about xref:5@studio::importing-a-maven-project-into-studio.adoc[importing Maven projects into Studio] or link:/mule-user-guide/v/3.7/enabling-maven-support-for-a-studio-project["mavenizing" existing Studio projects].
