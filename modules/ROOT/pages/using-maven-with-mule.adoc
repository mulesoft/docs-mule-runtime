...
* xref:enabling-maven-support-for-a-studio-project.adoc[Enabling Maven support for an existing Studio project]
...
* xref:maven-tools-for-mule-esb.adoc[Maven tools for Mule ESB] is a plugin that provides archetypes for building regular Mule applications, allowing you to develop Mule applications from within Maven
* The xref:mule-esb-plugin-for-maven.adoc[muleesb-maven-plugin] allows you to control Mule ESB instances from within a Maven environment
...
* xref:using-maven-in-anypoint-studio.adoc[Using Maven in Anypoint Studio]
...
* Learn more about xref:maven-support-in-anypoint-studio.adoc[adjusting your Studio Preferences to work with Maven].
