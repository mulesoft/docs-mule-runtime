...
* xref:5@studio::building-a-mule-application-with-maven-in-studio.adoc[Building a Mule application with Maven in Studio]
* xref:5@studio::enabling-maven-support-for-a-studio-project.adoc[Enabling Maven support for an existing Studio project]
* xref:5@studio::importing-a-maven-project-into-studio.adoc[Importing a Maven project into Studio]
...
[TIP]
For info on how to use Maven in the context of Anypoint Sutio, MuleSoft's IDE for developing integration applications, see xref:5@studio::using-maven-in-anypoint-studio.adoc[Use Maven in Anypoint Studio]
...
* **Build and run a new Maven project in Anypoint Studio.** If you're starting from scratch and you want to use Maven to build your project, begin by creating a new Maven-based project in Studio. You can then run the project with Maven from the command line, or run it directly from Studio. See xref:5@studio::building-a-mule-application-with-maven-in-studio.adoc[Building a Mule Application with Maven in Studio] for a step-by-step guide demonstrating how to create, manage, and run a Mule project with Maven.
...
* Learn more about xref:5@studio::importing-a-maven-project-into-studio.adoc[importing Maven projects into Studio] or xref:5@studio::enabling-maven-support-for-a-studio-project.adoc["mavenizing" existing Studio projects].
