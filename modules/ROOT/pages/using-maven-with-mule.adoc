...
** xref:5@studio::maven-support-in-anypoint-studio.adoc[Maven Support in Anypoint Studio]
** xref:3.6@building-a-mule-application-with-maven-in-studio.adoc[Building a Mule Application with Maven in Studio]
...
* Learn more about xref:5@studio::maven-support-in-anypoint-studio.adoc[adjusting your Studio Preferences to work with Maven].
