...
Mule ESB provides several xref:non-mel-expressions-configuration-reference.adoc[default expression evaluators], allowing you to embed expression logic in a variety of expression languages, or you can xref:creating-non-mel-expression-evaluators.adoc[create your own evaluators] to support additional languages.
