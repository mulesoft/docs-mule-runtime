...
Instead, please refer to xref:3.7@mule-expression-language-mel.adoc[Mule Expression Language MEL] for a complete user guide and reference.
====
...
Mule ESB provides several xref:3.6@non-mel-expressions-configuration-reference.adoc[default expression evaluators], allowing you to embed expression logic in a variety of expression languages, or you can xref:3.6@creating-non-mel-expression-evaluators.adoc[create your own evaluators] to support additional languages.

This page describes how to use expressions. For more details on how to configure expressions, see xref:3.6@non-mel-expressions-configuration-reference.adoc[Non-MEL Expressions Configuration Reference].

== Message Property Scopes

Starting with Mule 3 expressions operating on message properties also support an optional scope qualifier syntax. For more information about message scopes, see xref:3.7@mule-concepts.adoc[Mule Concepts].

== Using Expressions with Transformers

This section describes the transformers that support expressions. For more information on transformers, see xref:3.6@using-transformers.adoc[Using Transformers].
