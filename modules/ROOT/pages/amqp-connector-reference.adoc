...
*Required:* no +
*Default:* `false`
|`listenOnPrimaryNodeOnly` |Defines if the listeners will only consume messages when deployed in a primary polling node in a clustered environment. *(From 3.9.0 onwards)*
