...
* Cluster lifecycle management and control. See https://docs.archive.mulesoft.com/mule-management-console/v/3.7/managing-mule-high-availability-ha-clusters[Managing Mule High Availability (HA) Clusters].
* Cluster and node performance monitoring. See https://docs.archive.mulesoft.com/mule-management-console/v/3.7/monitoring-a-cluster[Monitoring a Cluster].
