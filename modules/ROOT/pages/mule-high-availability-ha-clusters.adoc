...
If you plan to use many nodes in your cluster, or you plan to store large message payloads, it is recommended that you research Hazelcast cluster scaling in the https://hazelcast.org/documentation/[Hazelcast documentation], or to contact * https://help.mulesoft.com[MuleSoft Support]
