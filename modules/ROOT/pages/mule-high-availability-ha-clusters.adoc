...
* You must keep the following port open to set up a Mule cluster: `5701`.
* If you configure your cluster to use multicast, you need to enable the multicast IP address: `224.2.2.3` and also open the port `54327`. Multicast is used to discover new cluster members.
