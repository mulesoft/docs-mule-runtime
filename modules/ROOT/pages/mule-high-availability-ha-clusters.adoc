...
:page-aliases: 1-installing-the-demo-bundle.adoc, 2-creating-a-cluster.adoc, 3-deploying-an-application.adoc, 4-applying-load-to-the-cluster.adoc, 5-witnessing-failover.adoc, 6-troubleshooting-and-next-steps.adoc, evaluating-mule-high-availability-clusters-demo.adoc
...
[NOTE]
High performance is implemented differently on xref:runtime-manager::index.adoc[CloudHub], so this section applies only for xref:runtime-manager::deploying-to-your-own-servers.adoc[on-premises deployments].
...
If you plan to use many nodes in your cluster, or you plan to store large message payloads, research Hazelcast cluster scaling in the https://hazelcast.org/documentation/[Hazelcast documentation] or contact https://help.mulesoft.com[MuleSoft Support].
// COMBAK: Commenting this out per JIRA SE-6162.
