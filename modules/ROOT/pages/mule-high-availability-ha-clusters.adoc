...
Mule uses an active-active model to cluster Mule runtime engines. The benefit of this model over an active-passive approach is that your application runs in all nodes, splitting apart message processing between the other nodes in your cluster expediting processing.
