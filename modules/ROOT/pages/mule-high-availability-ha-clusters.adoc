...
** If you use the fixed ports, keep TCP ports `5701`, `5702`, and `5703` open.
** If you configure custom ports instead, keep the custom ports open.

If you enable multicast for your cluster, the following additional prerequisites also apply:
