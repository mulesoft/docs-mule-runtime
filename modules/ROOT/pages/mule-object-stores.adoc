...
If you deploy your application to CloudHub, you can also use Object Store V2.
...
Alternatively, you can create the object store by including the object store configuration inside the component element in the XML configuration file, for example:
