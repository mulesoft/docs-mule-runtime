...
* *In-memory store* – Prior to Mule 3.5.0, in-memory store was the default. As of Mule 3.5.0, persistent store is the default. For more information, see "Object Stores and Clustering" in the xref:3.6@cache-scope.adoc[Cache Scope] document.
...
* Learn about the xref:runtime-manager::managing-application-data-with-object-stores.adoc[CloudHub implementation of object stores].