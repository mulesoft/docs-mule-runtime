...
. xref:6.x@studio::installing-extensions.adoc[Extend Mule with plugins, modules, runtimes and connectors] (_optional_)

For instructions on installing Anypoint Studio, the IDE for creating integration applications, see xref:6.x@studio::to-download-and-install-studio.adoc[Download and Launch Studio]
