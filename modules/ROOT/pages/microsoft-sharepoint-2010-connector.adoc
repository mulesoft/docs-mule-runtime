...
Anypoint Connector for Microsoft SharePoint 2010 (Microsoft SharePoint 2010 Connector) is a web application platform for content and document management, intranet portals, collaboration, extranets, websites,and enterprise search. The connector enables integration with SharePoint 2010 through its SOAP API.
...
Exchange: https://www.mulesoft.com/exchange/org.mule.modules/mule-module-sharepoint-2010/Microsoft SharePoint 2010 Connector]
