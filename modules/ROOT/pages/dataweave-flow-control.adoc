...
conditions. The condition can act on any valid DataWeave input. For example, the following uses `if else` statements with the result of the following conditions:
