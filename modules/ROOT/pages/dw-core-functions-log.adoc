...
Use this function to help debug DataWeave scripts until a proper
debugger is incorporated. A Mule app outputs the results
through the `DefaultLoggingService`, which you can see in the Studio
console.
...
|===
| Name | Description
| `prefix` | A optional string that typically describes the log.
