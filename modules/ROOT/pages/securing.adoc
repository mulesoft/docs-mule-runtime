...
:page-aliases: mule-security.adoc, configuring-security.adoc, migration-aes.adoc, migration-oauth2-provider.adoc, migration-security-filters.adoc
...
== TLS Configuration
TLS is a cryptographic protocol that provides communications security for your Mule app. Mule 4.x supports Transport Layer Security (TLS) 1.2 and 1.3.
