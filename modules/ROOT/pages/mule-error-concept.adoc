...
the Mule runtime engine and the module and connector operations configured
in the app can throw errors.
...
(`STREAM_MAXIMIMUM_SIZE_EXCEEDED`), while the operations can throw many different
...
[source,txt,linenums]
----
HTTP GET on resource 'https://jsonplaceholder.typicode.com:443/mybadrequest' failed: not found (404).
----
+
* `#[error.detailedDescription]` returns `HTTP GET on resource 'https://jsonplaceholder.typicode.com:443/mybadrequest' failed: not found (404).`

* `#[error.errorType]` returns `HTTP:NOT_FOUND`
* `#[error.cause]` returns `HTTP GET on resource 'org.mule.extension.http.api.request.validator.ResponseValidatorTypedException`
...
{
  payload=org.mule.runtime.core.internal.streaming.bytes.ManagedCursorStreamProvider@3a4799f4
  ...
  attributes=org.mule.extension.http.api.HttpResponseAttributes
{
   ...
   Headers=[
      date=Tue, 06 Oct 2020 21:31:47 GMT
      content-type=application/json; charset=utf-8
      content-length=2
      connection=keep-alive
      set-cookie=__cfduid=d3234e10c21675c2f007116edde4155241602019907; expires=Thu, 05-Nov-20 21:31:47 GMT; path=/; domain=.typicode.com; HttpOnly; SameSite=Lax
      x-powered-by=Express
      x-ratelimit-limit=1000
      x-ratelimit-remaining=999
      x-ratelimit-reset=1602019041
      ...
      cf-cache-status=HIT
      age=879
      cf-request-id=05a16cf1030000ebc13dae7200000001
      expect-ct=max-age=604800, report-uri="https://report-uri.cloudflare.com/cdn-cgi/beacon/expect-ct"
      report-to={"endpoints":[{"url":"https:\/\/a.nel.cloudflare.com\/report?lkg-colo=12&lkg-time=1602019908"}],"group":"cf-nel","max_age":604800}
      nel={"report_to":"cf-nel","max_age":604800}
      server=cloudflare
      cf-ray=5de27dc80ff5ebc1-LAX
   ]
}
  attributesMediaType=*/*
}
----
+
The `errorMessage` becomes available when a connector or component exposes
the information it normally propagates upon success, when the error does not
occur. For example, when an HTTP request receives a status code that Mule treats
