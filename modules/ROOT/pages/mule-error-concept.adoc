...
To use custom error types, you only need to define them either when mapping or raising the errors.
...
In the example below, you can see how mappings allow granular error handling by defining two custom error types:
