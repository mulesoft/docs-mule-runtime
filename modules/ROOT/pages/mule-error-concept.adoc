...
For details about how Mule defines error types in the API, see https://github.com/mulesoft-emu/mule-api/blob/master/mule-api/src/main/java/org/mule/runtime/api/message/ErrorType.java[ErrorType class].
