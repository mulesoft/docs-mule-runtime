...
The JSON reader accepts parameters that provide instructions for reading input data.
...
The JSON writer accepts parameters that provide instructions for writing output data.
