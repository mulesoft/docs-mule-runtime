...
The Avro reader accepts parameters that provide instructions for reading Avro input data.
...
The Avro writer accepts parameters that provide instructions for writing Avro output data.
