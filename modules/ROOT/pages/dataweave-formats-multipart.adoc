...
The Multipart reader accepts parameters that provide instructions for reading input data.
...
The Multipart writer accepts parameters that provide instructions for writing output data.
