...
The Multipart reader accepts properties that provide instructions for reading input data.
...
The Multipart writer accepts properties that provide instructions for writing output data.
