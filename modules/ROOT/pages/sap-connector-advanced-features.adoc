...
The SAP Connector provides a wide range of functionalities, beyond the basic ones already described in the xref:sap-connector.adoc[SAP Connector Documentation]. The present document will help you harness the full potential of your SAP Mule application.
...
[WARNING]
The key to a fully working application in cluster is the implementation of xref:reliability-patterns.adoc[reliability patterns].
...
[[see-also]]
== See Also
* xref:sap-connector.adoc[SAP Connector documentation].
