...
Mule supports the x86 and x64 architectures but does not yet support the ARM architecture. Support is planned for a future release.
...
|===
|Software |Version
| OS | MacOS 10.15, HP-UX 11i V3, AIX 7.2, Windows Server 2019, Windows 10, Solaris 11.3, Red Hat Enterprise Linux 8.1, Ubuntu Server 20.04
