...
|===
|Software |Version
| JDK | JDK 1.8 or JDK 11
|===

[NOTE]
MuleSoft recommends using AdoptOpenJDK with the latest version of OpenJDK 8 (LTS) and the HotSpot JVM.
...
This version of Mule Runtime is bundled with the Runtime Manager agent plugin version 2.3.0. For Runtime Manager Agent compatibility, see xref:release-notes::runtime-manager-agent/runtime-manager-agent-release-notes.adoc[Runtime Manager Agent Release Notes].

== See Also

* xref:private-cloud::system-requirements.adoc[About Minimum System Requirements for Anypoint Private Cloud]
