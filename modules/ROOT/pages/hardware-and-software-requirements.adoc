...
[TIP]
For Hardware and Software requirements of Anypoint Studio, MuleSoft's IDE for building integration applications, see xref:5.x@studio::hardware-and-software-requirements.adoc[Studio Hardware and Software Requirements].
