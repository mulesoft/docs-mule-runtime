...
+
image::mruntime-custom-business-event.png["Setup for a custom business event"]
...
+
image::mruntime-business-events-kpi.png["A configuration panel showing settings for a key performance indicator"]
