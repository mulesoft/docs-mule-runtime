...
** `(1 + 1 == 2)` evaluate to `true` in Design Center, `#[(1 + 1 == 2)]` evaluates to `true` in Anypoint Studio.

This example sets a variable to a Java object by using a DataWeave script. The script outputs the object in Java format:  `<set-variable value='#[%dw 2.0&#10;output application/java&#10;---&#10;{&#10;  name: "Tomo",&#10;  lastName: "Chibana",&#10;  expirationDate: now(),&#10;  salesRepr: {&#10;  name: "Mariano",&#10;  lastName: "de Achaval",&#10;  }&#10;} as Object {class: "Customer"}]' doc:name="Set Variable" variableName="Variable to Java Objects"/>`. 
