...
By default, mule uses two MDC entries: the "processor" (to show the current event location) and the "event" (to show the event correlation id). So, if you don't use the Mule Tracing Module:
