...
----
[NOTE]
You can use MDC Logging with Anypoint Runtime Fabric or CloudHub 2.0. +
However, if you are using CloudHub 1.0 to deploy your Mule applications, MDC logging isn't supported. For more information, see https://help.salesforce.com/s/articleView?id=001120207&type=1[MDC Logging Module support in CloudHub].
----
