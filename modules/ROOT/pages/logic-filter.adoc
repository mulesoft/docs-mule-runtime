...
* For more information about the And Filter, see xref:3.4@filters-configuration-reference.adoc[here].
* For more information about the Or Filter, see xref:3.4@filters-configuration-reference.adoc[here].