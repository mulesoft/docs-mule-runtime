...
In Mule, a non-repeatable stream can be read only once. Unlike most other Mule components, the Logger does not convert such a stream to a non-streamed or repeatable form.
