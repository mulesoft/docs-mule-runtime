...
The configured messages are logged to the app's log file, which is located in `MULE_HOME/logs/<app-name>.log` unless a custom log file path is specified in the `log4j2.xml` file. +
