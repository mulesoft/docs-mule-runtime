...
Unlike the Logger, many Mule components, such as Transform Message, convert such a payload into a non-streamed form. So a Logger located downstream of such a component no longer receives streamed payload.
