...
For Mule ESB Community _prior to Mule 3.2_, you must xref:configuring-reconnection-strategies.adoc[create your own strategies] and configure them using standard Spring syntax
====
