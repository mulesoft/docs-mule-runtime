...
This document assumes that you are familiar with the xref:6.x@studio::index.adoc[Visual Editor in Anypoint Studio], as well as the xref:3.7@anypoint-connectors.adoc[Anypoint Connectors] and xref:5.x@studio::datamapper-user-guide-and-reference.adoc[Anypoint DataMapper Transformer] that you can use to create applications in Studio. Further, this document references xref:3.7@connecting-using-transports.adoc[Connectors] and xref:3.6@global-elements.adoc[Global Elements.] Review xref:3.6@datasense.adoc[DataSense] to learn more about the overall DataSense functionality.
...
* Connection testing functionality is only available in xref:6.x@studio::index.adoc[Studio's Visual Editor].
...
+
Select one of the xref:5.x@studio::datasense-enabled-connectors.adoc[*Anypoint Connectors* which support connection testing].
...
* Learn how to exploit xref:5.x@studio::using-perceptive-flow-design.adoc[DataSense Perceptive Flow Design].
* Review the xref:3.6@datasense.adoc[DataSense] functionality.