...
* Learn about the xref:dataweave.adoc[Data Weave] transformer, the most efficient way to assign mappings to data.
* Learn about the xref:choice-flow-control-reference.adoc[Choice]
* Learn about the xref:splitter-flow-control-reference.adoc[Splitter]
