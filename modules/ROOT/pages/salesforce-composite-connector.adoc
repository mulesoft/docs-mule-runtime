...
This document assumes you are familiar with Mule, xref:3.7@anypoint-connectors.adoc[Anypoint Connectors], and xref:6@studio::index.adoc[Anypoint Studio Essentials] To increase your familiarity with Studio, consider completing one or more xref:6@studio::basic-studio-tutorial.adoc[Anypoint Studio Tutorials]. Further, this page assumes that you have a basic understanding of xref:3.7@elements-in-a-mule-flow.adoc[Mule flows] and xref:3.7@global-elements.adoc[Mule Global Elements].
...
To use the Salesforce Composite connector in your Mule application, you must configure a global Salesforce Composite element that can be used by all the Salesforce Composite connectors in the application (read more about xref:3.7@global-elements.adoc[global elements]).
...
+
NOTE: In the image above, the placeholder values refer to a configuration file placed in the *src* folder of your project (Learn how to xref:3.7@configuring-properties.adoc[configure properties]). You can either hardcode your credentials into the global configuration properties, or reference a configuration file that contains these values. For simpler maintenance and better re-usability of your project, Mule recommends that you use a configuration file. Keeping these values in a separate file is useful if you need to deploy to different environments, such as production, development, and QA, where your access credentials differ. See xref:3.7@deploying-to-multiple-environments.adoc[Deploying to Multiple Environments] for instructions on how to manage this.
+
...
The purpose of this connector is to let you take advantage of composite resource of Salesforce REST API. It comes to you with operations that have xref:3.6@datasense.adoc[DataSense] support in order to give you the best user experience in preparing sub-requests that are going to be executed in one batch and also for parsing the responses that come from Salesforce.
...
* Learn about the xref:3.7@dataweave-tutorial.adoc[DataWeave] transformer, the most efficient way to assign mappings to data.
* Learn about the xref:3.7@choice-flow-control-reference.adoc[Choice]
* Learn about the xref:3.6@splitter-flow-control-reference.adoc[Splitter]
* Read more about xref:3.7@anypoint-connectors.adoc[Anypoint Connectors].
