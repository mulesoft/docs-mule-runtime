...
Batch jobs capture record-level failures during batch step execution. For details about the error representation and how to access error fields, see xref:batch-error-concept.adoc[Batch Errors].
