...
* https://docs.mulesoft.com/downloads/mule-runtime/v3.8/rosettanet-buyer-app.zip[Buyer App (.zip)]
* https://docs.mulesoft.com/downloads/mule-runtime/v3.8/rosettanet-seller-app.zip[Seller App (.zip)]
