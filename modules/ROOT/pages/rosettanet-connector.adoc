...
* https://docs.mulesoft.com/downloads/mule-runtime/v3.9/rosettanet-buyer-app.zip[Buyer App (.zip)]
* https://docs.mulesoft.com/downloads/mule-runtime/v3.9/rosettanet-seller-app.zip[Seller App (.zip)]
...
This page requires some basic knowledge of xref:mule-concepts.adoc[Mule Concepts],
...
You can run these two applications in the xref:shared-resources.adoc[shared domain] in Studio, but to show the logged messages clearly, the example uses two Studio applications, one for the buyer app and the other for the seller app.
