...
If you are using the Enterprise Edition of Mule, you can use the xref:3.3@mule-management-console::index.adoc[Mule Management Console] to update a running application.