...
Read through this user guide to understand how to set up and configure a basic flow using the connector. Track feature additions, compatibility, limitations and API version updates with each release of the connector using the xref:release-notes::connector/hdfs-connector-release-notes.adoc[Connector Release Notes]. Review the connector operations and functionality using the http://mulesoft.github.io/mule-hadoop-connector/[Technical Reference] and the https://www.anypoint.mulesoft.com/exchange/org.mule.modules/mule-module-hdfs/[Anypoint Exchange HDFS connector].

Since version 5.0.0, MuleSoft maintains this connector under the xref:anypoint-connectors.adoc#connector-categories[_Select_] support policy.
...
For hardware and software requirements, visit the xref:hardware-and-software-requirements.adoc[Hardware and Software Requirements] page.
...
[IMPORTANT]
Starting with v5.0.0, the HDFS connector is licensed commercially with Anypoint Platform as are other xref:anypoint-connectors.adoc#connector-categories[_Select_] connectors.  Prior versions will remain freely available to the community.
...
[NOTE]
See a full list of operations for any version of the connector in the http://mulesoft.github.io/mule-hadoop-connector/[HDFS Hadoop Reference].
...
Existing demos demonstrate how to use the connector for http://mulesoft.github.io/mule-hadoop-connector/[basic file system operations] and how to http://mulesoft.github.io/mule-hadoop-connector/[poll data from a file] at a specific interval.
