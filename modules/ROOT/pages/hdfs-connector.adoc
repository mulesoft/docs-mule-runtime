...
Review the connector operations and functionality using the http://mulesoft.github.io/mule-hadoop-connector/[Technical Reference]. 

Starting in version 5.0.0, MuleSoft maintains this connector under the xref:anypoint-connectors.adoc#connector-categories[_Select_] support policy.
...
[IMPORTANT]
Starting with v5.0.0, HDFS Connector is licensed commercially with Anypoint Platform as are other xref:anypoint-connectors.adoc#connector-categories[_Select_] connectors.  Earlier versions remain freely available to the community.
