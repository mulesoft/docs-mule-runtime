...
* Access the xref:3.6@anypoint-enterprise-security-example-application.adoc[example application] which demonstrates Anypoint Enterprise Security in action.