...
To use the OpenAir connector in a production environment, you must have an Enterprise license to use Mule. Contact the mailto:info@mulesoft.com[MuleSoft Sales Team] to obtain either of these. Read more about xref:installing-an-enterprise-license.adoc[Installing an Enterprise License].

=== Hardware and Software Requirements

For hardware and software requirements, visit xref:hardware-and-software-requirements.adoc[Mule Hardware and Software Requirements] page.
...
[NOTE]
See the full list of operations for the latest version of the connector http://mulesoft.github.io/mule-netsuite-openair-connector/[here].


=== Configuring the Global Element

To use the OpenAir connector in your Mule application, configure a global OpenAir element that can be used by the OpenAir connector (read more about  xref:global-elements.adoc[Global Elements].) The OpenAir connector offers one global configuration, requiring the following credentials: Username, Password, Company ID, API Namespace, and API Key.
