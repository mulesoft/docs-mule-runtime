...
For hardware and software requirements, please visit xref:hardware-and-software-requirements.adoc[Mule Hardware and Software Requirements] page.
...
http://mulesoft.github.io/mule-netsuite-openair-connector/[here]


=== Configuring the Global Element

To use the OpenAir connector in your Mule application, you must configure a global OpenAir element that can be used by the OpenAir connector (read more about  xref:global-elements.adoc[Global Elements].) The OpenAir connector offers one global configuration, requiring the following credentials: *Username*, *Password*, *Company ID*, *API Namespace*, and *API Key*.
