...
Mule runtime engine 4.x supports Transport Layer Security (TLS) 1.1, 1.2 and 1.3*.

== TLS compatibility matrix

.TLS compatibility matrix
|===
|TLS Version |Standalone|CloudHub|RTF
|1.1 3+|Supported & enabled
|1.2 3+|Supported & enabled
|1.3|Supported but not enabled by default|Not supported|Supported & enabled
|===
