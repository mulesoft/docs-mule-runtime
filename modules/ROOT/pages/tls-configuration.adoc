...
:page-notice-banner-message: TLS 1.1 support ends for Mule versions released on October 7, 2025 and later. Update your applications to use TLS 1.2 or TLS 1.3 to maintain secure connections.
