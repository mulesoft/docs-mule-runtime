...
|1.3|Supported when running Mule on a JDK that supports 1.3. but _not enabled by default_|Not supported|Supported when running on a JDK that supports 1.3 and _enabled by default_
