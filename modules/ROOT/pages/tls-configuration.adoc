...
Mule runtime engine 4.x supports Transport Layer Security (TLS) 1.1 and 1.2. If Mule is running on a JDK that supports TLS 1.3, Mule can run applications that use TLS 1.3.
