...
:page-notice-banner-message: TLS 1.1 support ends for new Mule minor versions starting with Mule 4.10. Update your applications to use TLS 1.2 or TLS 1.3 to maintain secure connections before upgrading.
...
* https://docs.oracle.com/javase/8/docs/technotes/tools/#security[Oracle security^]
