...
----
+
. Export your certificate using any of the following options.
+
* Export a self-signed certificate authenticating the public key.
+
...
----
+
* Generate both a certificate from Certificate Authorities and a self-signed certificate.
+
.. Run the following command:
+
----
