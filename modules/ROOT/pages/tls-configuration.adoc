...
|1.3|Supported when running Mule on a JDK that supports TLS 1.3 but _not_ enabled by default|Not supported|Supported and enabled when running on a JDK that also supports TLS 1.3
