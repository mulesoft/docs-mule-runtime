...
:page-notice-banner-message: TLS 1.1 support ends for new minor Mule versions released on or after October 7, 2025. Update your applications to use TLS 1.2 or TLS 1.3 to maintain secure connections before upgrading.
