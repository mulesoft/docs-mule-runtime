...
. From *Mule Palette* in Anypoint Studio, select and hold any component (for example: `Set Payload`)
. Drag and drop the component inside the Choice router until you see a vertical black line:
+
