...
:page-aliases: choice-router-xml-reference.adoc, migration-core-choice.adoc
...
image:mruntime-choice-configuration-studio.png["A flow showing the configuration of a Choice component in Studio"]
...
image:mruntime-choice-add-route.png["A flow showing a content-based routing configuration"]
...
image:mruntime-choice-new-route.png["A flow for a new content-based routing path"]
...
image::mruntime-choice-example.png["A flow for content-based routing including payload settings and error handling"]
