...
This document assumes that you understand the difference between xref:3.7@flows-and-subflows.adoc[synchronous and asynchronous flows]. Furthermore, you're also familiar with xref:3.6@scopes.adoc[Scopes] in general.
...
+
image::req-rep-config.png[req_rep_config]
+
[%header,cols="4*"]
|===
...
* Learn more about xref:3.7@flows-and-subflows.adoc[synchronous and asynchronous flows].