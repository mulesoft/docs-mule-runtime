...
This document assumes that you understand the difference between xref:flows-and-subflows.adoc[synchronous and asynchronous flows]. Furthermore, you're also familiar with xref:scopes.adoc[Scopes] in general.
...
* Learn more about xref:flows-and-subflows.adoc[synchronous and asynchronous flows].