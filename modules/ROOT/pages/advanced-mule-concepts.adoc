...
The xref:distributed-locking.adoc[distributed Locking]provides the ability to create locks for synchronizing access to resources within Mule components.
