...
The xref:about-classloading-isolation.adoc[Classloading Isolation] mechanism implemented in Mule 4 addresses potential issues caused when conflicting versions of the same library are visible in the same location.
...
You can see a list of xref:third-party-software-in-mule.adoc[Third-party software] that is included as part of Mule's  source code, either as examples, as default services or as dependencies.
