...
Both DataWeave examples return an array that combines and flattens the
elements from two arrays. The second example applies the selector `fruit`
...
next is addition of the `.fruit` selector to the body expression
