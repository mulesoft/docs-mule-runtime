...
Every payload modification, variable addition, modification or removal will be propagated through the rest of the execution. This includes modifications done inside the error handlers. 
