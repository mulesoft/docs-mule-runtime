...
In all this cases the transaction created at Flow level will be rolled back, and the message will be available to be read again. We analyze what happends with the Try Scope:
