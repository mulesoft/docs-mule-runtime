...
This document assumes familiarity with http://git-scm.com/[git] as a software version control system, and that you are using xref:6.x@studio::index.adoc[Anypoint Studio] to build a new application that you intend to manage using git.
...
* Learn about xref:5.x@studio::using-subversion-with-studio.adoc[Using Subversion with Studio].