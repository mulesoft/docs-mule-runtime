...
This document assumes familiarity with http://git-scm.com/[git] as a software version control system, and that you are using xref:6.x@studio::index.adoc[Mule Studio] to build a new application that you intend to manage using git.
