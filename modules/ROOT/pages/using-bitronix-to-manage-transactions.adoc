...
+
image::bitronix-studio.png["A configuration tab for selecting a global element type with options including Bitronix Transaction Manager in Anypoint Studio"]
