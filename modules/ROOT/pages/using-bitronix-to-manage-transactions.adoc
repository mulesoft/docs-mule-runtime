...
This document assumes you are familiar with working with xref:3.7@shared-resources.adoc[Shared Resources] in Mule.
...
Bitronix integration provides a datasource connection pool for the xref:3.6@database-connector.adoc[Database connector], which you must use whenever you want to implement resource pooling in the database connector.
