...
Edit your `pom.xml` file to include the following:
...
The repository for the plugin is at https://repository.mulesoft.org/nexus/content/repositories/releases. To add it to your Maven installation, edit your `pom.xml` file to include the following:
...
To run the plugin, use your system's console to navigate to the root directory of your project and type:
...
NOTE: For the following example to work, your `pom.xml` must include the repository where Mule is available.
...
|`businessGroup` |Specifies the path to the business group you want to deploy to, if any. The default is the main organization.
...
|`businessGroup` |Specifies the path to the business group you deploy to, if any. The default is the main organization.
