...
For daylight saving you can also use the time zone ID values. The following example uses the `>>` operator and the time zone ID `America/Los_Angeles` to change the time zone.
