...
Because MuleSoft recommends running Mule using the default settings, if you decide to customize thread pool configurations, be sure to perform load and stress testing with all applications, using real-life scenarios, and validating the impact in all the applications deployed in the same runtime.
...
Because MuleSoft recommends running Mule using the default settings, if you decide to customize thread pool configurations, be sure to perform load and stress testing with all applications, using real-life scenarios, and validating the impact in the applications.
