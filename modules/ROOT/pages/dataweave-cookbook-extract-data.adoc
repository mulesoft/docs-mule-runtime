...
DataWeave can select data from objects, arrays, and variables that store data
in objects and arrays. You can use selectors in Mule modules, connectors, and
...
```
+
Only returns the first `user` value, `"a"`.
