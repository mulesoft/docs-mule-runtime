...
This example uses the selectors `..` and `&amp` to select all descendants
of
...
to select and return all descendant objects with the key `name` in an
array of DataWeave objects. It transforms the JSON input to XML output.
