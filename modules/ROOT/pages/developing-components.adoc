...
For details on configuring entry point resolvers, see xref:3.7@entry-point-resolver-configuration-reference.adoc[Entry Point Resolver Configuration Reference].
...
* Design your component in such a way that interface methods can be mapped to outbound endpoints and then use bindings to map these in configuration. For information on how to configure bindings, see xref:3.7@configuring-java-components.adoc[Configuring Java Components].
====
