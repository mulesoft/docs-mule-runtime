...
These simple DataWeave examples changes the XML input to JSON output. Note that more complex transformations usually require the use of the `map` or `mapObject` function.
