...
*When Mule is embedded in another container, the xref:3.8@mule-management-console::index.adoc[Mule Management Console] cannot perform Autodiscovery or server restarts.
