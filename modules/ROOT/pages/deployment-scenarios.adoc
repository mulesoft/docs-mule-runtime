...
You can also run multiple applications side-by-side in a Mule instance using the Mule Deployment Model. This model supports live deployment and hot redeployment of applications.  Further, Mule Standalone fully support for xref:mule-high-availability-ha-clusters.adoc[Mule High Availability] module.

For more information on deploying Mule apps, see xref:mule-deployment-model.adoc[Mule App Deployment Model].
