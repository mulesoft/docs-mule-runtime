...
These are several other components available that allow you to use different technologies such as xref:using-web-services.adoc[web services] for your components. These components are often included as part of xref:transports-reference.adoc[transports] or xref:modules-reference.adoc[modules].
...
|dispose |Called as the object is being disposed off. Typically this happens because either the MuleContext is shutting down. |`org.mule.api.lifecycle.Disposable` |`javax.annotation.PreDestroy`
|===
