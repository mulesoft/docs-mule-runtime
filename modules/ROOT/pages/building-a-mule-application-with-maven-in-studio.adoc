...
* Line number 12: This class extends FunctionalTestCase, which is Mule's implementation of an abstract JUnit test case. For more information, see xref:3.7@functional-testing.adoc[Functional Testing].
...
* Read more about xref:3.7@using-maven-with-mule.adoc[Using Maven with Mule].
* Learn how to xref:5.x@studio::maven-support-in-anypoint-studio.adoc[configure your Studio Preferences to work with Maven].
* Learn how to xref:3.6@importing-a-maven-project-into-studio.adoc[import an existing Maven project into Anypoint Studio].
* Access additional Maven xref:3.7@maven-reference.adoc[reference] and xref:3.6@configuring-maven-to-work-with-mule-esb.adoc[configuration] information.