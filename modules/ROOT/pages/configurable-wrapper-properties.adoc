...
* `strict` (also known as true) +
APIs blocked until the platform policies are applied. +
* `flexible` +
Is the default value, and behaves the same as `strict` but in the case of downtime, it tries to use local backup if available. +
