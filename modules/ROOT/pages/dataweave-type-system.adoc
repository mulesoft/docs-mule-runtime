...
[NOTE]
 The use of constraints is optional but it can be useful in big scripts or multiple scripts where the type system could help you avoid bugs in your DataWeave logic by running the type checking algorithm.
