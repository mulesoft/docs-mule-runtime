...
Except for the following changes, xref:3.9@mule-runtime::mel-cheat-sheet#server-mule-application-and-message-variables[context variables]
...
* xref:https://github.com/mulesoft/mule-migration-assistant/blob/master/docs/user-docs/migration-tool-post-mig.adoc#outbound_attachments[Outbound Attachments]
* xref:intro-mule-message#attachments[Attachments].
...
Use the DataWeave xref:dw-core-functions-now.adoc[`now`] function.
|===
