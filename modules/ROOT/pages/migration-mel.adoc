...
https://blogs.mulesoft.com/dev-guides/how-to-tutorials/why-dataweave-main-expression-language-mule-4/[Why DataWeave is the Main Expression Language in Mule 4 Beta]
