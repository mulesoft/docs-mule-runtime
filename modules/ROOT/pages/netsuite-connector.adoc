...
To use the NetSuite connector in your Mule application, configure a global NetSuite element that can be used by all the NetSuite connectors in the application (read more about xref:global-elements.adoc[global elements]).
...
You can download fully functional demo applications using the NetSuite connector from http://mulesoft.github.io/mule-netsuite-connector/[this link].
