...
Contact the https://www.mulesoft.com/lp/contact[MuleSoft Sales Team] to obtain either of these. (Read more about xref:installing-an-enterprise-license.adoc[Installing an Enterprise License].)
...
To use the NetSuite connector in your Mule application, you must configure a global NetSuite element that can be used by all the NetSuite connectors in the application (read more about xref:global-elements.adoc[global elements]).
