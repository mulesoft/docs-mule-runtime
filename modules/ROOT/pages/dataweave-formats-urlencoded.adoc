...
This example shows how to generate a URL Encoded data.

=== Input

The JSON object serves as the input payload to the DataWeave script.
...
The DataWeave script select the value of the `name` key in the input payload
...
The output is is URL encoded data that is constructed from the key-value pairs
