...
This example splits the number by `.` and applies the index selector `[0]` to the argument of the splitby function `(".")`. If the index is bigger or equal to 0, it starts counting from the beginning.
