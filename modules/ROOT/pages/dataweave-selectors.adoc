...
////
POSTPONED PUBLICATION OF THIS SECTION PENDING BUG FIX:
== Dynamic Selector
...
//TODO: EXAMPLES. ONCE BUG FIXED, can use variants of this for some dynamic
selection examples.
...
TODO payload:
----
<flow name="myFlow" xmlns:http="some_url" xmlns:foo="other_url">
    <http:listener>1111111</http:listener>
    <foo:listener>22222222</foo:listener>
    <listener>3333333</listener>
    <something>4444</something>
</flow>
----
////
