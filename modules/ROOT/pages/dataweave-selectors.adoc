...
This example shows how to dynamically select a single value. It uses the value
on the `"ref"` property to select the value with that key.
...
This example shows how to dynamically select a single value with namespace.
It uses the value on the `"ref"` property to select the value with that key.
