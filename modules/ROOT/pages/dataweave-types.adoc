...
that are based on the Java 8 `java.time.format` package, such as the `u` (for the year), `M`,
and `d` in the date format `uuuu-MM-dd`. The following example formats
...
output application/json
---
formattedDate: |2019-10-01T23:57:59| as String {format: "uuuu-MM-dd"}
----

.Output
[source,json,linenums]
----
{ "formattedDate": "2019-10-01" }
----
