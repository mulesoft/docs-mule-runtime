...
[
  ...
  { "am|pm-a" : now() as String {format: "a"} }, 
  ...
  { "timeZoneOffsetZforZero-XXXX" : now() as String {format: "XXXX"} }, 
  ...
  { "timeZoneOffset-xxxx" : now() as String {format: "xxxx"} }, 
