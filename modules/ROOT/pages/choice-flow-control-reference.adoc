...
In Studio, drag the *Choice* icon from the Studio palette to the canvas, positioning it within the sequence of xref:3.7@elements-in-a-mule-flow.adoc[building blocks] that form the flow (below).
...
+
image::drag-to-choice.png[drag_to_choice]
...
+
image::drag-session.png[drag_session]
...
+
image::drag-attachment.png[drag_attachment]
...
* For more information on the Choice Flow Control, see the xref:3.6@routers.adoc[Choice] section on the Routing Message Processors page.