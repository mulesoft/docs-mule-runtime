...
+
image::studio-choice-patternproperties.png[Studio_Choice_PatternProperties]
...
+
image::studio-choice-patternproperties-configured1.png[Studio_Choice_PatternProperties_configured1]
...
+
image::studio-choice-newdefault1.png[Studio_Choice_newdefault1]
...
+
image::studio-choice-newdefault3.png[Studio_Choice_newdefault3]
