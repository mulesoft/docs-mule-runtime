...
*Release Notes:* xref:release-notes::connector/amazon-sns-connector-release-notes.adoc[Amazon SNS Connector Release Notes]
...
You can install a connector in Anypoint Studio using the instructions in xref:installing-connectors.adoc[Installing Connectors].
...
+
image::sns-wrong-region.png[Wrong Topic Region Endpoint]
+
...
+
[.center.text-center]
image::sns-usecase-settings.png[Flow Settings]
+
...
You can download a fully functional example from http://mulesoft.github.io/mule-amazon-sns-connector/[this link].
