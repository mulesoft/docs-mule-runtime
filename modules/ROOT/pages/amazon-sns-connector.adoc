...
See the full list of operations for the latest version of the connector in the https://mulesoft.github.io/mule-amazon-sns-connector/[SNS Connector Reference].
...
[NOTE]
See the full list of operations for the latest version of the connector http://mulesoft.github.io/mule-amazon-sns-connector/3.0.0/apidocs/mule/sns-config.html[here].
...
You can download a fully functional example in the https://mulesoft.github.io/mule-amazon-sns-connector/[SNS Connector Reference].
