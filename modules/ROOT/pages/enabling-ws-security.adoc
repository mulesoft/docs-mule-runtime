...
For more information, see https://www.anypoint.mulesoft.com/exchange/?search=soap%20security[SOAP Web Service Security] in Anypoint Exchange. You can also use the xref:web-service-consumer.adoc[Web Service Consumer] to provide username token and timestamp support for WS-Security.
...
* See https://www.anypoint.mulesoft.com/exchange/?type=example[examples].