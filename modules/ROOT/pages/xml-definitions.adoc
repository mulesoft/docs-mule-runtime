...
For BAPIs (functions) the SAP Connector offers two different proprietary formats (Version 1 and 2), being version 2 the best option to use with xref:5.x@studio::datamapper-user-guide-and-reference.adoc[Anypoint DataMapper].
