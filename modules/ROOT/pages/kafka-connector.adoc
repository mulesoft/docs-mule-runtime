...
http://mulesoft.github.io/mule-kafka3-connector/[Technical Reference and Demo App Download] +
...
*Note:*
Track feature additions, compatibility, limitations and API version updates with each release of the connector using the xref:release-notes::connector/kafka-connector-release-notes.adoc[Connector Release Notes]. Review the connector operations and functionality using the http://mulesoft.github.io/mule-kafka3-connector/[Technical Reference] and in https://www.anypoint.mulesoft.com/exchange/?search=kafka[Anypoint Exchange].
