...
This document assumes you are familiar with xref:3.7@mule-expression-language-mel.adoc[Mule Expression Language (MEL)].  Further, this document assumes you are using Mule 3.4.0 or later.
...
|*xref:3.6@mule-expression-language-date-and-time-functions.adoc[compare]* a|
...
* Learn more about the xref:3.7@mule-expression-language-mel.adoc[Mule Expression Language (MEL)].