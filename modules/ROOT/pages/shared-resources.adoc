...
You can configure the <<create_domain_project,domain project>> by defining shared resources in your `mule-domain-config.xml` file. You can define multiple resources in this configuration file. In Anypoint Studio, you can edit this file in the XML editor or using the graphic interface.

=== Configure Shared Resources in the Configuration XML

You can configure shared resources by adding module or connector configurations to a domain's configuration XML.
...
=== Configure Shared Resources in the Global Elements Tab

You can configure shared resources by creating connector configurations in the *Global Elements* tab in Anypoint Studio. Before you can create connector configurations using Studio, you must add the module to your project.

For example, to add the HTTP connector to the domain project:
...
After you add the connector to the domain project, you can create a global configuration to use as a shared resource:

. In the *Global Elements* tab, click *Create*.
+
image:mruntime-domain-create-config.png[create config domain]
. Search for the connector you added to the project and continue with the configuration steps.
+
