...
Configure shared resources by using the *Global Elements* tab in Anypoint Studio to first add a module or connector to your domain project and then create module or connector configurations.
