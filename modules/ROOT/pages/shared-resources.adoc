...
+
image::mruntime-new-domain.png["Menu options for managing Mule projects and domains"]
+
. Fill in the same fields as you would with a regular Mule Project:
+
image::mruntime-create-domain.png["A new Mule domain with runtime version options"]
+
...
+
image:mruntime-domain-manage-modules.png["An interface for managing modules in a Mule domain configuration"]
. Click *Add Module*:
+
image:mruntime-domain-add-module.png["A configuration panel for adding modules to a project"]
. Search for the module you want to add and click *Add >*:
+
image:mruntime-domain-add-module-finish.png["A search interface for adding modules from MuleSoft Exchange to a project"]
. Click *Finish*.
...
+
image:mruntime-domain-create-config.png["An interface for creating and managing global configuration elements in a Mule domain"]
. Select the HTTP Connector and complete the configuration process:
+
image:mruntime-domain-connector-config.png["A menu for selecting global element types including HTTP and Sockets configurations"]
...
image::pick-resource.png["A configuration settings for an HTTP resource showing path and allowed methods"]
...
+
image::mruntime-run-configuration.png["Run configurations menu with options to manage and execute Mule projects"]
+
...
+
image::mruntime-run-configuration-properties.png["Run configuration properties with options for Mule applications and domains"]
...
+
image::mruntime-export-studio.png["A menu for exporting projects from Anypoint Studio to various destinations"]
+
