...
* Share metadata, if the Mule domain project is open on the workspace while you are working on the linked Mule project.
+
If the Mule domain project is not open on the workspace, you must input metadata manually on the linked Mule project.
