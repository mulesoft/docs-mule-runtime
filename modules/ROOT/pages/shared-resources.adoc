...
. In Studio, select `File > Export`. Then in the folder named *Mule*, pick *Anypoint Studio Project to Mule Deployable Archive (includes Studio metadata)*. This creates a `.jar` file that you can deploy to a standalone Mule runtime engine.
+
