...
In the following example, `mule-domain-config.xml`, an HTTP connector listener configuration is defined as a shared resource as well as an HTTP connector requester configuration.
