...
To use the Oracle EBS 12.2 connector in your Mule application, you must configure a global Oracle EBS 12.2 element that can be used by all the Oracle EBS 12.2 connectors in the application (read more about xref:3.7@global-elements.adoc[global elements]).
...
You can download fully functional demo applications using the Oracle EBS 12.2 connector from https://mulesoft.github.io/mule-oracle-ebs-12.2-connector/[this link].
