...
Contact the mailto:info@mulesoft.com[MuleSoft Sales Team] to arrange for either license. See also xref:3.7@installing-an-enterprise-license.adoc[Installing an Enterprise License].
...
|*Search Expression* | Use xref:3.7@mule-expression-language-mel.adoc[Mule Expression Language (MEL)] to define a search expression that would return a list of business components. |
...
[NOTE]
Refer to documentation on the xref:3.6@poll-reference.adoc[Poll Scope] , xref:5@studio::datamapper-user-guide-and-reference.adoc[DataMapper], and the xref:3.7@salesforce-connector.adoc[Salesforce connector] for in-depth information about these Mule elements.
...
+ image:poll2.jpg[]
+
A xref:3.6@poll-reference.adoc[Poll Scope] executes any Mule element you place inside it, at regular intervals. In this case, it is a Siebel endpoint.
...
[NOTE]
Refer to documentation on the xref:3.6@poll-reference.adoc[Poll Scope], xref:5@studio::datamapper-user-guide-and-reference.adoc[DataMapper], and the xref:3.7@salesforce-connector.adoc[Salesforce Connector] for in depth information about these elements.
...
image::poll2.jpg[]
+
A xref:3.6@poll-reference.adoc[Poll Scope]  executes the Mule element placed inside it at regular intervals. In this case, it is a Salesforce connector.
...
|===
|Element |Description
|Poll |A  xref:3.6@poll-reference.adoc[Poll Scope] executes the Mule element you place inside it at regular intervals. In this case, it is a Salesforce connector.
|===
+
[%header,cols="2*"]
|===
