...
For information on the elements you can configure for the Security Manager, see xref:3.7@security-manager-configuration-reference.adoc[Security Manager Configuration Reference]. The following sections provide links to information on configuring different types of security managers.
...
For more information on these features and instructions for downloading them, see xref:3.6@anypoint-enterprise-security.adoc[Anypoint Enterprise Security].
====
...
* xref:3.6@configuring-the-spring-security-manager.adoc[Configuring the Spring Security Manager]

* xref:3.7@component-authorization-using-spring-security.adoc[Component Authorization Using Spring Security]

* xref:3.7@setting-up-ldap-provider-for-spring-security.adoc[Setting up LDAP Provider for Spring Security]
...
* xref:3.6@enabling-ws-security.adoc[Enabling WS-Security] - Describes how to secure your CXF connectors with WS-Security.

* xref:3.6@saml-module.adoc[SAML Module] - Mule now supports the SAML standard for exchange of security information between systems. This module is available in the enterprise edition of Mule as of version 2.2.3

== Other Security Integration

Mule also supports the following security technologies:

* xref:3.7@encryption-strategies.adoc[Encryption Strategies] - Secure your messages by encrypting them.

* xref:3.6@pgp-security.adoc[PGP Security] - Secure your messages by encrypting them with PGP.

* xref:3.6@jaas-security.adoc[Jaas Security]