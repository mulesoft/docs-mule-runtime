...
The following XML snippet shows the configuration of a caching strategy that defines a persistent Object Store to cache the responses. The caching strategy is then referenced by a Cache Scope in the flow:
