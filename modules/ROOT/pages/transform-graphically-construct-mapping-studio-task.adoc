...
image::using-dataweave-in-studio-8e6e0.png["A JSON input and output structure"]
...
image::using-dataweave-in-studio-6b171.png["A list of items with fields including ItemID and DeliveryMethod"]

== Set a Fixed Value or Function

. Double click on a field in the output tree. This adds a function icon image:using-dataweave-in-studio-66cdc.png["Function icon", 5%, 5%] next to it.
