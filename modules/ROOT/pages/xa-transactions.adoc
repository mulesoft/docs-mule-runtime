...
* xref:jms-connector::jms-xa-transactions.adoc#[JMS Connector]
* xref:ibm-mq-connector::ibm-mq-transactions.adoc#xa-transactions[IBM MQ Connector]
* xref:vm-connector::vm-reference.adoc#parameters-6[VM Connector ]
* xref:db-connector::database-connector-xa-transactions.adoc[Database Connector]
