...
This page provides reference information about the elements and attributes you can configure for the xref:3.6@cxf-module-reference.adoc[CXF Module Reference].
