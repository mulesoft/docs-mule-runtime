...
Anypoint Connector for Microsoft Dynamics GP enables Mule apps to interact with the Microsoft Dynamics Great Plains (GP) Web Services.
...
Reference: https://mulesoft.github.io/mule-microsoft-dynamics-gp-connector/[Mule Microsoft Dynamics GP Connector Reference].


== Prerequisites

This document assumes that you are familiar with Microsoft Dynamics GP, Mule, Anypoint Connectors,
Anypoint Studio essentials, elements in a Mule flow, and global elements.


=== Hardware and Software Requirements

For hardware and software requirements, see xref:hardware-and-software-requirements.adoc[Hardware and Software Requirements].
...
To use the Dynamics GP connector in your Mule app, configure a global
...
You can download https://mulesoft.github.io/mule-microsoft-dynamics-gp-connector/[fully functional demo apps] for the Dynamics GP connector.
