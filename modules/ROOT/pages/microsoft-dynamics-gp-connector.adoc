...
For hardware and software requirements, see the xref:hardware-and-software-requirements.adoc[Hardware and Software Requirements] page.
...
You can download fully functional demo applications using the Dynamics GP connector from the https://mulesoft.github.io/mule-microsoft-dynamics-gp-connector/[Microsoft Technical Reference].
...
* http://forums.mulesoft.com/[Forum]