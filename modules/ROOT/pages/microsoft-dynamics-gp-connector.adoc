...
Review the connector operations and functionality using the https://mulesoft.github.io/mule-microsoft-dynamics-gp-connector/[Technical Reference].
...
You can download fully functional demo applications using the Dynamics GP connector from https://mulesoft.github.io/mule-microsoft-dynamics-gp-connector/[this link].
...
* Access the xref:release-notes::connector/microsoft-dynamics-gp-connector-release-notes.adoc[Microsoft Dynamics GP Connector Release Notes].
* Learn how to xref:6@studio::import-asset-exchange-task.adoc[To Import an Asset from Exchange].
* https://forums.mulesoft.com[MuleSoft Forum].
* https://support.mulesoft.com[Contact MuleSoft Support].
* https://mulesoft.github.io/mule-microsoft-dynamics-gp-connector/[Connector Reference].