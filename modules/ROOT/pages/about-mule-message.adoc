...
To understand why you use `statusCode` instead of `Status Code` or `"Status Code"` to select the status code value, see the <<note_top_level_selectors, note>> in the next section.
