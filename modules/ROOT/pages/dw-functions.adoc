...
Each DataWeave function in the reference is identified by its function signature, such as xref:dw-core-functions-contains.adoc#contains2[contains(String, String): Boolean] for the `contains` function. This function has two parameters, each of which accepts a value of the String type. The function returns as Boolean value. The parameters in the function correspond, _in order_, to its xref:dw-core-functions-contains.html#parameters-2[named parameters], in this case, `text` for the first parameter and `toSearch` for the second.
