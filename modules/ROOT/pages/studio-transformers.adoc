...
|image:python-transformer-24x16.png[] |Python |Implements a script transformer backed by a Python script engine |xref:script-transformer-reference.adoc[Script Transformer Reference]
