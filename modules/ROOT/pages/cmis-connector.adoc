...
* A global element for CMIS for use by all the CMIS connectors in your Mule application. For more information, see xref:global-elements.adoc[Mule Global Elements].
...
* Learn about xref:mule-expression-language-mel.adoc[Mule Expression Language]
