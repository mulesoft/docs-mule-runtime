...
This document assumes you are familiar with Mule, xref:anypoint-connectors.adoc[Anypoint Connectors],
...
* A global element for CMIS for use by all the CMIS connectors in your Mule application. For more information, see xref:3.6@global-elements.adoc[Mule Global Elements].
...
* Learn about xref:mule-expression-language-mel.adoc[Mule Expression Language (MEL)]
* Learn about xref:endpoint-configuration-reference.adoc[Configuring Endpoints]
* Learn about xref:mule-transformers.adoc[Mule Transformers]
