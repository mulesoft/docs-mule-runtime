...
+
Automatically uploads and starts your application in any of the Anypoint Platform or On-Premises deployment targets.
* `xref:mmp-concept.adoc#undeploy-goal[mule:undeploy]`
+
Automatically removes your application from any of the Anypoint Platform or On-Premises deployment targets.
...
The Mule Maven Plugin allows you to automate the deployment of your Mule application to any of the Anypoint Platform or On-Premises deployment targets. +
...
|`onlyMuleSources` | boolean | Generates the application JAR file with the source code only. This property is just for sharing purposes.
...
Uploads and deploys the application JAR file to any of the Anypoint Platform or On-Premises deployment targets.
...
Removes an application from any of the Anypoint Platform or On-Premises deployment targets.
