...
:page-aliases: add-mmp-task.adoc, packager-concept.adoc, package-task-mmp.adoc, application-structure-reference.adoc, mmp-deployment-concept.adoc, ch-deploy-mule-application-mmp-task.adoc, cloudhub-deployment-mmp-reference.adoc, runtime-fabric-deploy-mule-application-mmp-task.adoc, runtime-fabric-deployment-mmp-reference.adoc, stnd-deploy-mule-application-mmp-task.adoc, stnd-deployment-mmp-reference.adoc, arm-deploy-mule-application-mmp-task.adoc, arm-deploy-mule-application-mmp-reference.adoc, agent-deploy-mule-application-mmp-task.adoc, agent-deploy-mule-application-mmp-reference.adoc
