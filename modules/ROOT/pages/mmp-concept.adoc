...
The Mule Maven plugin enables you to automate the deployment of your Mule application to any of the application deployment targets (CloudHub, Runtime Fabric, or On-Premises). +

By default, this plugin enables you to deploy your Mule app by using any of five different deployment strategies:

* CloudHub deployment +
Automates the deployment of your Mule application to CloudHub. See xref:deploy-to-cloudhub.adoc[Deploy to CloudHub] for instructions.
* Runtime Fabric deployment +
Deploys your Mule application to Runtime Fabric.
...
Deploys your Mule application using the Mule Agent. +
...
Deploys your Mule Application to a Mule instance running on your machine.
...
You can set up a deployment configuration using the dedicated deployment reference for that strategy.
