...
----
<plugin>
include::4.2@mule-runtime::example$mmp-concept-config.xml[]
  <configuration>
    <cloudHubDeployment>
...
----
include::4.2@mule-runtime::partial$mmp-concept.adoc[tag=propertiesParameterDescription]
...
include::4.2@mule-runtime::partial$mmp-concept.adoc[tag=businessGroupParameterDescription]
include::4.2@mule-runtime::partial$mmp-concept.adoc[tag=businessGroupIdParameterDescription]
include::4.2@mule-runtime::partial$mmp-concept.adoc[tag=deploymentTimeoutParameterDescription]
include::4.2@mule-runtime::partial$mmp-concept.adoc[tag=serverParameterDescription]
include::4.2@mule-runtime::partial$mmp-concept.adoc[tag=skipParameterDescription]
|===
