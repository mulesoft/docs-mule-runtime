...
----
For other drivers than derby, you need to consider: https://help.mulesoft.com/s/article/Why-database-driver-can-not-be-found-when-moved-to-additionalPluginDependencies
