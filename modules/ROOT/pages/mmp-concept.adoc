...
This plugin allows you to deploy your Mule application to different deployment targets such as standalone Mule instances, clustered instances, and CloudHub.
...
include::mmp-concept.adoc[tag=businessGroupParameterDescription]
include::mmp-concept.adoc[tag=businessGroupIdParameterDescription]
include::mmp-concept.adoc[tag=deploymentTimeoutParameterDescription]
include::mmp-concept.adoc[tag=serverParameterDescription]
include::mmp-concept.adoc[tag=propertiesParameterDescription]
include::mmp-concept.adoc[tag=skipParameterDescription]
