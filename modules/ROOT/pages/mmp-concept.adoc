...
[NOTE]
Currently, Mule Maven plugin does not support the new Mule runtime version schema introduced with Mule 4.5. For Mule runtime 4.5, Mule Maven plugin deployment selection automatically defaults to the latest patch version.
