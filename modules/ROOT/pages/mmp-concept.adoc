...
The Mule Maven plugin enables you to integrate the packaging, testing, and deployment of your Mule applications with your Maven lifecycle. With the plugin, you can deploy your Mule application to different deployment targets, such as standalone runtimes, clustered instances, and CloudHub.
