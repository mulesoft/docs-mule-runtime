...
This page summarizes reference information that is helpful for working with Maven and Mule. Refer to xref:3.7@using-maven-with-mule.adoc[Using Maven with Mule] for an introduction and overview.
...
See xref:3.6@configuring-maven-to-work-with-mule-esb.adoc[Configuring Maven to Work with Mule ESB].
