...
See xref:on-premises::installing-an-enterprise-license.adoc[Install an Enterprise License], for instructions to acquire or install an Enterprise license
...
+
Read more about the `settings.xml` file in the https://maven.apache.org/settings.html[Maven documentation^].
