...
When you create a new Mule project from Anypoint Studio, the minimum required Mule repositories are automatically added to the `pom.xml` file. If you are creating the `pom.xml` file manually, add the following repositories:
...
The following set of commands enables you to retrieve information related to your Maven installation, as well as perform certain project-related tasks.
