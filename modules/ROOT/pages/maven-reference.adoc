...
See xref:configuring-maven-to-work-with-mule-esb.adoc[Configuring Maven to Work with Mule].
...
* https://github.com/mulesoft/mule-maven-plugin[Mule plugin for Maven]
