...
* HTTP Response attributes examples:
** `attributes.statusCode`: For getting the HTTP status code, such as `200`.
** `attributes.headers."content-type"`: For getting the HTTP content type, such as `application/json; charset=utf-8`.
...
>>>>>>> 65a2d3e0fc731d70c18c308a254d5655b81f0088
