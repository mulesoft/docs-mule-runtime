...
In Mule 4 to avoid a malformed URI when you make an HTTP request to the HTTP Listener, as recommended by in https://tools.ietf.org/html/rfc1738#page-3[RFC] encode characters such as `{` and `}` that you set in the HTTP request.
