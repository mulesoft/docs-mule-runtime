...
image::global-element-ext-properties.png[global_element_ext_properties]
...
image::003-select-function-or-idoc.png[003_select_function_or_IDoc]
...
image::endpointproperties-xml-def.png[EndpointProperties-XML_def]
