...
The Excel reader accepts optional parameters that provide instructions for reading Excel input data.
...
The Excel writer accepts optional parameters that provide instructions for writing Excel output data.
