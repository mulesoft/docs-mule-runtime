...
The Excel reader accepts parameters that provide instructions for reading Excel input data.
...
The Excel writer accepts parameters that provide instructions for writing Excel output data.
