...
|`ignoreEmptyLine`  |`Boolean`|`true`|Indicates whether any empty line should be ignored.
...
|`zipBombCheck`  |`Boolean`|`true`|"Indicates whether zip bomb check is turned on or off.
