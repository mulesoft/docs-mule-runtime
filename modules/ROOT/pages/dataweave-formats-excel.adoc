...
The Excel format accepts optional properties that provide instructions for reading input data.
...
The Excel format accepts optional properties that provide instructions for writing output data.
