...
For more information and full details about how to demarcate transactions in your Mule flow, refer to xref:3.6@transaction-management.adoc[Transaction Management].