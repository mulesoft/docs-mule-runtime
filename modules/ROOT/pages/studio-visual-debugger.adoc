...
Before accessing and debugging your application on a remote server, you must first https://docs.archive.mulesoft.com/mule-management-console/v/3.6/deploying-applications[export and deploy] your application to the desired Mule ESB server.
