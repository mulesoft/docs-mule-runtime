...
A flow reference can route messages to any type of flow within the same application. Refer to xref:3.7@flows-and-subflows.adoc[Flows and Subflows] for more information.
...
* Read more about the different kinds of xref:3.7@flows-and-subflows.adoc[Flows and Subflows] that you can call using a flow reference component.