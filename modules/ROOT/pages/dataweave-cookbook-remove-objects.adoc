...
* `filter` iterates over objects within an input array and to return an object that matches the result of an expression. Each object the input array contains a set of key-value pairs.
