...
image::mruntime-tuning-monitoring-top.png["A system monitoring output with process details including CPU and memory usage"]
...
image::mruntime-tuning-sar-cpu.png["A table showing CPU usage statistics including user and system times"]
...
.CG Log wrapper.conf
image::mruntime-tuning-wrapper.png["A text listing Java Virtual Machine options set in a configuration file"]
...
image::mruntime-tuning-sar-memory.png["A table showing memory usage statistics including columns for time, free memory, used memory, and cache size"]
...
image::mruntime-tuning-sar-disk.png["A table showing disk I/O statistics including columns for transactions per second and read/write sectors"]
...
image::mruntime-tuning-sar-network.png["A table detailing network interface statistics including packets and bytes sent and received"]
...
.Runtime Manager Dashboard
image::mruntime-tuning-runtimemanager.png["A line graph displaying CPU and memory usage over time in Runtime Manager"]
...
image::mruntime-tuning-anypointmonitoring.png["Anypoint Monitoring dashboard showing CPU and memory usage statistics for a Mule application"]
