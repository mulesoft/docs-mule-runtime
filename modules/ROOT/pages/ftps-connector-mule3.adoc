...
Use the Anypoint Connector for FTPS (FTPS Connector) to send and receive files over FTPS to enable seamless integration between Mule applications and an FTPS server, using Mule runtime.
