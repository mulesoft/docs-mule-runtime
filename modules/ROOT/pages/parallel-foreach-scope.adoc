...
However, because this feature is not available in the Anypoint Studio Mule Palette view, you must manually configure Parallel For Each scope in the XML, as follows:
...
None of the modifications done inside the For Each scope are registered, including the creation of new variables.
