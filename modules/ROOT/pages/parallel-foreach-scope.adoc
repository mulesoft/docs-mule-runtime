...
[IMPORTANT]
This component is not available in the Mule Palette from Anypoint Studio yet. You are able to configure and use the Parallel For Each scope by manually modifying the XML configuration.
