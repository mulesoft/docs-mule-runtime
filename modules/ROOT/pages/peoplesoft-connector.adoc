...
* *Anypoint Studio*. If you don't use Anypoint Studio for development, follow the instructions to http://mulesoft.github.io/mule-peoplesoft-connector/[install the PeopleSoft Maven dependencies] into your pom.xml file .
...
You can "test drive" the PeopleSoft connector in Anypoint Studio using the instructions in xref:installing-connectors.adoc[To Install a Connector from Anypoint Exchange].
