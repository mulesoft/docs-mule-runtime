...
* https://www.mulesoft.com/exchange/org.mule.modules/mule-module-peoplesoft/[PeopleSoft Connector on Exchange]
* http://mulesoft.github.io/mule-peoplesoft-connector/2.0.0/apidocs/mule/peoplesoft-config.html[Technical Reference Documentation]
