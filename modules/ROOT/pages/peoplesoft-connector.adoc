...
This document assumes you are familiar with Mule, xref:amqp-connector.adoc[Anypoint Connectors], and xref:studio::index.adoc[Anypoint Studio]. To increase your familiarity with Studio, consider completing one or more xref:general:getting-started:index.adoc[Anypoint Studio Tutorials].
...
NOTE: Contact the mailto:info@mulesoft.com[MuleSoft Sales Team] to obtain either of these. Read more about xref:installing-an-enterprise-license.adoc[Installing an Enterprise License].
...
NOTE: Read more about xref:installing-connectors.adoc[Installing Connectors].
...
NOTE: Read more about xref:global-elements.adoc[Global Elements].
...
+
[TIP]
Server, Username and Password use *property placeholder syntax* to load the credentials in a simple and reusable way. Read more about this practice at xref:configuring-properties.adoc[Configuring Properties].
+
[source,xml]
----
...
+
[NOTE]
Read more about MEL notation in xref:mule-expression-language-mel.adoc[Mule Expression Language Examples].
+
...
You can download a fully functional example from http://mulesoft.github.io/mule-peoplesoft-connector/[this link].

[[see-also]]
=== See Also

* For additional technical information regarding the PeopleSoft Connector, visit our http://mulesoft.github.io/mule-peoplesoft-connector/2.0.0/apidocs/mule/peoplesoft-config.html[online documentation].
