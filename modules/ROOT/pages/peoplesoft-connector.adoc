...
This document assumes you are familiar with Mule, xref:anypoint-connectors.adoc[Anypoint Connectors], and xref:studio::index.adoc[Anypoint Studio]. To increase your familiarity with Studio, consider completing one or more xref:general:getting-started:index.adoc[Tutorials].
...
To use the PeopleSoft connector in your Mule application, you must configure a global PeopleSoft element that can be used by the PeopleSoft connector (read more about  xref:global-elements.adoc[Global Elements]).
...
For additional technical details regarding PeopleSoft Connector configuration, visit the  http://mulesoft.github.io/mule-peoplesoft-connector/[APIdoc technical reference and example apps].
...
* For additional technical information regarding the PeopleSoft Connector, visit the http://mulesoft.github.io/mule-peoplesoft-connector/2.0.0/apidocs/mule/peoplesoft-config.html[technical reference documentation].
