...
. Package your Mule application's configuration file and custom Java classes in `.war` file (see xref:application-server-based-hot-deployment.adoc[Application Server Based Hot Deployment]).
...
* Learn about deploying Mule application in the cloud with https://docs.mulesoft.com/runtime-manager/cloudhub[CloudHub].