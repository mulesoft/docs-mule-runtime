...
Mule Runtime includes third-party software as part of the source code, examples, default services or as dependencies. Mule Runtime has dependencies on a subset of libraries from the following software. Apps may also include new third party dependencies which are not included in the following list. These latter dependencies are managed through maven. This information is current to Mule 4.1.6.
...
| Apache-2.0 | org.parboiled : parboiled_2.12 : 2.1.4
