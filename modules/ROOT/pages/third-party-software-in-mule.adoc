...
* `+http://aopalliance.sourceforge.net/++`: for for AOP
* `+https://opensource.org/licenses/APACHE-2.0++`: for for Apache-2.0
* `+https://en.wikipedia.org/wiki/BSD_licenses++`: for for BSD
* `+https://opensource.org/licenses/BSD-2-Clause++`: for for BSD-2-Clause
* `+https://opensource.org/licenses/BSD-3-Clause++`: for for BSD-3-Clause
* `+https://creativecommons.org/licenses/by-sa/3.0/us/++`: for for CC-BY-SA-3.0
* `+https://opensource.org/licenses/CDDL-1.0++`: for for CDDL-1.0
* `+https://spdx.org/licenses/CDDL-1.1.html++`: for for CDDL-1.1
