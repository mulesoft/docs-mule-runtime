...
IMPORTANT: Older versions of the runtime don't release resources after Dispose Store Operation. Set -M-Dmule.partitioned.persistent.os.only.clear.keys.on.dispose=true property to use old behaviour. 
