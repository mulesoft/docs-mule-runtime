...
|===
+
. Drag a Transform Message component onto canvas and paste the following code:
+
[source,xml,linenums]
----
%dw 1.0
...
----
+
. Drag an Object to Byte Array component next to the Transform Message component.
. Next, drag the Object Store connector next to the Object to Byte Array component and configure it according to the steps below:
