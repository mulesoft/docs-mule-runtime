...
* *External OS implementation*: This is the same as on-premises - allows you to use an external implementation as a backend for the object store. Examples include a MySQL database or Redis.
