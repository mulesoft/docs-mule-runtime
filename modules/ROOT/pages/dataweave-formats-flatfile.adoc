...
=== Reader Properties (for Flatfile)

The Flatfile format accepts optional properties that provide instructions for reading input data.
...
The Flatfile format accepts optional properties that provide instructions for writing output data.
