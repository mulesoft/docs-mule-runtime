...
* In clusters of Mule servers, messages can migrate between nodes when sent to an asynchronous flow. This allows for *load balancing between nodes* and higher performance of application. (See our xref:3.6@flow-architecture-advanced-use-case.adoc[advanced use case] for an example.)
...
Read more about setting up xref:3.6@transactional.adoc[Transactional units] in Mule applications.
====
...
|Asynchronous Flow |Flow Reference wrapped within an xref:3.6@async-scope-reference.adoc[Async Scope] |asynchronous |not inherited
|===

== See Also

* Read about some alternative ways to control message processing within a flow using xref:3.6@routers.adoc[routing message processors].
* Refer to the xref:3.6@flow-reference-component-reference.adoc[Flow Reference Component Reference] and xref:3.6@async-scope-reference.adoc[Async Scope].
* Read more about xref:3.7@flow-processing-strategies.adoc[Flow Processing Strategies].
* Read more about setting up xref:3.6@transactional.adoc[transactional units] in Mule applications.