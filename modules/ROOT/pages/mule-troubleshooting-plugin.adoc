...
[source,text]
----
"payment-service" - type: APPLICATION, state: STARTED
  Domain: shared-domain
  Last started: 2024-01-15 10:30:45
  Policies:
    - rate-limit-policy-001
...
"order-processing" - type: APPLICATION, state: STARTED
  Domain: shared-domain
  Last started: 2024-01-15 10:31:12
  Policies:
    - rate-limit-policy-003
  Plugins:
    - HTTP : 1.10.3
    - File : 1.5.0
    - JSON : 1.2.1
...
"inventory-service" - type: APPLICATION, state: STOPPED
  Last started: 2024-01-15 09:15:30
  Plugins:
    - HTTP : 1.10.3
    - Database : 1.8.2

"shared-domain" - type: DOMAIN, state: DEPLOYED
  Last started: 2024-01-15 08:00:00
  Plugins:
    - SharedConnector : 2.0.0
    - CommonLibrary : 1.3.5

"com.mulesoft.anypoint:mule-analytics-policy-template:4.11.0-SNAPSHOT" - type: POLICY_TEMPLATE, version: 4.11.0-SNAPSHOT
  Plugins:
    - AnalyticsPlugin : 1.5.0
    - HTTP : 1.10.3

"com.mulesoft.anypoint:rate-limiting-policy-template:1.4.0" - type: POLICY_TEMPLATE, version: 1.4.0
  Plugins:
    - SoapFault : 2.1.0
    - http-policy-transform : 3.2.0
    - throttling : 3.1.0
----
