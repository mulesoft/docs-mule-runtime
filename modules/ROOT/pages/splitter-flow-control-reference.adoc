...
You can look at the values of these outbound variables by putting a break point after the splitter and running your flow with the xref:5.x@studio::studio-visual-debugger.adoc[Visual Debugger]:
