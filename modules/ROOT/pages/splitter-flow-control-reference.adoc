...
It is important to note that the outbound variables will need to be backed up when using nested collection splitters (since each splitter will override the existing values of these variables).
