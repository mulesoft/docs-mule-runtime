...
+
You can look at the values of these outbound variables by putting a break point after the splitter and running your flow with the xref:6.x@studio::studio-visual-debugger.adoc[Visual Debugger]:
...
See the xref:splitter-flow-control-examples.adoc#example-nested-splitters[Nested Splitters Example] for more information.
