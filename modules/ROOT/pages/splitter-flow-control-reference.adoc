...
[NOTE]
Weigh the pros and cons of using a splitter and aggregator in your flow, versus using a "Foreach" scope xref:foreach.adoc#using-foreach-versus-splitter-and-aggregator-pairs[here].
