...
The Java Remote Message Invocation (RMI) transport sends and receives Mule events over Java Remote Method Protocol. This transport has a dispatcher that invokes an RMI method and a polling receiver that repeatedly does the same.
