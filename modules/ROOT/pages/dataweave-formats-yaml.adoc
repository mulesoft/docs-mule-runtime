...
The YAML reader accepts properties that provide instructions for reading input data.
...
The YAML writer accepts properties that provide instructions for writing output data.
