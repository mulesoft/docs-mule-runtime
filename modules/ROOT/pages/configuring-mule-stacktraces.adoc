...
provide stack traces and to filter out packages or classes to remove. To adjust these settings:
...
image::stack-traces-studio.png["A configuration panel including VM arguments"]
