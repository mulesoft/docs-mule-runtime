...
All notifications extend `java.util.EventObject`, and you can use the `getSource()` method to access the the payload of the object. The following table describes the payloads for each type of notification.
