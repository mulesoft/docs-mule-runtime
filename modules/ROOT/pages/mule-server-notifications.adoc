...
For a list of notification types, see xref:3.6@notifications-configuration-reference.adoc[Notifications Configuration Reference]. For a list of notification listener interfaces, see <<Notification Interfaces>> below.
