...
Developing in Maven is greatly simplified by the xref:maven-tools-for-mule-esb.adoc[Maven Tools for Mule ESB] plugin, which provides Maven archetypes for building Mule applications.
