...
In addition to fine-tuning the attributes of the queued-asynchronous processing strategy, you can also xref:tuning-performance.adoc[tune performance] of your Mule application by analyzing and configuring thread profiles.
...
* xref:tuning-performance.adoc[Tune performance]
