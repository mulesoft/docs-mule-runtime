...
This document assumes you are familiar with Mule, xref:3.7@connector-devkit::index.adoc[Anypoint Connectors] and xref:5@studio::index.adoc[Anypoint Studio Essentials]. Review xref:elements-in-a-mule-flow.adoc[Elements in a Mule Flow] and xref:global-elements.adoc[Global Elements] if you are unfamiliar with these topics.
