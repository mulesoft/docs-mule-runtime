...
| `readerProperties` | Optional: Sets reader configuration properties. For other formats and reader configuration properties, see https://docs.mulesoft.com/mule-runtime/4.2/dataweave-formats[Formats Supported by DataWeave].
|===
