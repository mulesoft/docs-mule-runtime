...
Global elements provide many benefits to you as a Mule application developer:
...
. Define the configurable parameters of your global element in the *Global Element Properties* window that shows.
. Click *OK* to save.
...
. Fill in the required fields for the type of global element you want to create.
