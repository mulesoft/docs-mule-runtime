...
+
image::mruntime-new-global-element.png["A menu for creating and managing global configuration elements in Mule"]
+
...
+
image::mruntime-global-element-component.png["A basic flow component setup with error handling"]
+
. In the properties panel, click the Add icon next to the *Connector Configuration*:
+
image::mruntime-global-element-create.png["An interface for creating a new global element in Mule"]
