...
This document assumes that you are familiar with the xref:5@studio::index.adoc[Anypoint Studio Essentials] document to learn more about developing with Mule's graphical user interface.
