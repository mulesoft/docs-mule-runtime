...
This document assumes that you are familiar with the
 xref:5.x@studio::index.adoc[Visual Editor in Anypoint Studio]. Review the xref:5.x@studio::index.adoc[Anypoint Studio Essentials] document to learn more about developing with Mule's graphical user interface.
...
* *NEXT STEP:* Use what you've learned to follow the xref:5.x@studio::basic-studio-tutorial.adoc[Basic Studio Tutorial].