...
*Connector Guide*: xref:file-connector.adoc[File Connector]
...
For new dateTime functions introduced into MEL with Mule 3.4 and later, see xref:mule-expression-language-date-and-time-functions.adoc[MEL Date and Time Functions].
