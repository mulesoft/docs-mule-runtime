...
For new dateTime functions introduced into MEL with Mule 3.4 and newer, see xref:mule-expression-language-date-and-time-functions.adoc[MEL Date and Time Functions].
