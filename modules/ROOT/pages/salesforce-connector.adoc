...
Starting with v.7.0.0, the Salesforce connector is licensed commercially with Anypoint Platform as are other xref:3.8@anypoint-connectors.adoc#connector-categories[_Select_] connectors.  Prior versions remain freely available to the community.
