...
* xref:release-notes::connector/
* See the xref:pop3-transport-reference.adoc[POP3 Transport Reference] for details on setting the properties for a POP3 endpoint using an XML editor.
