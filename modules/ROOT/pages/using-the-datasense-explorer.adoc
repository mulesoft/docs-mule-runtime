...
This document assumes you are familiar with Mule ESB and the xref:6@studio::index.adoc[Studio interface]. Further, it assumes you have read the xref:mule-message-structure.adoc[Mule Message Structure document] to understand the contents of a Mule message. To increase your familiarity with Studio, consider reading xref:6@studio::index.adoc[Anypoint Studio Essentials].
