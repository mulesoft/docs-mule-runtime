...
(the default for all Mule errors).
...
to handle that error can inspect the error and execute. If no error
handling is configured for the error, the app follows a
