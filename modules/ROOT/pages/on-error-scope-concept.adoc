...
configuration that matches the Mule error, such as for HTTP:NOT_FOUND,
...
On-Error components list the errors that the Mule runtime and configured
operations can throw. You can select the errors you want to handle.
...
* Matching: On-Error components can perform matching
