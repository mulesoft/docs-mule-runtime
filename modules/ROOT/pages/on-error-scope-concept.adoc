...
image::mruntime-error-handler.png["A palette menu for selecting error handling strategies in Mule applications"]
...
image::mruntime-on-error-propagate.png["An error handling configuration using 'On Error Propagate' in a Mule flow"]
...
+
image:mruntime-on-error-type-selection.png["An error type selection menu in a Mule application's error handling configuration"]
+
