= Migrating to the Anypoint MQ Connector
...
For information about the new subscriber, see xref:connectors::anypoint-mq/anypoint-mq-listener.adoc[Anypoint MQ Subscriber Source].
...
For more information, see xref:connectors::anypoint-mq/anypoint-mq-publish.adoc[Anypoint MQ Publish Operation].
...
For more information, see xref:connectors::anypoint-mq/anypoint-mq-consume.adoc[Anypoint MQ Consume Operation].
...
For more information, see xref:connectors::anypoint-mq/anypoint-mq-ack.adoc[Anypoint MQ ACK and NACK Operations].
