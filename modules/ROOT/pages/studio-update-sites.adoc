...
Access a list of xref:anypoint-connectors.adoc[Anypoint Connectors already installed in Studio] with this version.
...
|*API Gateway Update Site* |+https://studio.mulesoft.org.s3.amazonaws.com/r3/api-gateway/+ |API Gateway runtime |Read more about the xref:1.x@api-manager::api-gateway-runtime-archive.adoc[API Gateway Runtime].
...
|*MUnit* |+http://studio.mulesoft.org/r4/munit+ |xref:munit.adoc[MUnit] beta framework for testing Mule Applications |
|===
