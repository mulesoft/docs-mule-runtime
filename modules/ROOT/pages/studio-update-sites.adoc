...
|*Anypoint Studio Update Site* |+http://studio.mulesoft.org/r4/updates+|
...
|*Anypoint Studio Eclipse Plugin* |+http://studio.mulesoft.org/r3/plugin+ |
...
DataMapper designer
 ...
 |Read more about installing xref:5.x@studio::studio-in-eclipse.adoc[Anypoint Studio as an Eclipse Plugin].
