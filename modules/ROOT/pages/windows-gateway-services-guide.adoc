...
* xref:windows-powershell-connector-guide.adoc[PowerShell Connector]
* xref:microsoft-dynamics-crm-connector.adoc[Dynamics CRM Connector]
* xref:microsoft-dynamics-ax-2012-connector.adoc[Dynamics AX Connector]
...
. Download the Windows Gateway Services installer from https://repository-master.mulesoft.org/nexus/content/repositories/releases/org/mule/modules/anypoint-windows-gateway-service/1.11.1/anypoint-windows-gateway-service-1.11.1.zip[here]. Unzip the software distribution.
...
For more information on the PowerShell connector, see the xref:windows-powershell-connector-guide.adoc[Windows PowerShell Connector Guide].
...
For more information on the CRM connector, see the xref:microsoft-dynamics-crm-connector.adoc[Microsoft Dynamics CRM Connector Guide].
...
For more information on the AX connector, see the xref:microsoft-dynamics-ax-2012-connector.adoc[Microsoft Dynamics AX Connector Guide.]
