...
* To can filter what you see from the input or output structures, click the magnifying glass icon image:tips-transform-message-ui-studio-69e11.png["Search icon", 5%, 5%] at the top of either section and then start typing the name of a field.
