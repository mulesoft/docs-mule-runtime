...
|===
2+|Schema Summary
|http://www.mulesoft.org/schema/mule/atom/3.4/mule-atom.xsd[mule-atom.xsd] a|The Mule ATOM support makes it possible to integrate easily with Atom feeds and Atom Publishing Protocol servers via the Apache Abdera project.
