...
* xref:5.x@studio::index.adoc[Download, then install and launch Anypoint Studio].
* Investigate different xref:3.7@deployment-scenarios.adoc[Deployment Scenarios].
