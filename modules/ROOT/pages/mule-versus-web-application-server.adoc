...
* xref:6.x@studio::to-download-and-install-studio.adoc[Download, then install and launch Anypoint Studio].
* Browse different xref:deployment-scenarios.adoc[Mule Runtime Standalone Deployment Scenarios].
