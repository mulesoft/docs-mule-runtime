...
Namespaces can be configured in the Mule Configuration using the xref:3.6@xml-namespaces.adoc[XML Namespaces], these will be made available for this annotation.

First declare the namespace using the xref:3.6@xml-namespaces.adoc[Namespace Manager] -
