...
|When enabled, error suppression will happen. This feature prevents component such as the Web Service Consumer connector and the Until Successful scope from reporting errors outside their namespaces.
