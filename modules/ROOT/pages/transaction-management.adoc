...
A Transactional Action (`transactionalAction`) is the type of joining action that operations can take regarding transactions. The following is a list of all available transaction actions:
