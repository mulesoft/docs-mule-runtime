...
A Transactional Action (`transactionalAction`) defines the type of action that operations take regarding transactions. The following is a list of all available transactional actions:
