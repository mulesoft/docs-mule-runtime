...
+
image::transaction-config-studio-vm.png["A transaction configuration panel with settings for action and type"]
...
+
image::transaction-config-studio.png["A transaction configuration interface with settings for action and type"]
