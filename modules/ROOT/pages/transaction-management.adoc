...
|xref:3.6@single-resource-transactions.adoc[Single Resource Transactions] a|
...
|xref:3.7@multiple-resource-transactions.adoc[Multiple Resource Transactions] a|
...
|xref:3.7@xa-transactions.adoc[XA Transactions] a|
* Receives or sends messages to more than one resource.
...
While XA Transactions offer similar functionality, Multiple Resource transactions use less overhead.  XA transactions are more reliable. Both can include JDBC resources. 
====

== Assumption

This document assumes that you are familiar with Mule ESB and/or the xref:6.x@studio::index.adoc[Anypoint Studio interface]. Further, this document assumes you have some knowledge of transaction processing and are familiar with xref:3.7@anypoint-connectors.adoc[Anypoint Connectors].
...
Use xref:3.6@transactions-configuration-reference.adoc[Transactions Configuration Reference] for quick access to attribute configurations.
...
Apply a transaction to a flow that involves a single resource. See xref:3.6@single-resource-transactions.adoc[Single Resource Transaction] for details.
|XA Transaction |Apply a transaction to a flow that involves multiple resources: JMS, VM or JDBC. See xref:3.7@xa-transactions.adoc[XA Transaction] for details.
|Multi Transaction |Apply a transaction to a flow that involves multiple resources: JMS or VM. See xref:3.7@multiple-resource-transactions.adoc[Multiple Resource Transaction] for details.
...
* If you apply an XA transaction to a JMS inbound connector in your flow, you have the option of specifying the polling frequency of the queue. Access xref:3.7@xa-transactions.adoc[XA Transactions] for configuration details.
...
* Read more about xref:3.6@single-resource-transactions.adoc[Single Resource Transactions], xref:3.7@multiple-resource-transactions.adoc[Multiple Resource Transactions], and xref:3.7@xa-transactions.adoc[XA Transactions].
...
* Use the xref:3.6@transactions-configuration-reference.adoc[Transactions Configuration Reference] for quick reference to transactional attributes.
