...
* Read more about xref:single-resource-transactions.adoc[Single Resource Transactions], xref:multiple-resource-transactions.adoc[Multiple Resource Transactions], and xref:xa-transactions.adoc[XA Transactions].
