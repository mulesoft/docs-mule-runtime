...
For more information on best design-time practices with DataSense and DataMapper, consult the xref:3.6@datasense.adoc[DataSense documentation].
...
* Study several xref:3.7@database-connector-examples.adoc[example applications] which utilize the Database connector.
* Access plain xref:3.6@database-connector-reference.adoc[Reference material] for the Database connector.
