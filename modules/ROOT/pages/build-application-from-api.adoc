...
.REST Studio Project.
image::mruntime-rest-studio-project.png["A REST Studio project showing components including APIkit Router and API console"]

.SOAP Studio Project.
image::mruntime-soap-studio-project.png["A SOAP Studio project showing components including SOAP Router and Transform Message"]
...
.REST API Main Flow.
image::mruntime-rest-main-flow.png["A REST API main flow with components including Listener and APIkit Router"]

.SOAP API Main Flow.
image::mruntime-soap-main-flow.png["A SOAP API main flow with components including Listener and SOAP Router"]
