...
After you build your application, you can start consuming data from the API. Review xref:consume-data-from-an-api.adoc[Consume Data from an API documentation] for guidelines.
