...
* Access xref:3.6@mule-high-availability-ha-clusters.adoc[Mule High Availability (HA) Clustering] for an overview.

* Learn how to xref:3.7@creating-and-managing-a-cluster-manually.adoc[manually create and manage a cluster,] accessing additional options.

* Learn how to enable xref:3.6@distributed-file-polling.adoc[distributed file polling].