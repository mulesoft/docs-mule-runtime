...
+
image::configure-threading.png[configure_threading]
...
image::until-successful.png[until_successful]
...
. xref:3.8@idempotent-filter.adoc[idempotent filter] with an in-memory object store
...
* Learn more about https://docs.archive.mulesoft.com/mule-user-guide/v/3.4/tuning-performance[Tuning Performance] in Mule.
* Learn more about https://docs.archive.mulesoft.com/mule-user-guide/v/3.4/scopes[Scopes] in Mule in general.
