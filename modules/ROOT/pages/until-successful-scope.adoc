...
all succeed or exhaust the maximum number of retries. Like all Core components
...
+
Before throwing `MULE:RETRY_EXHAUSTED`, Mule also logs each unsuccessful retry, for example:
+
[source,logs]
----
ERROR 2022-12-09 17:41:44,910 ... event: cdad31c0-782b-11ed-af21-147ddaaf4f97] ...UntilSuccessfulRouter: 
Retrying execution of event, attempt 1 of 5.
...
ERROR 2022-12-09 17:41:55,079 ... event: cdad31c0-782b-11ed-af21-147ddaaf4f97] ...UntilSuccessfulRouter: 
Retrying execution of event, attempt 5 of 5.
----
