...
For information about pooling, see xref:tuning-performance.adoc[Tuning Performance].

== Enable Logging for Requests and Responses

To log requests and responses for the IBM CTG Connector, configure a Logger in the Loggers tag in your Mule app's log4j2.xml file:
