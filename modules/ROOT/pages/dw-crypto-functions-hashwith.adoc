...
|`MD2` |The MD2 message digest algorithm as defined in RFC http://www.ietf.org/rfc/rfc1319.txt[1319].
|`MD5` |The MD5 message digest algorithm as defined in RFC http://www.ietf.org/rfc/rfc1321.txt[1321.
