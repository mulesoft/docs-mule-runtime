...
This document assumes that you are familiar with xref:6@studio::index.adoc[Anypoint Studio] and have reviewed the overview and basic anatomy of xref:3.6@batch-processing.adoc[Batch Processing].
