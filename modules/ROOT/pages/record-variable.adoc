...
This document assumes that you are familiar with xref:5.x@studio::index.adoc[Anypoint Studio] and have reviewed the overview and basic anatomy of xref:batch-processing.adoc[Batch Processing].
