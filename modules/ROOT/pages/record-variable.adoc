...
During the xref:batch-processing.adoc[Process] phase of batch processing, use the *Record Variable message processor* to remove an existing `recordVars` from records, setting the *Operation* to *Remove Record Variable*.
[.ex]
=====
[discrete.view]
=== Studio Visual Editor
