...
This document assumes that you are familiar with xref:5@studio::index.adoc[Anypoint Studio] and have reviewed the overview and basic anatomy of xref:batch-processing.adoc[Batch Processing].
