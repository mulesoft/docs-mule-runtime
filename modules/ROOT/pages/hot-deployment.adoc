...
* Start your app with `mule -M-Dmule.deploy.applications=foo`
...
Therefore, if you want to change one of your custom classes, modify it, copy the updated class to the java directory, and then touch the anchor file.

== See Also
* xref:application-deployment[Application Deployment]
