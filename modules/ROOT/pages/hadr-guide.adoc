...
HA mechanisms and DR responsibilities differ depending on how you deploy Mule. Use the following table to identify the approach for your deployment model, and then read the deployment-specific guide for details.
