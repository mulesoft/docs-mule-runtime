...
The example below is assuming each environment is using the same number of Mule runtime instances and cores. It's plausible that the new environment may have more or less number than the baseline environment.
