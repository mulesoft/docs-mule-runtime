...
|`poolExhaustedAction` |`WAIT`, `DISCARD`, `DISCARD_OLDEST`, `ABORT`, `RUN` |no |  a|When the maximum pool size or queue size is bounded, this value determines how to handle incoming tasks.
