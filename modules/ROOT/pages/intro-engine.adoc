...
As mentioned above, there are thread pools for all flows in an app , configuared at runtime level. This decouples overall tuning from flow-specific behavior. Mule allocates threads in proportion to how many CPU cores your machine has.
