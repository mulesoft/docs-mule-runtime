...
[WARNING]
*Important*: Install the xref:windows-gateway-services-guide.adoc[Windows Gateway Service] before installing and configuring MSMQ.
...
The Windows Gateway Services supports running in a load-balanced configuration to allow for fault tolerance. See xref:windows-gateway-services-guide.adoc[Windows Gateway Service] documentation for more details.
