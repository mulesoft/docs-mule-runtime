...
The ndjson reader accepts parameters that provide instructions for reading input data.
...
The ndjson writer accepts parameters that provide instructions for writing output data.
