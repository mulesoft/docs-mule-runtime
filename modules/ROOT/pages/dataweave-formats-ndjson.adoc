...
=== Reader Properties (for Ndjson)
 ...
 The Ndjson format accepts optional properties that provide instructions for reading input data.
...
=== Writer Properties
 ...
 The Ndjson format accepts optional properties that provide instructions for writing output data.
...
|`skipNullOn`  |`String`|`null`| *Valid Options*: arrays or objects
