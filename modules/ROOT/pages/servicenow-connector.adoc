= ServiceNow Connector 4.0 - Mule 3
...
Anypoint Connector for ServiceNow (ServiceNow Connector) facilitates connections between Mule integration and ServiceNow applications. The ServiceNow connector currently provides access to standard tables in the ServiceNow database, enabling you to perform Insert, Delete Record, Delete Multiple, Update, Get, Get Keys, and Get Record operations on them.

Release Notes: xref:release-notes::connector/servicenow-connector-release-notes.adoc[ServiceNow Connector Release Notes] +
Reference: https://mulesoft.github.io/mule-servicenow-connector[ServiceNow Connector Reference]

== Prerequisites

This document assumes that you are familiar with ServiceNow, Mule, xref:anypoint-connectors.adoc[Anypoint connectors], and the xref:6@studio::index.adoc[Anypoint Studio interface]. To increase your familiarity with Studio, consider completing one or more xref:6@studio::basic-studio-tutorial.adoc[Anypoint Studio Tutorials]. Further, this page assumes that you have a basic understanding of xref:mule-concepts.adoc[Mule flows] and xref:global-elements.adoc[Mule Global Elements].
...
Contact the mailto:info@mulesoft.com[MuleSoft Sales Team] to obtain either of these. (Read more about xref:installing-an-enterprise-license.adoc[Installing an Enterprise License].)
