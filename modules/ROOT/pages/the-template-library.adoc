...
The template library is a discovery interface where you can find templates that can make the adoption of Anypoint Studio a lot easier. Although this library can be accessed via your installed copy of Anypoint Studio, it makes use of https://www.mulesoft.com/exchange/?type=template[Anypoint Exchange] and its list of templates, examples, and other assets.
