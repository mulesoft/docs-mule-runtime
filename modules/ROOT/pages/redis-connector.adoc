...
To use Redis connector in your Mule application, you must configure a global Redis element that can be used by all the connectors in the application (read more about xref:3.7@global-elements.adoc[global elements]).
...
[NOTE]
See the full list of operations for the latest version of the connector http://mulesoft.github.io/mule-redis-connector/[here].

== Managing the Connection Pool

To define the pooling profile for the connector manually, access the *Pooling Profile* tab in the applicable global element for the connector.

For background information on pooling, see xref:tuning-performance.adoc[Tuning Performance].
...
* http://mulesoft.github.io/mule-redis-connector/[Connector Reference].