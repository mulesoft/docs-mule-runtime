...
The AWS SDK for Java provides a Java API for AWS infrastructure services. The Amazon S3 connector is built using the SDK for Java. For the complete list of operations supported by the connector, see  http://mulesoft.github.io/mule-amazon-s3-connector/[Versioned Reference Documentation and Samples].
...
== Configuring the Connector Global Element Using Studio Visual Editor

To use the Amazon S3 connector in your Mule application, configure a global Amazon S3 element that can be used by all the Amazon S3 connectors in the application.
...
== Configuring the Connector Global Element Using the XML Editor
...
See the https://mulesoft.github.io/mule-amazon-s3-connector[full list of operations for the latest version of the connector].
...
=== Demo Mule Application Using Studio Visual Editor
...
=== Demo Mule Application Using XML Code
...
* xref:release-notes::connector/amazon-s3-connector-release-notes.adoc[Amazon S3 Connector Release Notes]
* Learn about xref:using-maven-with-mule.adoc[Using Maven with Mule]
* xref:mule-transformers.adoc[Mule Transformers]
* https://mulesoft.github.io/mule-amazon-s3-connector[S3 Connector Reference]