...
Release Notes: xref:release-notes::connector/amazon-s3-connector-release-notes.adoc[Amazon S3 Connector Release Notes - Mule 3] +
Reference: https://mulesoft.github.io/mule-amazon-s3-connector/[Amazon S3 Technical Reference]
...
After restarting, if you have several versions of the connector installed, Mule asks you for the version of the connector to use.

== Configure a Global Element

To use the Amazon S3 connector in your Mule app, configure a global Amazon S3 element that can be used by all the Amazon S3 connectors in the app (read more about  xref:global-elements.adoc[Global Elements].)
...
|===
+
In the image, the placeholder values refer to a configuration file placed in the
...
Follow these steps to configure an Amazon S3 connector in your app:
...
See the full list of operations for the latest version of the connector in the http://mulesoft.github.io/mule-amazon-s3-connector/[Amazon S3 Technical Reference].
