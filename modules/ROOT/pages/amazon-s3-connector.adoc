...
To use the Amazon S3 connector in your Mule application, configure a global Amazon S3 element that can be used by all the Amazon S3 connectors in the application (read more about  xref:global-elements.adoc[Global Elements].)
...
[NOTE]
See the full list of operations for the latest version of the connector http://mulesoft.github.io/mule-amazon-s3-connector/[here].
...
* http://mulesoft.github.io/mule-amazon-s3-connector/[Connector Reference]