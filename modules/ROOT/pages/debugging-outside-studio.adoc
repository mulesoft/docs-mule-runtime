...
In Anypoint Studio, you can use the xref:6.x@studio::studio-visual-debugger.adoc[Studio Visual Debugger] to help you troubleshoot your app. If you're creating your Mule app outside Studio, you can resort to the following options:
...
See xref:6.x@studio::studio-visual-debugger.adoc#debugging-remotely[Starting Mule Server In Debug Mode] for additional debugging options, such as changing the debug port from 5005 to another number.