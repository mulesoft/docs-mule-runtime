...
<<more_examples, examples>> in the documentation that act on a `payload`, you
...
+
image::studio-define-metadata[Define MetaData in Studio]
+
The metadata is for the content of the `myJson.json` file created in the
<<readUrl>> example. You need that file to complete this procedure.
+
