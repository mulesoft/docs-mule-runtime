...
comfortable with the examples here, you can try your own DataWeave scripts on
sample data.
...
----
+
Learn about xref:dataweave-language-introduction.adoc[DataWeave Scripts]
...
xref:mule-app-dev-tutorial.adoc[Mule App Tutorial]. Also note that when you
are learning to create your own Mule apps, some useful Mule components for trying out sample data without depending on external data sources are
...
of a Mule events to hold data set by those components.
