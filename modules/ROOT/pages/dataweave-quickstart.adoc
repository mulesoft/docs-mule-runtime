...
.. Now revise the DataWeave script in the code edit area to select the
value of the payload instead of the entire object: `payload.hello`, and
notice that the output  `"world"`.
+
