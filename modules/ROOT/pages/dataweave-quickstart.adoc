...
DataWeave variable (`var`) in the header of a DataWeave script. Then, in the
body of the script, you replace `payload` with the name of the new variable
...
content of a local file that contains your data. You can then load that content
...
<<readurl_ex, readUrl>> example. You need that file to complete this procedure.
+
