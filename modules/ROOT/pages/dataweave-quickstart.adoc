...
For DataWeave examples with more than a few lines of sample data, you should
create a custom data type for a `payload` through Transform Message. The data
type accepts local file that contains sample data. Follow these steps to load
the `src/main/resources/myJson.json` content (created in the
