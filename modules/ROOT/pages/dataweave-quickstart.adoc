...
.. Now change the body of the script in the source code area to `payload.hello`.
+
...
Core components accept short DataWeave expressions in their *fx* fields.
+
To learn about them, you can start with xref:mule-application-about.adoc[Mule Applications].
+
