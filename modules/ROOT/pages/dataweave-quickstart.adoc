...
. Begin with a simple DataWeave script that concatenates two strings ("hello" and "World") together into a single string and then performs a simple JSON to XML transformation on the output:
...
the strings "hello" and "World" into a single string. When you are ready, you can learn more about the DataWeave xref:dw-core-functions-plusplus.adoc[++] function used to concatenate the strings.
