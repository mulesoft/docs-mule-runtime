...
+
. Now try a DataWeave script that simply introduces you to a variety of
...
the *Preview* pane. The structures `[1, 1000]` and `[1, 2, 3]`
...
script. The point here is to get a taste of DataWeave's ability to handle more
