...
in the component's *Preview* pane. Once you feel comfortable with DataWeave
examples here and elsewhere in the documentation, you can try out your own
DataWeave scripts on sample data.
