...
image::expression-transformer.png[expression_transformer]
...
The default value in the *Expression* field is `#[].` You need to type a valid expression within the square brackets. For syntax details see the xref:expression-transformer-reference.adoc[Mule Expression Language MEL] documentation.
...
image::expression-advanced.png[expression_advanced]
