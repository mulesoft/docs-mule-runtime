...
image::expression-transformer1.png[]
...
The default value in the *Expression* field is **`#[]`**. You need to type a valid expression within the square brackets. For syntax details see the xref:3.4@mule-expression-language-mel.adoc[Mule Expression Language MEL] documentation.
...
image::expression-transformer2.png[]
