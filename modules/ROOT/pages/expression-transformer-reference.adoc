...
[NOTE]
--
The default value in the *Expression* field is `#[]`. You need to type a valid expression without the square brackets. For syntax details see the xref:mule-expression-language-mel.adoc[Mule Expression Language MEL] documentation.
--
