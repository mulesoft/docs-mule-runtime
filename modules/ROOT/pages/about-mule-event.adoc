...
A Mule event source (previously called a "message source") triggers the generation of a Mule event and dispatches that event to the flow. Examples of event sources include the Scheduler, HTTP Listener, and On New or Updated File components.
