...
For more information on component configuration, see xref:3.7@configuring-components.adoc[Configuring Components]. For more information on the elements you use to configure components, see xref:3.6@component-configuration-reference.adoc[Component Configuration Reference].
