...
image::reliability-pattern.png["A flow showing a reliable message handling process using VM"]
...
image::reliabilitypatternwithjms.png["A flow showing a reliable message acquisition and response process using JMS"]
