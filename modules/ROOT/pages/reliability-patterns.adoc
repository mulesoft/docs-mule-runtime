...
Here is a code example that shows what a complete reliability pattern would look like, including the reliable acquisition flow and application logic flow. In this example, the reliable acquisition flow part of the reliability pattern is HTTP-to-VM. Note that this example shows VM file persistency, which does not work on clusters.
