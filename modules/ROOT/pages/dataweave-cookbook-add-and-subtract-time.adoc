...
For additional information about adding and subtracting periods, see time and duration designators in xref:dataweave-types.adoc#dw_type_dates_period[Period].
