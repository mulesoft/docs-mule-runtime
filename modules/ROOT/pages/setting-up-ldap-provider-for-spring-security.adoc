...
* To perform xref:3.7@component-authorization-using-spring-security.adoc[component authorization]

For information on configuring an in-memory provider, see xref:3.7@configuring-security.adoc[Configuring Security].
...
The configuration for component authorization is similar to the one described in xref:3.7@component-authorization-using-spring-security.adoc[Component Authorization Using Spring Security]. A key point of configuration is `securityMetadataSource`:
