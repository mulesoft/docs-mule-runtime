...
This procedure assumes that you already have a Mule instance installed on your host machine. If not, follow the instructions for xref:downloading-and-starting-mule-esb.adoc[downloading and installing Mule].
