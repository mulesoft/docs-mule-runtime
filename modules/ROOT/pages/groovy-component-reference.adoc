...
Refer to the generic xref:script-component-reference.adoc[Script Component Reference] page to see how a script works with one-way and request-response endpoints.
