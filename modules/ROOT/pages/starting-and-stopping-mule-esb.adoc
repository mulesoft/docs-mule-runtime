...
* *NEXT STEP:* Graduate to the content of the First Week with Mule chapter, starting with xref:3.6@mule-application-architecture.adoc[Mule Application Architecture].