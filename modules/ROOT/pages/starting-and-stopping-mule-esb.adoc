...
[NOTE]
====
You can also start Mule without executing the installation step. This will start Mule in the background for the current user session.
====
...
* xref:mule-runtime::runtime-installation-task.adoc[Download, Install, Configure, Upgrade Mule]
