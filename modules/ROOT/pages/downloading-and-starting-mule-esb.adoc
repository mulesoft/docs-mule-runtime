...
. _Optional_: xref:5.x@studio::adding-community-runtime.adoc[Add Community runtime] to your Studio instance.
...
* xref:5.x@studio::installing-extensions.adoc[Extend Mule] with plugins, modules, runtimes, and connectors.

* Access a list of all the xref:5.x@studio::studio-update-sites.adoc[update sites] available for your version of Studio.