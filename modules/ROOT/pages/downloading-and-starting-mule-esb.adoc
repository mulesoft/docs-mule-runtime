...
. Download xref:6.x@studio::to-download-and-install-studio.adoc[Anypoint Studio], which includes the Mule Runtime.
...
. _Optional_: xref:6.x@studio::adding-community-runtime.adoc[Add Mule CE] to your Studio instance.
...
* xref:6.x@studio::installing-extensions.adoc[Extend Mule] with plugins, modules, runtimes, and connectors.
* Access a list of all the xref:6.x@studio::studio-update-sites.adoc[update sites] available for your version of Studio.
