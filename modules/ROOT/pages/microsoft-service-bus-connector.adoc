...
To install a connector, see xref:installing-connectors.adoc[To Install a Connector from Anypoint Exchange].
...
* For code samples that illustrate more advanced scenarios, refer to link:{attachmentsdir}/service-bus-connector-samples.zip[service-bus-connector-samples.zip].
* Learn how to xref:installing-connectors.adoc[Install and Configure Anypoint Connectors] in Anypoint Studio.
* Access MuleSoft’s http://forums.mulesoft.com[forums] to pose questions and get help from Mule’s broad community of users.
* To access MuleSoft’s expert support team, https://www.mulesoft.com/support-and-services/mule-esb-support-license-subscription[subscribe] to Mule Enterprise and log into MuleSoft http://www.mulesoft.com/support-login[Customer Portal].