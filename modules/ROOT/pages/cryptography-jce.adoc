...
* Password-based encryption (PBE): Encrypt/sign content by providing only an encryption password.
* Key-based Encryption: Similar to how PGP and XML encryption works, this method enables you to configure a symmetric or asymmetric key to perform encryption/signing operations.
...
=== Configuring Password-Based Encryption From Anypoint Studio
...
. Configure the *Algorithm* and *Password* properties:
+
...
Configure a symmetric or asymmetric key to perform encryption/signing operations.

=== Configuring Key-Based Encryption From Anypoint Studio
...
The following are examples of operations that use the asymmetric keys defined in the previous configuration:
...
The following are examples of operations that use the symmetric keys defined in the previous configuration:
