...
In Anypoint Studio: 
. Add the `Xml sign` operation to your flow. 
. Configure the operation with a Module Configuration or create a new one, selecting the desired keystore, type (JKS, JCEKS, PKCS12) and password. You can also add Symmetric or Asymmetric key info to be used in the sign operations. 
. Configure the key selection by using a key id previously defined in the Module Configuration, or a new one defined for this operation. 
