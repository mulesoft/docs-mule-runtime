...
----
include::partial$cookbook/change-value-of-a-field-ex1/transform.dwl[]
----

.Input XML
[source,xml,linenums]
----
include::partial$cookbook/change-value-of-a-field-ex1/inputs/payload.xml[]
----

.Output XML
[source,xml,linenums]
----
include::partial$cookbook/change-value-of-a-field-ex1/out.xml[]
----
...
[source,dataweave,linenums]
----
include::partial$cookbook/change-value-of-a-field-ex2/transform.dwl[]
----

.Input XML
[source,xml,linenums]
----
include::partial$cookbook/change-value-of-a-field-ex2/inputs/payload.xml[]
----
...
[source,xml,linenums]
----
include::partial$cookbook/change-value-of-a-field-ex2/out.xml[]
----
