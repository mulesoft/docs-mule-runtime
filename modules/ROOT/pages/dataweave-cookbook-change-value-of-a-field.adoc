...
The `update` operator provides the most general and easy way to change the value of a field. However, note that DataWeave provides a simpler way to mask values, without specifying the path to each sensitive field:
