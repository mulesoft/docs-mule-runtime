...
|===
|Filter |Description
|+http://www.mulesoft.org/docs/site/3.8.0/apidocs/org/mule/providers/email/filters/AbstractMailFilter.html+ |A base filter implementation that must be extended by any other mail filter.
|+http://www.mulesoft.org/docs/site/3.8.0/apidocs/org/mule/providers/email/filters/MailSubjectRegExFilter.html+ |Applies a regular expression to a Mail Message subject.
|===
