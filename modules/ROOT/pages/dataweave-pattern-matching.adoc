...
As in other languages, the DataWeave `match` function provides compact way to
...
If you want to name the input expression in the `else` statement, you can
...
For use cases where you simply need a Boolean result based on whether a value
