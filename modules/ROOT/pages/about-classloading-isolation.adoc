...
To avoid such conflicts, you can configure additional plugin dependencies to enrich a connector's classpath. This configuration enables you to effectively add new dependencies to a connector, as if the dependencies were declared in the connector's `pom.xml` file. +
