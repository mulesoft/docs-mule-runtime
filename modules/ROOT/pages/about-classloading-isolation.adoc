...
The Mule Runtime engine is developed using Java and many other third party libraries. Mule apps can also contain other Java libraries, particularly modules that extend the runtime to provide integration functionality, such as the HTTP connector and the XML module. These extensions can also contain other JAR libraries.
