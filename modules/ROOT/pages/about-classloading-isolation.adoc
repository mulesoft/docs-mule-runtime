...
Mule 4 provides a well-defined API that makes it easy for you to extend Mule and provides clarity on the proper extension points:
...
See xref:how-to-export-resources.adoc[] to export a resource from an artifact.
