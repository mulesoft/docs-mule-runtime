...
When the connectors in your application need access to a dependency in your project, you need to configure the dependency to be visible by the connector's class loader. There are two different ways to do this configuration:
