...
[NOTE]
This reference is for versions of the object store connector (object store module) prior to 2.0.0. xref:object-store-connector.adoc[Object Store connector v2 and later] is supported under the xref:anypoint-connectors.adoc#connector-support-categories[_Select_] support policy.  The xref:release-notes::connector/objectstore-connector-release-notes.adoc[release notes] detail all the changes for this module.
...
[NOTE]
====
To use the object Store module in Anypoint Studio, you must first download the https://anypoint.mulesoft.com/exchange/org.mule.modules/mule-module-objectstore/[Object Store Connector] from  Anypoint Exchange.
====
...
*MIME Type:* */* +
*Encoding:* UTF-8
|partition |Name of the partition. If set, and a partitionable object store is specified in the objectstore-ref attribute, it will be used. Otherwise, it will be ignored.
