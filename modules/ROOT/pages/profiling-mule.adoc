...
+
image::profiling-mule-286a5.png["A table listing applications with their PID and profiler status", 500%]
+
. Confirm that YourKit is connected to your Mule instance:
+
image::yourkit-hooked-up.png["A detailed CPU profiling interface from YourKit Java Profiler showing method performance", 1000%]
...
+
image::yourkit-auth.png["An SSH authentication dialog for YourKit", 500%]]
+
. Click *OK*.
