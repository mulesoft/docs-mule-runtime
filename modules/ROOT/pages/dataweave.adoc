...
[TIP]
====
DataWeave version 1.0 is embedded in the Mule 3.7 runtime that replaces the xref:5.x@studio::datamapper-user-guide-and-reference.adoc[DataMapper], which is a major component in previous versions. We recommend you use DataWeave to avoid the future obsolescence of Datamapper.
====
...
For complete DataWeave 1.0 documentation in its new location, see xref:1.0@dataweave::index.adoc[].
