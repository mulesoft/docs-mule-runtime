...
Take into consideration that key sizes may depend on the Java Cryptography Extension (JCE) version. For example, from version 1.8.0_161, AES key size should be of 32 characters (256 bytes), instead of 16 for previous versions.
