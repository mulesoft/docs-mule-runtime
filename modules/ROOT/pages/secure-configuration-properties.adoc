...
[NOTE]
Fully encrypted files are not supported as secure properties or YAML configuration files because the system requires access to unencrypted keys for secure property resolution.
