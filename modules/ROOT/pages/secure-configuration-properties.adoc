...
You can download the xref:attachments$secure-properties-tool.jar[Secure Properties Tool Jar file] for this tool to perform encryption or decryption operations.
