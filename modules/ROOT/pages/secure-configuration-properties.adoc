...
The following Algorithms are also supported, but you need to configure a xref:https://docs.oracle.com/cd/E19830-01/819-4712/ablsc/index.html[Java Cryptography Extension (JCE) Provider] that add support for them: 
