...
You can create your secure configuration properties files either in `src/main/resources` in your Mule project, or by using absolute paths.
...
== Encrypt or Decrypt Secure Configuration Properties
