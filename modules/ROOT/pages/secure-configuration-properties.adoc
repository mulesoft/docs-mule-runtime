...
Download link: https://github.com/mulesoft/docs-mule-runtime/tree/v4.4/modules/ROOT/attachments/secure-properties-tool.jar[Secure Properties Tool Jar file]. +
