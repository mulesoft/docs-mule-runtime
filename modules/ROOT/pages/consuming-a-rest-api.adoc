...
If you work with complex authentication protocols such as OAuth, you can xref:3.9@connector-devkit::index.adoc[build your own Anypoint Connector] to consume the API.
