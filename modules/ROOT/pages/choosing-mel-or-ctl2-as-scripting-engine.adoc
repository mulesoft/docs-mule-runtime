...
The images below illustrate DataMapper's xref:5.x@studio::datamapper-visual-reference.adoc[Script view] displaying the same mapping, in CTL2 (below, at top) and MEL (below, at bottom.
