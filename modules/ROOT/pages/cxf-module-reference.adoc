...
* xref:3.7@cxf-module-overview.adoc[Overview]
* xref:3.6@building-web-services-with-cxf.adoc[Building Web Services]
* xref:3.6@consuming-web-services-with-cxf.adoc[Consuming Web Services]
* xref:3.6@proxying-web-services-with-cxf.adoc[Proxying Web Services]
* xref:3.6@using-http-get-requests.adoc[Using HTTP GET Requests]
* https://docs.archive.mulesoft.com/mule-user-guide/v/3.3/bookstore-example[Bookstore Example]
* xref:3.6@cxf-module-configuration-reference.adoc[Configuration Reference]
* xref:3.6@wsdl-connectors.adoc[Using the WSDL Connector]

*Web Service Standards*

* xref:3.7@supported-web-service-standards.adoc[Supported Web Service Standards]
* xref:3.7@using-mtom.adoc[Using MTOM]
* xref:3.6@enabling-ws-addressing.adoc[Enabling WS-Addressing]
* xref:3.6@enabling-ws-security.adoc[Enabling WS-Security]
