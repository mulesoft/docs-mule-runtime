...
Anypoint Connectors are automatically bundled with Anypoint Studio, and there is a large library of additional connectors available for download in https://anypoint.mulesoft.com/exchange/?type=connector[Anypoint Exchange]. You can also create a xref:publishing-and-consuming-apis-with-mule.adoc[REST or SOAP API connector], or create your own connectors using xref:3.8@connector-devkit::index.adoc[Anypoint Connector DevKit]. For more information on integration solutions, see the http://www.mulesoft.com/platform/cloud-connectors[Anypoint Connectors] product site.
...
Install connectors using https://anypoint.mulesoft.com/exchange/?type=connector[Anypoint Exchange]. For more information, see xref:installing-connectors.adoc[To Install a Connector from Anypoint Exchange].
...
* Download new connectors and read specific documentation for them in https://anypoint.mulesoft.com/exchange/?type=connector[Anypoint Exchange].
