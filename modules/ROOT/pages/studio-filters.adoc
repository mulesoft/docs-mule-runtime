...
|image:filter-24x16.png[Filter-24x16] |Message |Applies specified criteria to a message to determine whether it should be processed |xref:message-property-filter.adoc[Message Filter Reference]
