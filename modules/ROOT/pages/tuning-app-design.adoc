...
Consider the following best practices while you are designing your applications to enhance the performance. These practices covers various fronts such as the Mule runtime engine version (Mule) to use, what to avoid while designing your app, and specific settings when using Mule components and connectors.


== Mule Runtime Version

Before you start tuning your application, first, check the following recommendations:

* Use the latest Mule version to create and run the application.
* Update your application dependencies to the latest version so you take advantage of the recent performance improvements and bug fixes. Also, update to the latest version of the Mule patch whenever possible.
* When developing and testing an application, use the same Mule version that will be used to deploy that application in your environments.

== General App Design Recommendations

When you are designing your applications consider the following recommendations:
...
* xref:connector::http/http-connector.adoc[HTTP Connector]
