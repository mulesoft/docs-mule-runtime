...
| Complex iterative logic that cannot be expressed using built-in scopes
| Implement a custom router using the xref:mule-sdk::routers.adoc[Mule SDK] that encapsulates the iteration logic in Java, avoiding deep nesting in the Mule execution chain.
|===
