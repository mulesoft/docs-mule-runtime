...
Consider the following best practices while you are designing your applications to enhance the performance. These practices covers various fronts such as the Mule runtime engine (Mule) version to use, what to avoid while designing your app, and specific settings when using Mule components and connectors.
