...
+
image::parse.png["A Parse Template showing an error message"]
+
...
image::parse-template-flow.png["A flow showing steps from Listener to Error handling with a Parse Template", 55%]
...
image::parse-template-flow2.png["A flow including a Listener, Set Payload, Parse Template, and Logger", 75%]
