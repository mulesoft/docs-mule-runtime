...
The output payload of the <<template, template example>> is HTML with the employee data that the Select operation returned.
...
The output payload of the <<template2, template example>> is HTML with the dynamically produced rows and data from the array.
