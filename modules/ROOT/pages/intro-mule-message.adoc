...
//TODO: ANA OR SOME OTHER KIND MULE DEV :) , COULD YOU PLEASE HELP WITH THE vars.outboundHeaders default {}. 
//IS THE KEYWORD default correct here? My understanding is that you set default differently in DW 2.0.
[source,xml,linenums]
----
