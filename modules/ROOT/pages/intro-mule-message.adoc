...
For examples that use target variables, see
...
Compare the Mule 3 Set Variable xref:variable-transformer-reference.adoc[Flow Variable Transformer Reference] to the Mule 4 xref:https://docs.mulesoft.com/mule-runtime/4.3/variable-transformer-reference.adoc[Set Variable Transformer]. Selecting a variable in Mule 3 and Mule 4 differs:

//TODO: SHOW HOW TO SELECT BOTH WITH BASIC EXAMPLE
* Mule 3: `flowvars`
* Mule 4: `vars`, for example, `vars.myVar` 

// TODO: show how to set the components in a flow
