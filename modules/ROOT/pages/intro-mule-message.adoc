...
In Mule 3, inbound properties stored additional information about a payload obtained through an event source, such as the query parameters coming through an HTTP listener. *Attributes* in Mule 4 replace inbound properties and have these advantages:
