...
The Mule message and its data are part of a context called the xref:about-mule-event.adoc[Mule event]. The event has its own message, composed of a payload and attributes. 
