...
image::mruntime-message-diagram.png["A Mule message including attributes, payload, and variables"]
...
image::mule-message.png["A Mule message showing types of attributes and payload"]
