...
Starting with Mule 4.9.8, you configure FIPS 140-2 by installing the FIPS license that MuleSoft provides in the license `.zip` file. To enable FIPS 140-2 compliance, install the FIPS license from the `.zip` package. The non-FIPS license in the same package isn't valid for FIPS mode.
