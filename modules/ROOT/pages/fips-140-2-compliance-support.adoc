...
The following list contains supported FIPS 140-2 compliant cipher suites for on-premises environments. 
The default configuration specifies `TLS_ECDHE_RSA_WITH_AES_256_CBC_SHA`, but you can add additional cipher suites. Refer to the Fine-Tuning SSL Connectors section for additional information.
