...
If you're running in FIPS mode with a Mule runtime in a clustered environment, define an encryption key for the cluster. See xref:mule-high-availability-ha-clusters.adoc#cluster_fips[Cluster reference] for more insight.
