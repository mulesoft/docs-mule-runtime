...
If you are running in FIPS mode with a Mule Runtime in a cluster environment, then you should define an encryption key for the cluster. See xref:mule-high-availability-ha-clusters.adoc#cluster_fips[Cluster reference] for more insight. 
