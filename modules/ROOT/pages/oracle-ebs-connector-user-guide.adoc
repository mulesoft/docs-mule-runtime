...
Anypoint Connector for Oracle E-Business Suite (EBS) provides real-time connectivity to query and update Oracle EBS using web services and message queues. The connector has been developed for the *Oracle EBS v12.1.x*. For Oracle EBS 12.2, see the xref:oracle-ebs-122-connector.adoc[Oracle EBS 12.2 Connector].

Read through this user guide to understand how to set up and configure a basic flow using the connector. Track feature additions, compatibility, limitations and API version updates with each release of the connector using the xref:release-notes::connector/oracle-e-business-suite-ebs-connector-release-notes.adoc[Oracle E-Business Suite (EBS) Connector Release Notes]. Review the connector operations and functionality using the https://mulesoft.github.io/mule-oracle-ebs-connector/4.0.0/apidocs/mule/oracle-ebs-config.html[Technical Reference] alongside the http://mulesoft.github.io/mule-oracle-ebs-connector/[demo applications].

MuleSoft maintains this connector under the xref:anypoint-connectors.adoc#connector-categories[_Premium_] support policy.
...
Contact the mailto:info@mulesoft.com[MuleSoft Sales Team] to obtain either of these. Read more about in xref:installing-an-enterprise-license.adoc[Installing an Enterprise License].
...
To use the Oracle EBS connector in your Mule application, you must configure a global Oracle EBS element that can be used by all the Oracle EBS connectors in the application (read more about xref:3.7@global-elements.adoc[global elements]).
