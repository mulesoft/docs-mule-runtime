...
xref:on-premises::mule-standalone.adoc[Run Mule Runtime Engine On-Premises]).
...
MuleSoft also provides the built-in PaaS solution, xref:runtime-fabric::index.adoc[Runtime Fabric], which runs Mule
