...
xref:runtime-manager::index.adoc[Runtime Manager] is an online management
...
Anypoint Platform Private Cloud for on-premise deployments, and it is available
...
which includes commands for deployments and for number of Anypoint Platform use 
cases.
...
bundled with Mule. These components can be updated as new versions of Mule are 
released. xref:connectors::index.adoc[Modules, connectors], the
