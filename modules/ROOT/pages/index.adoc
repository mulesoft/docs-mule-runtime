...
MuleSoft also provides the
xref:runtime-manager::anypoint-platform-cli-commands.adoc[Anypoint CLI 3.x],
which includes commands for deployments without Runtime Manager and for number
of Anypoint Platform use cases.

[[version]]
== Mule Versioning

The Mule version you use determines the features you can use in a Mule app.
...
bundled with Mule and can be updated as new versions of Mule are released.
