...
:page-aliases: mule-concepts.adoc, index-migration.adoc, mule-runtime-updates.adoc, intro-overview.adoc, intro-studio.adoc, intro-connectors.adoc, intro-java-integration.adoc, intro-programming-model.adoc, migration-intro.adoc, migration-prep.adoc, migration-process.adoc, migration-cheat-sheet.adoc, migration-core.adoc, migration-transports.adoc, migration-connectors.adoc, migration-connectors-amqp.adoc, migration-connectors-database.adoc, migration-connectors-email.adoc, migration-connectors-file.adoc, migration-connectors-ftp-sftp.adoc, migration-connectors-http.adoc, migration-connectors-json.adoc, migration-connectors-jms.adoc, migration-connectors-objectstore.adoc, migration-module-scripting.adoc, migration-module-spring.adoc, migration-module-validation.adoc, migration-module-vm.adoc, migration-module-wsc.adoc, migration-connectors-xml.adoc, migration-example-complex.adoc, migration-api-gateways.adoc, migration-api-gateways-autodiscovery.adoc, migrate-mule3-apimanager.adoc, migration-api-gateways-policies.adoc, migration-api-gateways-proxies.adoc, migration-api-gateways-runtime-config.adoc, migration-munit-test-structure.adoc
...
* xref:on-premises::runtime-installation-task.adoc[Download, Install, Upgrade Mule]
