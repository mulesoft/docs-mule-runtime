...
resources. Mule supports a variety of sources, including a variety of 
listeners for external events, and schedulers for internally triggered events.
This behavior reflects Mule's event-driven architecture (EDA).
