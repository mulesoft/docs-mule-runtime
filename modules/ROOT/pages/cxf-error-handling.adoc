...
The sections below describe how to use Mule's xref:error-handling.adoc[*Default Exception Strategy*], a xref:rollback-exception-strategy.adoc[*Rollback Exception Strategy*] or a xref:catch-exception-strategy.adoc[*Catch Exception Strategy*] to handle errors in a flow with a CXF Web service.
...
Refer to xref:rollback-exception-strategy.adoc[Rollback Exception Strategy] for detailed instructions on how to apply one to a flow.
...
Refer to xref:catch-exception-strategy.adoc[Catch Exception Strategy] for detailed instructions on how to apply one to a flow.
