...
This example configures a pool that holds up to `20` active components, keeps at most `10` idle, and grows beyond `maxActive` when the pool is exhausted:

[source,xml,linenums]
----
<pooling-profile maxActive="20" maxIdle="10" exhaustedAction="WHEN_EXHAUSTED_GROW" />
----
