...
The `maxPoolSize` setting specifies the maximum number of connections that will be open to the database, and that will remain available to serve incoming requests. 
