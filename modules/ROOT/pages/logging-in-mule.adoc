...
image::logging-in-mule-view-error-log.png["An Anypoint Studio error log viewer interface"]
...
image::logger-synch.png["A synchronous logging in a threaded environment"]
...
image::logger-asynch-alternativo.png["An asynchronous logging in a threaded environment"]
...
image::logging-latency-vs-concurrency.png["A line chart comparing latency versus concurrency"]
