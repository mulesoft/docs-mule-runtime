...
The runtime log configuration is located in the `log4j2.xml` file, in the `/conf` directory. You can customize this file when running the Mule instance on premises.
