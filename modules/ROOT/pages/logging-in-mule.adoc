...
***Reviewers, please supply a one or two sentence summary of the types of information the runtime log has in it. Does this a new log file start up each time the server is started?***
...
The runtime log is located in the `mule_ee.log` file.
***Reviewers, should we say more about this location?***
