...
[NOTE]
Mule 4.x introduced thread local functionality to optimize the memory usage of log4j. In order to enhance the use of this feature, the system property `AsyncLoggerConfig.RingBufferSize` can be set. The suggested value to use is `20000`.
