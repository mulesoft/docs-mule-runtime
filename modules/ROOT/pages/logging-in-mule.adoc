...
The Mule server has a `log4j2.xml` in its `conf` directory, which you can customize when running the server in standalone mode. This configuration file is is relevant for data output to the `mule_ee.log` file.
