...
Reference: https://mulesoft.github.io/mule-sap-successfactors-connector/[SAP SuccessFactors Connector Reference]

== Prerequisites

This document assumes that you are familiar with SAP SuccessFactors and have an http://www.successfactors.com/en_us.html[SAP account]. 
...
To use the SuccessFactors Connector in a Mule app, first create a new Mule project in Anypoint Studio:
...
When you drag a connector onto the Studio canvas, the configuration XML for your Mule app gets populated with the namespace and schema.
...
. To use the SuccessFactors Connector in your Mule app, configure a global configuration element that can be used by all SuccessFactors Connectors in the app.
...
For details on operations see the https://mulesoft.github.io/mule-sap-successfactors-connector/[SuccessFactors connector technical reference] and click the APIdoc for your connector version.
