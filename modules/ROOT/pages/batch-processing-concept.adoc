...
+
* <<phase_process>>: Processes records in batches using one or more Batch Step scope and, optionally, Batch Aggregator scopes. To process the records within these scopes, you need to configure other processors, such as connector operations and Mule components, within these batch scopes.
* <<phase_on_complete>>: Issues a report on the result of processing the instance. This phase takes place within the On Complete area of the Batch Job scope.
