...
+
This option is useful when you can guarantee that no job execution can have a 
...
you might end up with a prior version of the data. However, you can safely 
...
independent).
+
This setting was introduced before the current default, ORDERED_SQUENTIAL.
