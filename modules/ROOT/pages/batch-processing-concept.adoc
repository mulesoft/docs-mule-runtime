...
During this phase, processors within the scopes can access and modify records using the Mule variables `payload`, `attributes`, and `vars`. There are some special propagation rules for variables (see <<variable_propagation>>).
