...
* xref:cloudhub-1::cloudhub-fabric#persistent-queues-for-applications-containing-batch-jobs.adoc[Persistent Queues for Applications Containing Batch Jobs]
