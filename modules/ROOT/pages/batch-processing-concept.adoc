...
If you are already familiar with batch processing in Mule 3.x, you can get an overview of the differences with batch in Mule 4.x in the xref:migration-core-batch.adoc[Migrating the Batch Element] article.
