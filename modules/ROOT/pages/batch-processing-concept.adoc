...
Note that there is no guarantee that records will be executed in order.
This strategies do not control the execution order of records in the batch job,
nor do they take into account the number of records each instance contains.
