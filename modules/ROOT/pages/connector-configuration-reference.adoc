...
While you do not need full proficiency in Mule to configure connectors, you should be familiar with Mule and the xref:6.x@studio::index.adoc[Anypoint Studio interface]. If you have not done so already, cement your understanding of the Mule application design process, and Studio:

* xref:6.x@studio::basic-studio-tutorial.adoc[Basic Studio Tutorial]
...
//* Skim through the Develop and Design section of the documentation to get a better lay of the MuleSoft product offering.
