...
For additional examples, see xref:dataweave-formats-multipart.adoc#examples[Multipart Format (Form Data)] and functions referenced in xref:dw-multipart.adoc[Multipart function].
