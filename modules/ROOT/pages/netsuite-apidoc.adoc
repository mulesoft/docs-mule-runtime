...
|
type  | http://mulesoft.github.io/mule-netsuite-connector/7.6.0/apidocs/javadocs/org/mule/module/netsuite/api/BaseRefType.html[RecordTypeEnum] | the type of the target deleted record to retrieve |  | *x*
...
|
baseRef icon:envelope[] |http://mulesoft.github.io/mule-netsuite-connector/7.6.0/apidocs/javadocs/org/mule/module/netsuite/api/BaseRefType.html[BaseRefType] | An instance of BaseRefType | #[payload] |
...
* http://mulesoft.github.io/mule-netsuite-connector/[NetSuite Connector Reference]