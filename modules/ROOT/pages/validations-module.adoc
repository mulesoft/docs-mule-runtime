...
*Note:* This feature is supported by the Mule runtime as of xref:release-notes::mule-runtime/mule-esb-3.7.0-release-notes.adoc[Mule ESB 3.7.0] in both Community and Enterprise editions. However, Studio support only became available starting with the September 2015 release.
...
There are several different types of validator that out of the box cover most of the common use cases you might run into. If none of the validators described below cover what you need, you can also xref:building-a-custom-validator.adoc[build a custom validator].
