...
Java Cron expression matches your time-date setting. You can trigger the event
...
. Year (empty or a 4-digit year, for example, 2019)
...
<flow name="cronFlow" doc:id="ae257a5d-6b4f-4006-80c8-e7c76d2f67a0" >
  <scheduler doc:name="Scheduler" doc:id="e7b68ccb-c6d8-4567-87af-aa7904a50359" >
    <scheduling-strategy >
      <cron expression="0 45 9 * * ?" timeZone="PST"/>
    </scheduling-strategy>
  </scheduler>
...
//source info: https://docs.oracle.com/cd/E12058_01/doc/doc.1014/e12030/cron_expressions.htm
