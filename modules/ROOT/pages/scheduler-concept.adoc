...
// TODO: MULE-14438
* A Scheduler component can trigger only one flow at any given time.
* The `disallowConcurrentExecution` enables you to prevent the Scheduler from re-triggering a flow until it finishes processing.
