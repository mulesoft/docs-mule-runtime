...
* The `disallowConcurrentExecution` property enables you to prevent the Scheduler from re-triggering a flow until it finishes processing. See xref:scheduler-xml-reference#scheduler-properties[&lt;scheduler&rt; Properties].
