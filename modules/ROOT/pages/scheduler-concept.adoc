...
* `W`: Weekday, which is valid only in the day-of-month field and must follow a specific day. For example, `15W` for the weekday nearest to the 15th of the month.
