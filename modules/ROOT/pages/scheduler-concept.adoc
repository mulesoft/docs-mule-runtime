...
+
To set a time zone for the Scheduler, see <<props_cron_expressions>>.
...
Example that uses a cron expression to trigger the flow at 12:00 every day in the `America/Los_Angeles` time zone.
