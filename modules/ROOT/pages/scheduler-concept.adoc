...
// TODO: MULE-14438
A Scheduler component can trigger only one flow at any given time, and if a flow is executing, the flow won't trigger again until it finishes processing. If xref:execution-engine.adoc#backpressure[back-pressure] is triggered
