...
In debug mode in Studio, the Mule app disables the triggering of events. You can
instead execute the Scheduler by clicking the green arrow icon that appears at the
