...
enterprise and local subsidiaries of large international groups. MuleSoft maintains this connector under the xref:anypoint-connectors.adoc#connector-categories[_Select_] support policy.
...
You can download fully functional demo applications using the Microsoft Dynamics NAV connector from https://mulesoft.github.io/mule-microsoft-dynamics-nav-connector/[this page].
...
* https://mulesoft.github.io/mule-microsoft-dynamics-nav-connector/[Connector Reference]
* https://www.mulesoft.com/exchange/org.mule.modules/mule-module-ms-dynamics-nav/[Microsoft Dynamics NAV Connector]