...
This document uses an example application and draws upon the content of the xref:mule-message-structure.adoc[Mule Message Structure document] to examine the state of a message as it passes through a xref:dataweave.adoc[Transform Message component] in a flow. Running the application in debug mode in Anypoint Studio, the screenshots illustrates the state of a message using the xref:5.x@studio::studio-visual-debugger.adoc[Visual Debugger] which facilitates "frozen-in-time" viewing of a message.

== Assumptions

This document describes the details of the example within the context of *Anypoint Studio* , Mule ESB’s graphical user interface (GUI). Where appropriate, the XML configuration accompanies the Studio interface screenshots. This document assumes that you are familiar with Mule ESB and the  xref:5.x@studio::index.adoc[Anypoint Studio interface] . Further, it assumes you have read the xref:mule-message-structure.adoc[Mule Message Structure document] to understand the contents of a Mule message.
...
Learn more about how to examine the state of your messages using the xref:5.x@studio::studio-visual-debugger.adoc[Visual Debugger] .
====
...
*  Learn more about xref:5.x@studio::studio-visual-debugger.adoc[Studio Visual Debugger].