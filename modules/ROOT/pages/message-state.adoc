...
Learn more about how to examine the contents of your messages using the xref:6.x@studio::studio-visual-debugger.adoc[Visual Debugger] .
====
...
*  Learn more about xref:6.x@studio::studio-visual-debugger.adoc[Studio Visual Debugger].