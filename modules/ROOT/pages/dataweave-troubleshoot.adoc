...
coming from another component upstream is not valid. For DataWeave errors themselves,
you can find here a listing of the most common ones and how to overcome them.
