...
When you work with flat files, configure the flat file schema to use either for the write or read operations. The flat file schema defines the structure of a flat file, and this enables Mule to write and read in such format.
