...
If you want to test the examples on your end, follow these steps to create and configure your example Mule application:
...
. Create a file named `flatfileconfig.properties` in the `src/main.resources` folder of your Mule application and set its content with the following:
+
----
