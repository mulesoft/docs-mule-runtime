...
Returns the first element that satisfies the condition or `null` if no
...
This example shows how `firstWith` behaves when an element matches and when it does not match.
