...
Mule provides xref:3.6@jmx-management.adoc[several agents for JMX support], including notifications and remote management. You can also create custom agents to plug any functionality into Mule, such as running functionality as a background process or embedding a server in Mule.
...
For a list of agents provided with Mule and how to configure them, see xref:3.6@jmx-management.adoc[JMX Management]. You can also create a custom agent as described below.
