...
The AMQP connector is available as a Studio plugin. Get the https://www.anypoint.mulesoft.com/exchange/?search=amqp[AMQP connector from Anypoint Exchange]. Connector installation information is available at xref:anypoint-connectors.adoc[Anypoint Connectors].
