...
. Configure the *CXF component* as per the image and table below. At runtime, the output of this component is a POJO.
+
image::new-cxf-order-api.png[newCXForderapi]
+
...
image::new-cxf-order-api-gen-from-wsdl.png[newCXForderapi-gen-from-wsdl]
