...
Note that in the above, the `loginContextName` contains the same name of the entry as in the Jaas configuration file. This name is used to create the login context as well as to find the complete URL of the `jaas.conf` file.
