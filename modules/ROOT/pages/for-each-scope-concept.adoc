...
Unlike attributes, Mule variables are directly accessible within For Each. See <<variable_propagation, Variable Propagation>> to understand how modifications to values of Mule variables propagate from within and outside of the For Each component.
