...
:page-aliases: for-each-scope-xml-reference.adoc, migration-core-foreach.adoc, migration-core-splitter-aggregator.adoc
...
+
image::component-foreach-example.png["A For Each component showing a flow with settings"]
