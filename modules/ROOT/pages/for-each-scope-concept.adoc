...
After an HTTP request (`<http:request />`), the remaining components in the flow are configured to illustrate how For Each properties work and how to access to the `payload` and `attributes` takes place within and outside of For Each:
