...
[WARNING]
====
For CloudHub deployments, avoid setting `initialState="stopped"` on flows that contain a Scheduler. The scheduler gets stuck in a permanent "Running" state, and you can't manage it through Runtime Manager.
====
