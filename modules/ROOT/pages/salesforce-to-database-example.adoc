...
This document assumes that you are familiar with Mule ESB and the xref:5.x@studio::basic-studio-tutorial.adoc[Anypoint Studio interface].
...
* Learn more about the xref:6.x@studio::datamapper-user-guide-and-reference.adoc[Datamapper].
