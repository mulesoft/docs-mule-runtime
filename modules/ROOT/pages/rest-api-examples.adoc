...
The database global connector is a https://docs.archive.mulesoft.com/mule-user-guide/v/3.4/global-elements[global element] that contains the connection configuration for the desired database. It is referenced by the database connector in the application flow.
