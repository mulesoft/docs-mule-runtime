...
. In *Connector Configuration*, click image:mruntime-add-plus[], and set up the *Host*, *Port*, and *Base Path*. This configuration sends requests to `http://baconipsum.com/api`.
. Click *OK*.
