...
image::mruntime-rest-api-example-1.png["Flow with components like Listener, Request, and Error handling for consuming a REST API"]
...
image::mruntime-rest-api-example-2.png["Flow showing components like Listener, Request, and Write for consuming a REST API"]
...
image::mruntime-rest-api-example-3.png["HTTP Listener configuration showing protocol, host, and port settings"]

[start=4]
. In the HTTP Listener properties editor, set *Path* to `/`:

.HTTP Listener properties editor with Path.
image::mruntime-rest-api-example-4.png["Configuration settings for an HTTP Listener including path, MIME type, and error handling"]
...
image::mruntime-rest-api-example-5.png["Configuration settings for an HTTP Request including URL, host, port, and connection details"]
...
image::mruntime-rest-api-example-6.png["Configuration panel for an HTTP Request showing method, path, and URL settings"]
...
image::mruntime-rest-api-example-7.png["Configuration settings for a file write operation showing path, content type, and write mode"]
