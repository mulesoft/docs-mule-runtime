...
. Click to run the example as a Mule application.
. In a Web browser, query the HTTP Listener on localhost port 8081: `http://localhost:8081?type=meat-and-filler` that triggers the flow in this application.
