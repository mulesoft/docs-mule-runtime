...
The *Splitter* divides the incoming message into parts based on a user-defined XPATH expression. The expression conforms to the xref:3.9@xpath.adoc[XPath syntax supported by MEL]:
