...
** The second item shows Message Enricher component view. This component enriches rather than manipulates the payload of the record.
...
** The second items instructs Mule to create a new Lead using the payload of the record.
