...
To build applications with Batch jobs and run them in a test or production environment, you must build the application with an Enterprise runtime. Learn more about xref:6@studio::changing-runtimes-in-studio.adoc[Changing Runtimes in Studio].
====
...
* xref:6@studio::datamapper-user-guide-and-reference.adoc[Anypoint DataMapper User Guide and Reference]
...
http://www.mulesoft.org/schema/mule/ee/dw http://www.mulesoft.org/schema/mule/ee/dw/current/dw.xsd">
    ...
    <batch:job max-failed-records="1000" name="CreateLeads">
        ...
        <batch:input>
            ...
            <dw:transform-message doc:name="CSV to Lead" metadata:id="7bff9652-407a-4479-9e4a-6f82f57ec3f6">
...
** The second item shows the Message Enricher component view. This component enriches rather than manipulates the payload of the record.
** The third item shows how to set a record variable on those records for which a Salesforce lead already exist.
...
** The first item instructs the batch step not to process any record enriched with an `exists` record variable that equal to true.
