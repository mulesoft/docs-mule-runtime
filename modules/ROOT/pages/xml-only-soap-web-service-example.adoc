...
[source,xml,linenums]
----
<flow doc:description="AdmissionService SOAP Web service which accepts calls and processes request to perform pre-admissions activities in the hospital's systems." doc:name="admitPatientService" name="admitPatientService">
...
* Learn more about the xref:cxf-component-reference.adoc[CXF component].
