...
|`com.mulesoft.dw.xml.supportDTD`|`Boolean`|`false`|Controls whether DTD handling is enabled or disabled. When this property is set to `false`, DataWeaves skips processing of both internal and external subsets.
|===
