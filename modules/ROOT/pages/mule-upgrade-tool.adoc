...
+
The target Mule version needs to be a version between 4.1.1 to 4.1.4 using the patch update released after January 20, 2022, or version 4.1.5 or later. If the running version is not one of the previously mentioned, an error message appears stating that the Mule version cannot be upgraded unless an upgrade is made.
...
. After reviewing the differences, accept or discard the changes:
