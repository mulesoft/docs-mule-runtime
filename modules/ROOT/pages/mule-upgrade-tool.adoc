...
include::mule-runtime::partial$upgrade-tool.adoc[tag=BeforeYouBegin]

== Upgrade or Update Mule

include::mule-runtime::partial$upgrade-tool.adoc[tag=UpgradeOrUpdateMule]

== Roll Back an Upgrade or Update

include::mule-runtime::partial$upgrade-tool.adoc[tag=RollBackUpgradeOrUpdate]
