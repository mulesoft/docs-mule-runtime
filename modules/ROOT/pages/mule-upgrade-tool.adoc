...
+
When updating your current Mule instance to a version between 4.1.1 and 4.1.4, use the patch update version released after January 20, 2022. If the running version is not one of the previously mentioned, an error message appears stating that the Mule version cannot be upgraded unless an upgrade is made.
