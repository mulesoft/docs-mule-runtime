...
* The new Mule runtime (with the version to be upgraded to) and Mule upgrade tool instances copied to each node that must be upgraded, to ensure less downtime.
+
include::partial$upgrade-tool.adoc[tag=BeforeYouBegin]
