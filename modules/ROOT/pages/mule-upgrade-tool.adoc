...
Before starting the upgrade or update, Mule upgrade tool creates a backup of your existing Mule Runtime instance. This is to let you restore your Mule Runtime instance to its previous state. This backup gets stored in the $MULE_HOME/backup folder. "Mule Runtime instance"
