...
+
To download the tool, log in to https://help.mulesoft.com/s/[Help Center^]. Under the Support menu, select *Downloads > Mule Runtime > https://help.mulesoft.com/s/downloads?tabset-169e6=2[Mule Upgrade Tool^]*.
+
