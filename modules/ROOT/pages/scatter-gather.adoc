...
|*Threading Profile* |Optionally, use to customize the threading profile. Refer to xref:tuning-performance.adoc[Tuning Performance] for a description of the configurable attributes. For a brief discussion of threading profiles in Scatter-Gather, see the section below. + |Default threading profile |
