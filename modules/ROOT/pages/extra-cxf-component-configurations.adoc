...
This page covers more complex configuration of the CXF Component than those described in the basic discussions of xref:publishing-a-soap-api.adoc[publishing a SOAP API] and xref:consuming-a-soap-api.adoc[consuming a SOAP API]. You may also wish to refer to full xref:cxf-component-reference.adoc[CXF Component Reference] documentation.
...
* Access full xref:cxf-component-reference.adoc[CXF Component Reference] documentation.
* Learn the basics of xref:publishing-a-soap-api.adoc[publishing a SOAP API].
* Learn the basics of xref:consuming-a-soap-api.adoc[consuming a SOAP API].