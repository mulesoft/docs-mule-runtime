...
* xref:transaction-management.adoc#tx_scopes_routers[Transaction Management], to see how Transactions affect the Flow Reference Component, and the execution of the referenced Flow or Sub-Flow.
