...
image::wmq-documentation.png[WMQdocumentation]
...
See the xref:3.4@mule-wmq-transport-reference.adoc[Mule WMQ Transport Reference] for details on setting the properties for a WMQ endpoint using an XML editor.