...
<6> This Set Variable component creates an inner 'greeting' variable that appends a string to the original 'greeting' variable: `greeting + ' World'`.
...
<10> This Logger component prints a message with the inner payload: `some arbitrary payload`.
<11> This Logger component prints a message with the outer payload, `null`.
<12> This Logger component prints a message with the final `greeting` variable, `Oh, Hello World Traveler!!!`.
<13> This Set Payload component sets the value of the final `greeting` variable (`Oh, Hello World Traveler!!!`) as the payload.
<14> This Logger component prints a message with the final payload (`Oh, Hello World Traveler!!!`).
<15> This Logger component prints a message that includes text around payload value: `"Value of payload: [Oh, Hello World Traveler!!!]"`.
