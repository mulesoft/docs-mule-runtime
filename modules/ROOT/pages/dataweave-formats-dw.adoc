...
The DataWeave (dw) writer accepts optional parameters that provide instructions for writing dw output data.
...
The DataWeave (dw) reader accepts optional parameters that provide instructions for reading dw input data.
