...
The DataWeave (dw) writer accepts parameters that provide instructions for writing dw output data.
...
The DataWeave (dw) reader accepts parameters that provide instructions for reading dw input data.
