...
|Collection Expression (`collection`) | An expression to that returns a Java collection, object array, map, or DOM nodes. By default, the payload is taken as the collection to split.
