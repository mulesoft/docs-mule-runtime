...
// This feature is currently not working in 2.3.x, will be updated during the next sprint and then this section can be published.
////
==== Import Your Generated ZIP to Anypoint Studio.
...
You can include additional JAR libraries into your project by using the `<inclusions>` section. Included libraries will be added to the `/lib` folder of your project.
...
You can also use the `<exclusions>` section to exclude libraries from your project's `/lib` folder when packaging the application.
