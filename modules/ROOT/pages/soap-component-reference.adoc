...
image::client-attributes-together.png[]
...
<spring:beans>
    ...
    <flow name="admitPatientService" doc:name="admitPatientService"
        ...
        doc:description="AdmissionService SOAP Web service which accepts calls and processes request to perform pre-admissions activities in the hospital's systems.">
...
* Examine details about the xref:cxf-module-reference.adoc[CXF Module] in Mule.
* Review a xref:xml-only-soap-web-service-example.adoc[Mule example application] which demonstrates a SOAP Web service.
* Learn more about applying xref:enabling-ws-security.adoc[security] to SOAP Web services.
