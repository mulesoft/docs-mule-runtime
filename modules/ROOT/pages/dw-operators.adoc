...
Versions prior to Mule 4.3 require the following syntax to increase the `age` value by one without recreating the `Object` value of `myInput`:
...
In Mule 4.3 and later, the `update` operator simplifies the syntax:
