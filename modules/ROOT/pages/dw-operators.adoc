...
The following example selects and dynamically updates a value of a DataWeave variable. The field is not hardcoded. The example uses `update` to change the value `name` to `Shoki`:
