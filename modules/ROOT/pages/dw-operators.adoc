...
The following example use mathematical operators:
...
The following example use relational operators:
...
The following example use equality operators:
...
The following example show use of the update operator, assume that you receive the next object as input:
[source,json,linenums]
----
{
    "name": "Ken",
...
The following example updates an attribute value and change it to upper case:
