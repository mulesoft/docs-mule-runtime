...
%dw 2.0
output application/json
var orNot = if (1 + 1 == 4 or not 1 == 2) {"answer": "true or (not false)"}
             else {"answer": "nope"}
var andNot = if (1 + 1 == 2 and not 1 == 2) {"answer": "true and (not false)"}
             else {"answer": "nope"}
var notWithAndNot = if (not (1 + 1 == 2 and not 1 == 1)) {"answer": "not (true and (not true))"}
              else {"answer": "nope"}
---
{ "answers" :
  [
...
{
  "answers": [
    { "answer": "true or (not false)" },
    { "answer": "true and (not false)" },
    { "answer": "not (true and (not true))" }
  ]
}
----
