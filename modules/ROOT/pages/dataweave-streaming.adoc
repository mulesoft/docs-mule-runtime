...
To check that your code can handle the input stream successfully, DataWeave provides the following _advanced, experimental_ annotation and a related directive:
