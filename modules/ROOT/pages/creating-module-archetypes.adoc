...
The module archetype can be used for updating existing modules and transports. It allows developers to add template code for schema configurations and xref:3.6@bootstrapping-the-registry.adoc[bootstrap the registry]. It will leave your existing code untouched.
