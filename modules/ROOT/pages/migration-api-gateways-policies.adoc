...
In Mule 4, policies underwent major changes.
...
https://docs.mulesoft.com/gateway/latest/policies-included-rate-limiting[Rate Limit and Throttling Policy]

https://docs.mulesoft.com/gateway/latest/policies-included-rate-limiting-sla-based-policies[Rate Limit SLA Based Policies]

https://docs.mulesoft.com/mule-gateway/policies-custom-upload-to-exchange[Uploading a Custom Policy to Exchange]
