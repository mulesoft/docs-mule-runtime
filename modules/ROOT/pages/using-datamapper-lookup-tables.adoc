...
. Click *OK*. At this point, the mapping is complete. Running a https://docs.archive.mulesoft.com/mule-user-guide/v/3.3/obtaining-a-preview-of-mapped-data[preview] of the mapping gives the following result:
