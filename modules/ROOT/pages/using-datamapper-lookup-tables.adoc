...
. Click *OK*. At this point, the mapping is complete. Running a xref:5@studio::previewing-datamapper-results-on-sample-data.adoc[preview] of the mapping gives the following result:
