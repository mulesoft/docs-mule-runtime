...
The following filters are provided in Anypoint Studio. Drag the *Filter Reference* processor to the canvas, click the green plus sign to configure the filter, and click a filter type from the *Choose Global Type* menu. For more information, see  xref:filter-ref.adoc[Filter Reference].
