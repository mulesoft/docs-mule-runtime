...
The XQuery Module gives users the ability to perform XQuery transformations on XML messages in Mule. This works in a very similar way to the xref:xslt-transformer-reference.adoc[XSLT Transformer] shipped with Mule.
