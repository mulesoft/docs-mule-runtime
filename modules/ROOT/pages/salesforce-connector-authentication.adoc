...
To use this document, you should be have a Salesforce account with access to data and you should be familiar with the xref:salesforce-connector.adoc[Salesforce Connector] in Anypoint Studio.
