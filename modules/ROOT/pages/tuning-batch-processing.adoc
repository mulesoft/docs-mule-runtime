...
If the aggregator contains an operation that streams data, you can set the activate the scope's Streaming option, which is independent of the Aggregator Size setting.
