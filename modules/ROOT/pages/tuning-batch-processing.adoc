...
If the aggregator contains an operation that streams data, you can set the activate the scope's Streaming option instead of using an Aggregator Size setting.
