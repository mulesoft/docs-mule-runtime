...
|Skips the next scheduled flow execution if the last one has not ended. Next attempt to execute occurs after another frequency period. Default value is `false`.
