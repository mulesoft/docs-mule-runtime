...
* Useful papers on mutable and extensible containers: http://www.xfront.com/VariableContentContainers.pdf[VariableContentContainers] and  http://www.xfront.com/ExtensibleContentModels.pdf[ExtensibleContentModels]