...
Mule 4.3 is the latest Mule Runtime which provides a huge performance boost on your applications, while still providing all the benefits of the Mule 4 platform that speeds up the development of applications and a runtime that bends but not breaks. 
