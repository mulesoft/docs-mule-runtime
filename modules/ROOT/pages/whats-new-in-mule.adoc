...
Mule 4.4 is the latest and best Mule Runtime available, it continues delivering a high performant and re continuing to expedite application development on Anypoint Platform and to offer a resilient runtime for use cases that are vital to the functioning your organization. 

MuleSoft recommends the usage of Mule 4.4 for all new and existing applications.
