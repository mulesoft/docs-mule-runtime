...
Mule 4.3 is the latest Mule Runtime which provides a huge performance boost on your applications, while still providing all the benefits of the Mule 4 platform that speeds up the development of applications and resilient runtime for critical mission use cases. 
It’s recommended to migrate your applications to Mule 4.3 to benefit from all the improvements that this new version provides and are explained below.
