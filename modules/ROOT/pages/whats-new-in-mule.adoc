...
Note that DataWeave uses the first function it finds that accepts the arguments of the function call, in the order that they are declared in the script.
