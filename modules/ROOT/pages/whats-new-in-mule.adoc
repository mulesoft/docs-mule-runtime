...
Mule 4.4 is the latest and best Mule Runtime available, it continues to deliver high performance, expedites application development on Anypoint Platform, and offers a resilient solution for use cases that are vital to the functioning of your organization.

Deploy all your new and existing applications to Mule 4.4 to benefit from all the improvements in this version.
