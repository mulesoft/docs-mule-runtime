...
The 4.3 version of the Mule runtime engine provides a huge performance boost to your applications, while continuing to expedite application development on the Anypoint Platform and to offer a resilient runtime for use cases that are vital to the functioning your organization. 
