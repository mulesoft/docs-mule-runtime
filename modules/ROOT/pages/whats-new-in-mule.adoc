...
Mule runtime engine 4.4 fixes issues and includes some enhancements. Deploy all your new and existing applications to Mule 4.4 to benefit from all the improvements in this version.
