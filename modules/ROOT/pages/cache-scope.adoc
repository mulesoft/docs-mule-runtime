...
By default, Mule stores all cached responses in an InMemoryObjectStore. <<Creating a Caching Strategy>> and define a new xref:3.7@mule-object-stores.adoc[object store] if you want to customize the way Mule stores cached responses.
...
* Read more about xref:3.6@scopes.adoc[Scopes] in Mule.