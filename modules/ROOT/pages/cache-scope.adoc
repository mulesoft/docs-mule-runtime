...
You can customize the way Mule stores cached responses if you  <<ccs,Create a Caching Strategy>> and define a new object store.
...
You can get more information about these base object stores in the xref:mule-object-stores.adoc[Mule Object Stores] reference page.
