...
The Cache scope persists only the message (payload and attributes) in the object store, not the full Mule event. Because this Java-based customizations require the full Mule event, they're deprecated:
