...
. In the New Mule Project window add a *Project Name*, for example: `cachescopesample`.
. Click *Finish*.
...
. Copy and paste the following XML code into your `cachescopesample.xml` file of your example project.
...
http://www.mulesoft.org/schema/mule/vm http://www.mulesoft.org/schema/mule/vm/current/mule-vm.xsd">
 ...
 <choice doc:name="Choice">
            <when expression="message.inboundProperties.'http.query.params'.['n'] &lt; 20">
                ...
                <vm:outbound-endpoint exchange-pattern="request-response" path="fibonacci" connector-ref="vmConnector" doc:name="VM"/>
                <expression-component doc:name="Expression"><![CDATA[payload= "Fibonacci(" + message.inboundProperties['originalN'] + ") = " + payload +"\nCOST: " + message.inboundProperties['cost']]]></expression-component>
            </when>
            <otherwise>
                <expression-component doc:name="Expression"><![CDATA[payload= "ERROR: n must be less than 20"]]></expression-component>
            </otherwise>
        </choice>
    </flow>
