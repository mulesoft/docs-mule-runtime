...
DataWeave provides a number of xref:dataweave-selectors.adoc[selectors] for traversing the structure of input data and returning matching values. The following examples use a single-value DataWeave selector (`.`) to extract the value of an XML element.
