...
JSON Path can be used in xref:mule-expression-language-mel.adoc[Mule expressions] to query JSON message payloads for filtering or xref:message-enricher.adoc[enrichment].
