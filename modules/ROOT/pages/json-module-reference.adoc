...
JSON Path can be used in xref:non-mel-expressions-configuration-reference.adoc[Mule expressions] to query JSON message payloads for filtering or xref:message-enricher.adoc[enrichment].
