...
Following is an introduction to configuring Mule via the Spring XML file. For details on this file, see xref:about-the-xml-configuration-file.adoc[About the XML Configuration File].
