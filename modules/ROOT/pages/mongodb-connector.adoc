...
[NOTE]
The xref:anypoint-connectors.adoc#connector-categories[Select] versions of the connector are MongoDB connector MongoDB v4 and later.
The xref:anypoint-connectors.adoc#connector-categories[Community] versions of the connector are MongoDB connector v3 and earlier.
