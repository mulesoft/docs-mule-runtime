...
*Technical Reference:* http://mulesoft.github.io/mule-mongodb-connector/[MongoDB Connector]
...
*Note:* MongoDB Connector v4.1 introduced the http://mulesoft.github.io/mule-mongodb-connector/4.3.0/apidocs/apidoc.html#_map_reduce_objects[Map Reduce feature].
...
[NOTE]
The xref:anypoint-connectors.adoc#connector-categories[_Select_] versions of the connector are MongoDB connector MongoDB v4 and later.
The xref:anypoint-connectors.adoc#connector-categories[_Community_] versions of the connector are MongoDB connector v3 and earlier.
...
See xref:hardware-and-software-requirements.adoc[hardware and software requirements].
...
* For additional technical information, regarding MongoDB Connector see visit our http://mulesoft.github.io/mule-mongodb-connector/[online documentation].
