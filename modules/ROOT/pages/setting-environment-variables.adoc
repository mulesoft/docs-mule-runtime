...
+
The environment variables you create are defined at the domain level and will affect all of the applications associated with that domain when you deploy locally using Studio.

== See Also

xref:shared-resources[Shared Resources]
