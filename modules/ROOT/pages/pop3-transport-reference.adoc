...
POP3 polling may fail if geronimo-mail is in the CLASSPATH. For information on this problem, consult http://www.mulesoft.org/jira/browse/MULE-4875[MULE-4875].
====
...
The POP3 connector supports all the xref:3.7@configuring-a-transport.adoc[common connector attributes and properties] and the following additional attributes:
...
POP3 and POP3S endpoints include details about connecting to a POP3 mailbox. You xref:3.6@endpoint-configuration-reference.adoc[configure the endpoints] just as you would with any other transport, with the following additional attributes:
...
For more information about transformers, see the xref:3.7@email-transport-reference.adoc[Transformers] section in the Email Transport Reference.

For more information about filters, see the xref:3.7@email-transport-reference.adoc[Filters] section in the Email Transport Reference.

== Exchange Patterns / Features of the Transport

See xref:3.6@transports-reference.adoc[transport matrix].
...
For more information about the limitations, see the xref:3.7@email-transport-reference.adoc[Limitations] section in the Email Transport Reference.