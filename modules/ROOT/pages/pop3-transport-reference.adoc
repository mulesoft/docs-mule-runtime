...
|POP3 |  |image:check.png[] |image:error.png[] |image:check.png[] |image:error.png[] |image:error.png[] |image:error.png[] |one-way |one-way |org.mule.transport:mule-transport-pop3
|POP3S |  |image:check.png[] |image:error.png[] |image:check.png[] |image:error.png[] |image:error.png[] |image:error.png[] |one-way |one-way |org.mule.transport:mule-transport-pop3s
|===
