...
|POP3 |https://www.mulesoft.org/docs/site/current3/apidocs/org/mule/transport/email/package-summary.html[JavaDoc SchemaDoc] |image:check.png[] | -  |image:check.png[] | -  | -  | -  |one-way |one-way |org.mule.transport:mule-transport-pop3

|POP3S |https://www.mulesoft.org/docs/site/current3/apidocs/org/mule/transport/email/package-summary.html[JavaDoc SchemaDoc] |image:check.png[] | -  |image:check.png[] | -  | -  | -  |one-way |one-way |org.mule.transport:mule-transport-pop3s
|===
