...
The sample project is a Mule SDK module. See xref:mule-sdk::getting-started.adoc[Getting started with the Mule SDK] for additional information.
...
image::custom-configuration-provider.png["Screen for selecting a type of global configuration element with a search function"]
