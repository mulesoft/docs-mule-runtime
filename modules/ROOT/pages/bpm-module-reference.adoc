...
----
<1> This configuration snippet illustrates how to use the `bpms-ref` attribute in #1 and #2 to disambiguate between more than one BPM systems. If there is only one BPMS available, this attribute is unnecessary.
