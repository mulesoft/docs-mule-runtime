...
Nested transactions are not available for Single Resource transactions. Refer to xref:xa-transactions.adoc#nested-transactions[XA Transactions] for more details about nested transactions.
