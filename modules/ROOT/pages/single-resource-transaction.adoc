...
Nesting transactions is not available for Single Resource Transactions. Please refer to xref:xa-transactions.adoc#_nested_tx_[XA Transactions] for nested transactions.
