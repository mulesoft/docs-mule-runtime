...
Nested transactions are not available for Single Resource transactions. Refer to xref:xa-transactions.adoc#_nested_tx_[XA Transactions] for details and support about nested transactions.
