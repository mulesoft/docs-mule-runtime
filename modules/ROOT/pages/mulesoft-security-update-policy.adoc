...
For policies related to security vulnerabilities in Mule 3 and later versions of Mule, see https://www.mulesoft.com/legal/versioning-back-support-policy#critical[Critical Security Vulnerabilities^].
