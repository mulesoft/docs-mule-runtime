...
[TIP]
 For a *full description* of the example and steps the batch job takes in each phase of processing, s ee  xref:3.6@batch-processing.adoc[Batch Processing].
...
* Review the xref:3.6@batch-processing.adoc[basic anatomy] of batch processing in Mule.