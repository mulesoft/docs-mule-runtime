...
You can combine <<ex03, formatting characters>>, such as `MM` and `dd`, to write supported date and time formats. The example uses the `as` operator to write the dates and times as a string.
