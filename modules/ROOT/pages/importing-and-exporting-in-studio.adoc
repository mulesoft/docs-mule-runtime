...
|*Mule extension Update Site* |Specific to xref:3.7@connector-devkit::index.adoc[DevKit] connector extension projects, this option allows you to export the project to an update website. This option only appears if you have installed the DevKit plugin for Anypoint Studio.
|===
...
* Read about xref:importing-a-maven-project-into-studio.adoc[Importing a Maven Project into Studio].
* Find out more about xref:enabling-maven-support-for-a-studio-project.adoc[Enabling Maven Support for a Studio Project].
* Read more about subtle but cool features hidden in Anypoint Studio in our https://blogs.mulesoft.com/dev/mule-dev/10-little-mule-studio-gems/[MuleSoft Blog].