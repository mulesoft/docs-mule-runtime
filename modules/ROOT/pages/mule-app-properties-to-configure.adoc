...
The output is an invalid DataWeave script because the dollar sign ($) has a special meaning and needs to be escaped. See xref:dataweave::dataweave-types.adoc#escape-chars-string[Dataweave - Escaping Special Characters].
