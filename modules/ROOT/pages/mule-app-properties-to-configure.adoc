...
. Select *New* > *File*:
+
image:mruntime-properties-new-file.png["A Mule project structure with various source and test directories"]
...
image::mruntime-properties-file.png["HTTP Request configuration settings showing fields for URL, host, port, and connection settings"]
