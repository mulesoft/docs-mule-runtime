...
image::to-transform-data-c2fc6.png["A transformation flow from item type and price in a payload"]
...
image::to-transform-data-afe5b.png["A table with properties for title, author, item, and year"]
