...
|http://www.mulesoft.org/docs/site/current3/schemadocs/namespaces/http_www_mulesoft_org_schema_mule_ftp/namespace-overview.html[javaDocSchemaDoc]
 |image:check.png[] |image:check.png[] |image:check.png[] |- |image:check.png[] |image:check.png[] |one-way |one-way |org.mule.transport:mule-transport-ftp
|===
...
Which allows use of xref:non-mel-expressions-configuration-reference.adoc[arbitrary expressions] to compose the filename to use when storing files on the FTP server.
