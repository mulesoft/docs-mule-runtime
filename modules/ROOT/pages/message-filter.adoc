...
A Message Filter may also include nested filters. Nested filters let you apply more complex logic to the filter. See xref:3.4@logic-filter.adoc[Logic Filter] for more details about nesting filters.