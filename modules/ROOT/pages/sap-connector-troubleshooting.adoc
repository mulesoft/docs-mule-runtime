...
This page contains some common troubleshooting suggestions for the xref:mulesoft-enterprise-java-connector-for-sap-reference.adoc[SAP Connector].
...
[NOTE]
For further information, take a look at xref:sap-connector.adoc#share-jco-dependencies-between-several-applications[Share JCo Dependencies Among Multiple Applications].
