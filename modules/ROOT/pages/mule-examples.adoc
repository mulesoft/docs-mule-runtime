...
|✓
|Low
|https://docs.archive.mulesoft.com/mule-user-guide/v/3.3/gps-walker-example[gpswalker]
...
|✓
|Low
|https://docs.archive.mulesoft.com/mule-user-guide/v/3.3/scripting-example[scripting]
...
|✓
|Medium
|https://docs.archive.mulesoft.com/mule-user-guide/v/3.3/foreach-example[foreach]
|image:iteration2.png[]Processes collections iteratively without losing any of the payload.
|✓
|✓
|Medium
|https://docs.archive.mulesoft.com/mule-user-guide/v/3.3/bookstore-example[bookstore]
|image:icon-world-blue-big.png[]Exposes a Web service using Jetty and CXF. +
|✓
|✓
|Medium
|https://docs.archive.mulesoft.com/mule-user-guide/v/3.3/stock-quote-example[stockquote]
...
|✓
|High
|https://docs.archive.mulesoft.com/mule-user-guide/v/3.3/flight-reservation-example[flight-reservation]
|image:iteration2.png[]Processes collections iteratively without losing any of the payload. +
 +
image:orchestrate.png[]Orchestrates a sequence of calls to other services or message queues.
|✓
|✓
|High
|https://docs.archive.mulesoft.com/mule-user-guide/v/3.3/jdbc-transport-example[jdbc]
