...
Add and configure the CloudHub connector according to the basic setup in our xref:general:getting-started:deploy-to-cloudhub.adoc[Deploy to CloudHub].
...
.. *Domain*: This should be the domain you set for your application when you first created it following the xref:general:getting-started:deploy-to-cloudhub.adoc[Deploy to CloudHub tutorial].
