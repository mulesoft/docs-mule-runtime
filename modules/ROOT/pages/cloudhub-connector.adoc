...
Add and configure the CloudHub connector according to the basic setup in our xref:general:getting-started:deploy-to-cloudhub.adoc[Deploy to CloudHub tutorial].
