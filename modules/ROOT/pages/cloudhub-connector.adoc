...
Add and configure the CloudHub connector according to the basic setup in xref:runtime-manager:deploying-to-cloudhub.adoc[Deploying to CloudHub tutorial].
