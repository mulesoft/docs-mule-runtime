...
+
. Enter your Anypoint Platform credentials into the configuration fields and click *OK*. The *Url* field specifies the path to CloudHub in Anypoint Platform. You can change the *Url* field to access other control planes such as EU. The EU control plane is at `+https://eu1.anypoint.mulesoft.com/+`.
+
