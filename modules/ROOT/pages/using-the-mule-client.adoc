...
For SOAP support, you can use the Mule xref:cxf-module-reference.adoc[CXF Module Reference] or #[AXIS:Axis Transport]#. For more information about Mule Axis support, see #[AXIS:Axis Web Services and Mule]#.
