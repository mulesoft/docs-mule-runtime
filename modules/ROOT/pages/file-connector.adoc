...
* xref:3.6@file-transport-reference.adoc[File Transport Reference], for details on setting the properties for a File endpoint using an XML editor.
* https://anypoint.mulesoft.com/exchange/68ef9520-24e9-4cf2-b2f5-620025690913/database-connector[File Connector on Exchange]
