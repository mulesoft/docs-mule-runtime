...
You can configure entry point resolvers that determine how your component is invoked when a message is received by the service. See xref:developing-components.adoc[Developing Components] for a more detailed description of their functionality.
