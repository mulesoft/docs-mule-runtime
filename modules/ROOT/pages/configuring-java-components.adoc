...
For a real-world example of using `<spring-object/>`, see xref:3.7@using-spring-beans-as-flow-components.adoc[Using Spring Beans as Flow Components].
...
You can configure entry point resolvers that determine how your component is invoked when a message is received by the flow. See xref:3.7@developing-components.adoc[Developing Components] for a more detailed description of their functionality.
...
See xref:3.7@developing-components.adoc[Developing Components] for more information about lifecycles.
...
Binding can be used on Java components and script components. For more information see xref:3.6@component-bindings.adoc[Component Bindings].
...
For more information about pooling and reference documentation for pooling configuration options, see xref:3.6@tuning-performance.adoc[Tuning Performance].