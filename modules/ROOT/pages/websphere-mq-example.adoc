...
* Using the https://docs.archive.mulesoft.com/mule-management-console/v/3.5/[Mule Management Console], which provides a graphical interface for managing servers
