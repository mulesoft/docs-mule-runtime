...
This document assumes that you are familiar with Mule ESB and the xref:5.x@studio::basic-studio-tutorial.adoc[Anypoint Studio interface]. To increase your familiarity with Studio, consider completing one or more xref:5.x@studio::basic-studio-tutorial.adoc[Anypoint Studio Tutorials].
