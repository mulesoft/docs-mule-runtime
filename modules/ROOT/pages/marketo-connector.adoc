...
* For additional technical information on the Marketo Connector, visit our lhttps://mulesoft.github.io/mule3-marketo-connector/[technical reference documentation]. You may also want access to MuleSoft’s expert support team, which requires a Mule Runtime Enterprise subscription and log into MuleSoft’s Customer Portal.
