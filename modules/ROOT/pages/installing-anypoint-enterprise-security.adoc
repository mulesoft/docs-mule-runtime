...
* If you've already downloaded Anypoint Enterprise Security version into your instance of Anypoint Studio, follow the procedure below to a later version. (Not sure which version of Anypoint Enterprise Security you have installed? xref:6.x@studio::installing-extensions.adoc[Find out].)
