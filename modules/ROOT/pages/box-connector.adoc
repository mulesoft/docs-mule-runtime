...
*Technical Reference:* http://mulesoft.github.io/mule-box-connector[Mule Box Connector]
...
For more information on how to install a connector xref:3.7@installing-connectors.adoc[click here].
...
To use the Box connector in your Mule application, you must configure a global Box element that can be used by the Box connector (read more about  xref:global-elements.adoc[Global Elements]).
...
You can download fully functional demo applications using the Box connector from http://mulesoft.github.io/mule-box-connector/[this link].
...
* For additional technical information on the Box Connector, visit our http://mulesoft.github.io/mule-box-connector[technical reference documentation].
