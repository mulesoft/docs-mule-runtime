...
the sample input data through a variable (`var`) in the header of your
...
example, then use then replace `payload` with the variable name. If
you instead want to create an example that uses `payload`, you need to
create a Mule app that can generate the payload in a Mule message. It
is beyond the scope of this quickstart to describe this process. To get
Mule app development and data mapping, see the xref:dataweave-quickstart.adoc[Mule App Development Tutorial].
