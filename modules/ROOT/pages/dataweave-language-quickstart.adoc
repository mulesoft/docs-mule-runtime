...
NOTE: To run examples that use the `payload` variable, you can provide the sample input data through a variable (`var`) in the header of your DataWeave script (as shown <<modify_payload, the last step>>) or from a file that you read into a variable, as shown in the <<readurl, readUrl>> example, then
