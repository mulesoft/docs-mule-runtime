...
NOTE: This section simply shows a way to test your scripts and only describes
a _limited use_ of the Transform Message component. It intends to help you get started with the language and does not attempt to cover every DataWeave use case. For more complete information about the component, see xref:transform-component-about.adoc[Transform Message].
...
script, producing the calculated averages within the JSON structure.
+
...
.. Double-click your new `myJSON.json` file within `src/main/resources`, and
then provide and save the following sample content to the file:
+
[source,json,linenums]
----
{
