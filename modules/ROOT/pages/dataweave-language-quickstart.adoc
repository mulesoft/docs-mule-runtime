...
many Mule connectors, modules, and Core components 
(described in xref:mule-application-about.adoc[Mule Applications]) 
accept short DataWeave expressions in their *fx* fields. 
