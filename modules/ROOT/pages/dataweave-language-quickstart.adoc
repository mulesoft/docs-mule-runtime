...
modules, and components (described in xref:mule-application-about.adoc[Mule Applications]) 
beyond Transform Message accept short DataWeave expressions in their *fx* fields. 
