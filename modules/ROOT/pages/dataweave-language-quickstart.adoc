...
sample data. It describes a _limited use_ of the Transform Message component to help you get started with the language (as opposed to Mule app development) and does not attempt to cover every DataWeave use case. For more information, see xref:transform-component-about.adoc[Transform Message].
