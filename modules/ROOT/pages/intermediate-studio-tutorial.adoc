...
image::studio-cbr-tutorial-step1-unconfigured.png[Studio-CBRTutorial_step1_unconfigured]
...
image::studio-cbr-tutorial-step1-unconfigured-notes.png[Studio-CBRTutorial_step1_unconfigured_notes]
...
+
image::studioconsole-started-cbr-tutorial.png[StudioConsole-startedCBRtutorial]
