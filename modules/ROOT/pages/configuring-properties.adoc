...
If you deploy your application to xref:runtime-manager::cloudhub.adoc[CloudHub], you can also set properties through the Runtime Manager console. These can be defined when xref:runtime-manager::deploying-to-cloudhub.adoc[Deploying to CloudHub], or on an xref:runtime-manager::managing-applications-on-cloudhub.adoc[already running application].
