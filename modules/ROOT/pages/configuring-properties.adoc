...
You can also escape properties resolution:
...
This way, the logger processor will log "${property.value}" instead of the actual value of such property. This can also be used to escape properties prefix resolucion (i.e. "${" character sequence). 
