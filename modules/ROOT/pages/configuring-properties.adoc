...
You can use https://ant.apache.org/[Ant]-style property placeholders in your Mule configuration. For example:
...
+
image::environment-tab.png["An Environment tab with options including New"]
...
image::environment-tab2.png["An Environment tab with options to define variables"]
