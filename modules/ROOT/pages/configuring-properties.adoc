...
The Configuration Properties support both YAML configuration files and Properties files. `String` is the only supported type in both file formats. Use the format that is easier to read and edit for you.
