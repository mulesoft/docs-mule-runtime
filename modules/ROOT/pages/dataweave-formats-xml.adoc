...
The XML format accepts optional properties that provide instructions for reading input data.
...
The XML format accepts optional properties that provide instructions for writing output data.
