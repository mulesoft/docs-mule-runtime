...
|`maxEntityCount`  |`Number`|`1`|Sets the maximum number of entity expansions. The limit helps avoid Billion Laughs attacks, which are a denial-of-service attack.
