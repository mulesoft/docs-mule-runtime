...
The XML reader accepts properties that provide instructions for reading input data.
...
The XML writer accepts properties that provide instructions for writing output data.
