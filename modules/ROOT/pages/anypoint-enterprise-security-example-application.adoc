...
This document assumes that you are familiar with the https://docs.mulesoft.com/anypoint-studio/v/5/[Mule Studio Essentials] guide. To increase your familiarity with Studio, consider completing the https://docs.mulesoft.com/anypoint-studio/v/5/basic-studio-tutorial[Basic Studio Tutorial].
...
image::verify-signature1.png[verify_signature1]
...
image::encrypt-cc-info.png[encrypt_cc_info]
...
image::decrypt-xml.png[decrypt_XML]
...
* For more information on encryption in Mule, refers to xref:mule-message-encryption-processor.adoc[Mule Message Encryption Processor].
