...
This document assumes that you have xref:5.x@studio::basic-studio-tutorial.adoc[Anypoint Studio Essentials] interface. To increase your familiarity with Studio, consider completing one or more xref:5.x@studio::basic-studio-tutorial.adoc[Basic Studio Tutorials].
...
// REMOVED link to BAD ZIP IN THIS EOL DOC, NO FIX NEEDED
Note: The resource for this procedure is no longer available.
