...
* A consumer key assigned by Concur; refer to the detailed documentation on how to xref:using-a-connector-to-access-an-oauth-api.adoc[use the Concur connector to access an OAuth API].
...
* http://mulesoft.github.io/mule-sap-concur-connector/[SAP Concur Technical Reference].
