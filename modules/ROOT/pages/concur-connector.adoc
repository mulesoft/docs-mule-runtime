...
This user manual presents two of many use cases you might have for the Concur connector in your organization. You may jump ahead and paste the <<flowXML,Complete Flow XML>> into the XML Editor in Studio after the Concur connector has been downloaded and a global element referencing your Concur instance credentials has been created. Download other demo applications http://mulesoft.github.io/mule-sap-concur-connector[here]
...
* http://mulesoft.github.io/mule-sap-concur-connector[Concur Technical Reference].
