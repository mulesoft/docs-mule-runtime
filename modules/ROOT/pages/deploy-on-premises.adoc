[WARNING]
Mule Maven plugin versions 3.0.0, 3.1.0, 3.1.1, 3.1.2, 3.1.3, 3.1.4, 3.1.5, 3.1.6, and 3.1.7 will be deprecated on August 15th.
...
include::4.2@partial$mmp-concept.adoc[tag=applicationNameParameterDescription]
...
include::4.2@partial$mmp-authentication.adoc[tags=!authenticationMethodsIntro;!authenticationCloudHub;!authenticationRTF]
