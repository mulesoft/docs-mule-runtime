...
|JMS |https://www.mulesoft.org/docs/site/current3/apidocs/org/mule/transport/jms/package-summary.html[JavaDoc] http://www.mulesoft.org/docs/site/current3/schemadocs/namespaces/http_www_mulesoft_org_schema_mule_jms/namespace-overview.html[SchemaDoc] |image:check.png[] |image:check.png[] |image:check.png[] |image:check.png[](client ack, local, XA) |image:error.png[] |image:check.png[] |one-way, request-response |one-way |org.mule.transport:mule-transport-jms
|===
...
* Supports local (JMS), distributed (XA), and multi-resource xref:transaction-management.adoc[transactions] _*Enterprise*_
