...
|JMS |https://www.mulesoft.org/docs/site/current3/apidocs/org/mule/transport/jms/package-summary.html[JavaDoc SchemaDoc] |image:check.png[] |image:check.png[] |image:check.png[] |image:check.png[](client ack, local, XA) | - |image:check.png[] |one-way, request-response |one-way |org.mule.transport:mule-transport-jms
|===
