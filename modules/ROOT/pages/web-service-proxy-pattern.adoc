...
The application serves these static contents from  *src/main/app/xsd*. See  xref:3.6@http-static-resource-handler.adoc[HTTP Static Resource Handler] for more information about this.