...
JSON is now natively supported in Mule, meaning you can work with JSON documents and bind them automatically to Java objects. Further information is available in the xref:json-module-reference.adoc[JSON Module] configuration reference.
