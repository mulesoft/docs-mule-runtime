= To Deploy a Mule Application to Runtime Fabric (Mule Maven Plugin)
...
To successfully deploy your Mule application to Runtime Fabric, consider the following requirements:

* The application is already deployed to Exchange. +
