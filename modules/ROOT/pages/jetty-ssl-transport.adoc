...
The Jetty SSL transport works exactly the same way as the xref:3.6@https-transport-reference.adoc[HTTPS Transport Reference].
...
If you do not need this level of security, you can use the xref:3.6@jetty-transport-reference.adoc[Jetty Transport Reference] instead.