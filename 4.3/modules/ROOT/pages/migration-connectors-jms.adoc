...
3) Priority is set as a parameter of the `publish` operation and doesn't rely on the user knowing the exact key.
...
You can implement the same scenario in Mule 4 by using the following approach:
